...
export function builtinMemberCandidates(): string[] => ["_", "add", "buildReadonly", "call", "charAt", "cloneMutable", "cloneReadonly", "contains", "defs", "delete", "description", "dispatch", "drainToReadonly", "endsWith", "error", "every", "fileName", "filter", "fromSerialValue", "fromName", "fromValue", "functionName", "get", "has", "indexOf", "inputSchema", "invoke", "isFailure", "isSuccess", "keys", "length", "line", "lowerBound", "map", "metadata", "methods", "name", "next", "outputSchema", "padEnd", "padStart", "pop", "post", "push", "repeat", "replaceAll", "reserve", "set", "size", "slice", "some", "split", "startsWith", "substring", "takeFirstCompleted", "toSerialObject", "toSerialValue", "toLowerCase", "toUpperCase", "trim", "trimEnd", "trimStart", "unwrapOr", "upperBound", "value", "values"]
