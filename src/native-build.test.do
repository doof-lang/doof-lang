...
export function testPlansMsvcCompilationAndLinking(): none {
  ...
  Assert.equal(generated.arguments.contains("/Zc:lambda"), true)
  ...
  Assert.equal(plan.compileTasks[2].arguments.contains("/Zc:lambda"), true)
...
export function testPlansMsvcPrecompiledRuntimeAndWindowsHeadersForGeneratedModules(): none {
  ...
  Assert.equal(pch.arguments.contains("/Zc:lambda"), true)
