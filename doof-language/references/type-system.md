...
specializes every reached Doof-owned generic function, method, and nominal
type. Only runtime- and native-owned C++ templates survive lowering; native
templates may consume concrete monomorphized Doof types.
