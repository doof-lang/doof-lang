...
namespace app_src_emitter_expr_lambda_ {
    ...
    std::shared_ptr<std::vector<std::string>> scanCapturedMutablesInExpression(const __type11& body);
    ...
    void scanStatementForLambdas(const __type12& statement, const std::shared_ptr<std::vector<std::string>>& result);
    void scanExpressionForLambdas(const __type11& expression, const std::shared_ptr<std::vector<std::string>>& result);
    ...
    void collectStatementCaptures(const __type12& statement, int32_t bodyStart, int32_t bodyEnd, const std::shared_ptr<std::vector<std::string>>& result, bool mutableOnly);
    void collectExpressionCaptures(const __type11& expression, int32_t bodyStart, int32_t bodyEnd, const std::shared_ptr<std::vector<std::string>>& result, bool mutableOnly);
