...
namespace app_src_parser_ {
    ...
    using __type13 = std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>;
}
...
namespace app_src_parser_declarations_ {
    __type9 parseExport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type9 parseConst(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type9 parseReadonly(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type9 parseLet(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type9 parseClass(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported, bool private_);
    __type9 parseInterface(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type9 parseEnum(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type9 parseTypeAlias(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type9 parseImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type9 parseMockImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
}

namespace app_src_parser_statements_ {
    __type10 parseStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type10 parseDestructuring(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    __type10 parseTryStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
}
...
namespace app_src_parser_ {
    ...
    __type12 parseStatement();
    __type12 parseExport();
    __type12 parseConst(bool exported);
    __type12 parseReadonly(bool exported);
    __type12 parseLet();
    ...
    __type12 parseClass(bool exported, bool private_);
    __type12 parseInterface(bool exported);
    __type12 parseEnum(bool exported);
    __type12 parseTypeAlias(bool exported);
    __type12 parseImport();
    __type12 parseMockImport();
    std::shared_ptr<::app_src_ast_::Block> parseBlock();
    __type13 parseCaseExpression();
    bool looksLikePattern(::app_src_lexer_::TokenType separator);
    __type12 parseDestructuring(const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    __type12 parseTryStatement();
    ...
    __type13 parseExpression();
    __type13 parseAdditive();
    __type13 parseUnary();
};
