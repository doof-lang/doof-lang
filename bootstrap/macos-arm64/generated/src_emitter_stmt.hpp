...
namespace app_src_emitter_stmt_ {
    ...
    using doof_header_type_16 = std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
...
namespace app_src_emitter_types_ {
    ...
    std::string emitContextType(const doof_header_type_11& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitType(const doof_header_type_11& resolvedType, const std::string& currentModulePath);
    bool usesVariantRepresentation(const doof_header_type_11& type_);
}
...
namespace app_src_emitter_expr_ {
    std::string emitExpression(const doof_header_type_12& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& expected);
    std::string emitDiscardedExpression(const doof_header_type_12& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string cppIdentifier(const std::string& name);
}

namespace app_src_emitter_expr_utils_ {
    std::string emitExpressionReturn(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& expected);
}
...
namespace app_src_emitter_stmt_ {
    ...
    std::string emitStatement(const doof_header_type_13& statement, int32_t level, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitDestructuringValue(const std::shared_ptr<::app_src_ast_::DestructuringStatement>& statement, const std::string& source, const doof_header_type_14& sourceType, int32_t level, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitDestructuredField(const std::string& source, const std::string& field, const doof_header_type_14& sourceType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::shared_ptr<::app_src_ast_::ClassDeclaration> statementClass(const doof_header_type_13& statement);
    ...
    bool isSingleOptional(const doof_header_type_15& resolvedType);
    ...
    std::string emitTryLocal(const std::string& ind, const std::string& name, const doof_header_type_16& annotation, const doof_header_type_15& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& value, bool readonly_, bool shallowImmutable);
    doof_header_type_14 resultValueType(const doof_header_type_17& expression);
    ...
    std::string emitLocalDeclaration(const std::string& ind, const std::string& name, const doof_header_type_16& annotation, const doof_header_type_14& resolvedType, const doof_header_type_17& value, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, bool readonly_, bool shallowImmutable);
    std::string emitExtractedLocal(const std::string& ind, const std::string& name, const doof_header_type_15& resolvedType, const std::string& value, bool readonly_, bool shallowImmutable);
    std::string localConstPrefix(const doof_header_type_15& resolvedType, bool readonly_, bool shallowImmutable);
    ...
    doof_header_type_14 caseSubjectType(const doof_header_type_17& expression);
    ...
    std::string emitCondition(const doof_header_type_17& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
