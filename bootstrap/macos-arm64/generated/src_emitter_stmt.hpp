...
namespace app_src_emitter_types_ {
    __type10 specializeEmitType(const __type10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitType(const __type10& resolvedType, const std::string& currentModulePath = std::string(""));
    bool usesVariantRepresentation(const __type10& type_);
}
...
namespace app_src_emitter_stmt_ {
    ...
    std::string emitStatement(const __type11& statement, int32_t level, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitDestructuringValue(const std::shared_ptr<::app_src_ast_::DestructuringStatement>& statement, const std::string& source, const __type12& sourceType, int32_t level, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitDestructuredField(const std::string& source, const std::string& field, const __type12& sourceType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::shared_ptr<::app_src_ast_::ClassDeclaration> statementClass(const __type11& statement);
    ...
    bool isSingleOptional(const __type13& resolvedType);
    ...
    __type12 resultValueType(const __type14& expression);
    ...
    std::string emitLocalDeclaration(const std::string& ind, const std::string& name, const std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const __type12& resolvedType, const __type14& value, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, bool readonly_, bool shallowImmutable = false);
    std::string emitExtractedLocal(const std::string& ind, const std::string& name, const __type13& resolvedType, const std::string& value, bool readonly_, bool shallowImmutable = false);
    std::string localConstPrefix(const __type13& resolvedType, bool readonly_, bool shallowImmutable);
    ...
    __type12 caseSubjectType(const __type14& expression);
    ...
    std::string emitCondition(const __type14& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
