...
namespace app_src_emitter_stmt_ {
    ...
    __type12 resultValueType(const __type13& expression);
    ...
    std::string emitLocalDeclaration(const std::string& ind, const std::string& name, const std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const __type12& resolvedType, const __type13& value, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, bool readonly_, bool shallowImmutable = false);
    ...
    __type12 caseSubjectType(const __type13& expression);
    ...
    std::string emitCondition(const __type13& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
