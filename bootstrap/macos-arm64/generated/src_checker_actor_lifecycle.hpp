...
namespace app_src_checker_actor_lifecycle_ {
    void reportRetiredActorUses(const __type9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Binding>>>& retired, const std::string& module, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
    void collectRetiredActorBindings(const __type9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Binding>>>& retired);
    void collectStatementIdentifiers(const __type9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Identifier>>>& result);
    void collectExpressionIdentifiers(const __type10& expression, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Identifier>>>& result);
    void collectStatementExpressions(const __type9& statement, const std::shared_ptr<std::vector<__type10>>& result);
