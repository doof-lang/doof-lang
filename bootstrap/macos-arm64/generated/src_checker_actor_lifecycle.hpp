...
namespace app_src_checker_actor_lifecycle_ {
    void reportRetiredActorUses(const doof_header_type_9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Binding>>>& retired, const std::string& module, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
    void collectRetiredActorBindings(const doof_header_type_9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Binding>>>& retired);
    void collectStatementIdentifiers(const doof_header_type_9& statement, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Identifier>>>& result);
    void collectExpressionIdentifiers(const doof_header_type_10& expression, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Identifier>>>& result);
    void collectStatementExpressions(const doof_header_type_9& statement, const std::shared_ptr<std::vector<doof_header_type_10>>& result);
