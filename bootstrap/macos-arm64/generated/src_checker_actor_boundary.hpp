...
namespace app_src_checker_actor_boundary_ {
    std::shared_ptr<ActorBoundaryViolation> findActorBoundaryViolation(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_10& type_);
    ...
    std::shared_ptr<ActorBoundaryViolation> findViolation(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_10& type_, const std::shared_ptr<std::vector<std::string>>& seen);
    ...
    doof_header_type_11 unwrapExport(const doof_header_type_11& statement);
