...
namespace app_src_parser_declarations_ {
    ...
    using doof_header_type_13 = std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_parser_declarations_ {
    struct ParsedTypeParameters : public std::enable_shared_from_this<ParsedTypeParameters> {
    std::shared_ptr<std::vector<std::string>> names;
    std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>> constraints;
    ParsedTypeParameters(std::shared_ptr<std::vector<std::string>> names, std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>> constraints) : names(names), constraints(constraints) {}
};
}
...
namespace app_src_parser_declarations_ {
    doof_header_type_11 parseExport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseConst(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    doof_header_type_11 parseReadonly(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    doof_header_type_11 parseLet(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_12 parseInitializer(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> makeFunctionExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name, const std::string& description, const std::shared_ptr<std::vector<std::string>>& typeParams, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& typeParamConstraints, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, const doof_header_type_13& returnType, const doof_header_type_12& body, bool exported, bool static_, bool isolated_, bool private_, ::app_src_ast_::AstLocation start);
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> makeFunctionBlock(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name, const std::string& description, const std::shared_ptr<std::vector<std::string>>& typeParams, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& typeParamConstraints, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, const doof_header_type_13& returnType, const std::shared_ptr<::app_src_ast_::Block>& body, bool exported, bool static_, bool isolated_, bool private_, ::app_src_ast_::AstLocation start);
    doof_header_type_12 parseExpressionBody(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    doof_header_type_11 parseClass(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported, bool private_);
    ...
    doof_header_type_11 parseInterface(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    doof_header_type_11 parseEnum(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    doof_header_type_11 parseTypeAlias(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    std::string parseDescription(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseMockImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
