...
namespace app_src_parser_declarations_ {
    ...
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> parseFunction(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported, bool static_, bool isolated_, bool private_);
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> parseMethod(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool static_, bool private_);
