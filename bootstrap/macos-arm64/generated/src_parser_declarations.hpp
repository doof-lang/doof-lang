...
namespace app_src_parser_declarations_ {
    ...
    using __type13 = std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_parser_declarations_ {
    __type11 parseExport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseConst(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type11 parseReadonly(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type11 parseLet(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type12 parseInitializer(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> parseFunction(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported, bool static_, bool isolated_, bool private_, bool legacyMethod = false);
    ...
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> makeFunctionExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name, const std::string& description, const std::shared_ptr<std::vector<std::string>>& typeParams, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& typeParamConstraints, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, const __type13& returnType, const __type12& body, bool exported, bool static_, bool isolated_, bool private_, ::app_src_ast_::AstLocation start);
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> makeFunctionBlock(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name, const std::string& description, const std::shared_ptr<std::vector<std::string>>& typeParams, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& typeParamConstraints, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, const __type13& returnType, const std::shared_ptr<::app_src_ast_::Block>& body, bool exported, bool static_, bool isolated_, bool private_, ::app_src_ast_::AstLocation start);
    __type12 parseExpressionBody(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type11 parseClass(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported, bool private_);
    ...
    __type11 parseInterface(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type11 parseEnum(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    __type11 parseTypeAlias(const std::shared_ptr<::app_src_parser_::Parser>& parser, bool exported);
    std::string parseDescription(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseMockImport(const std::shared_ptr<::app_src_parser_::Parser>& parser);
