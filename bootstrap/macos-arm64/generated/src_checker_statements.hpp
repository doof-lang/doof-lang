...
namespace app_src_checker_expressions_ {
    ...
    using doof_header_type_16 = std::variant<std::shared_ptr<::app_src_ast_::TypePattern>, std::shared_ptr<::app_src_ast_::WildcardPattern>, std::shared_ptr<::app_src_ast_::ValuePattern>, std::shared_ptr<::app_src_ast_::RangePattern>>;
}
...
namespace app_src_checker_expressions_ {
    ...
    doof_header_type_15 nonNoneType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_15& value);
...
namespace app_src_checker_statements_ {
    bool checkStatement(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_17& statement, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool inLoop);
    ...
    bool checkValueDeclaration(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_17& declaration, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& kind, bool mutable_, bool inLoop);
    doof_header_type_18 checkFunction(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn, const std::shared_ptr<::app_src_semantic_::Scope>& outer, const std::shared_ptr<::app_src_semantic_::ClassType>& owner);
    ...
    doof_header_type_19 classStreamElementType(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& class_);
    bool generatedMemberName(const std::string& name);
    bool containsWeakType(const doof_header_type_18& type_);
    ...
    void checkDestructuring(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::DestructuringStatement>& statement, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_19& sourceType);
    std::shared_ptr<std::vector<doof_header_type_18>> positionalDestructuringTypes(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& valueType, ::app_src_ast_::SourceSpan span);
    void declareDestructuredBinding(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& name, const doof_header_type_18& type_, const std::string& bindingKind, ::app_src_ast_::SourceSpan span);
    ...
    void validateDestructuringTarget(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& name, const doof_header_type_18& valueType, ::app_src_ast_::SourceSpan span);
    ...
    doof_header_type_18 inferredReturn(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::Block>& block);
