...
bool checkTry(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::TryStatement>& statement, const std::shared_ptr<::app_src_semantic_::Scope>& scope) {
    ...
    auto kind = std::string("");
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ConstDeclaration>>(_case_subject)) {
            ...
            (value = doof::variant_promote<std::variant<std::monostate, std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>(declaration->value));
            (annotation = declaration->type_);
            ...
            (name = binding->name);
            (kind = std::string("immutable-binding"));
    }
    ...
    const auto resultValue = ::app_src_checker_expressions_::checkExpression(state, doof::unwrap_optional(value), scope, std::monostate{});
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ResultResolvedType>>(_case_subject)) {
            ...
            (static_cast<void>(validatePropagation(state, scope, result->errorType, statement->span)), std::monostate{});
            {
                auto _case_subject = statement->binding;
                if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ExpressionStatement>>(_case_subject)) {
                    ...
                    if (std::visit([](auto&& _obj) { return _obj->kind; }, result->valueType) == std::string("none")) {
                        (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Cannot bind a none success value; use bare 'try expr'"), statement->span)), std::monostate{});
                    }
            }
            }
            if (kind != std::string("")) {
                ...
                if ((kind == std::string("readonly")) || (kind == std::string("const"))) {
                    (bindingType = ::app_src_checker_types_::applyDeepReadonly(bindingType));
                ...
                if (!::app_src_checker_interfaces_::isAssignableWithInterfaces(state->result, valueType, bindingType)) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, (((std::string("Cannot assign ") + ::app_src_checker_types_::typeName(valueType)) + std::string(" to ")) + ::app_src_checker_types_::typeName(bindingType)), statement->span)), std::monostate{});
                }
                {
                    auto _case_subject = statement->binding;
                    if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ConstDeclaration>>(_case_subject)) {
                        const auto& declaration = std::get<std::shared_ptr<::app_src_ast_::ConstDeclaration>>(_case_subject);
                        (declaration->resolvedType = ::app_src_checker_symbols_::optionalResolvedType(bindingType));
                }
                else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject)) {
                        const auto& declaration = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
                        (declaration->resolvedType = ::app_src_checker_symbols_::optionalResolvedType(bindingType));
                ...
                if (name != std::string("_")) {
                    (static_cast<void>(::app_src_checker_statements_::declareUserBinding(state, scope, std::make_shared<::app_src_semantic_::Binding>(name, kind, bindingType, (kind == std::string("let")), ::app_src_checker_validation_::checkerSemanticSpan(statement->span), state->info->path, nullptr, std::string(""), std::string(""), std::string("")), statement->span)), std::monostate{});
                }
            } else {
                {
                    auto _case_subject = statement->binding;
                    if (std::holds_alternative<std::shared_ptr<::app_src_ast_::DestructuringStatement>>(_case_subject)) {
                        const auto& destructuring = std::get<std::shared_ptr<::app_src_ast_::DestructuringStatement>>(_case_subject);
                        (static_cast<void>(::app_src_checker_statements_::checkDestructuring(state, destructuring, scope, doof::variant_promote<std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(result->valueType))), std::monostate{});
                }
                else {
                }
                }
            ...
            (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("try requires a Result expression"), std::visit([](auto&& _obj) { return _obj->span; }, doof::unwrap_optional(value)))), std::monostate{});
    }
    }
...
void validatePropagation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& errorType, ::app_src_ast_::SourceSpan span) {
    ...
    while (!doof::is_null(current)) {
        ...
        if (target->capturesTryErrors) {
            (static_cast<void>(target->catchErrorTypes->push_back(errorType)), std::monostate{});
            return;
        }
        if (target->inValueYieldBlock) {
            (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("'try' cannot be used inside a value-producing block; handle the Result outside the block"), span)), std::monostate{});
            return;
        }
        if (!doof::is_null(target->returnType)) {
            {
                ...
                if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ResultResolvedType>>(_case_subject)) {
                    ...
                    if (!::app_src_checker_interfaces_::isAssignableWithInterfaces(state->result, errorType, result->errorType)) {
                        (static_cast<void>(::app_src_checker_common_::typeError(state, (((std::string("Cannot propagate error ") + ::app_src_checker_types_::typeName(errorType)) + std::string(" from function returning ")) + ::app_src_checker_types_::typeName(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(result))), span)), std::monostate{});
                    }
                    return;
            }
            else {
    ...
    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("'try' requires a Result-returning function, a catch block, or native entry-script scope"), span)), std::monostate{});
}
}
