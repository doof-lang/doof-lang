...
namespace app_src_checker_types_ {
    bool sameType(const __type10& left, const __type10& right);
    bool isAssignable(const __type10& value, const __type10& target);
}
...
namespace app_src_emitter_expr_utils_ {
    __type11 decoratedExpressionType(const __type12& expression);
    __type11 optionalExpectedType(const __type13& value);
    std::string emitExpectedExpression(const __type12& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const __type11& expected);
    bool needsNullableVariantPromotion(const __type11& source, const __type11& expected);
    std::string emitNullableVariantPromotion(const std::string& value, const __type11& source, const __type11& expected, const std::string& currentModulePath);
    bool nullablePromotionSourceUsesVariant(const __type13& source);
    bool needsVariantPromotion(const __type11& source, const __type11& expected);
    bool isNullableVariantType(const __type11& resolvedType);
    bool hasNoneMember(const __type11& resolvedType);
    std::string variantVisitValue(const std::string& value, const __type13& resolvedType);
    __type13 requireExpressionType(const __type12& expression, const std::string& description);
