...
namespace app_src_checker_generics_ {
    ...
    std::shared_ptr<::app_src_ast_::ClassDeclaration> staticMemberOwner(const __type9& objectType, const std::string& property, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result);
