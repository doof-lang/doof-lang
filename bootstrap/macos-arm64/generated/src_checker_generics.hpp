...
namespace app_src_checker_generics_ {
    std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> inferTypeArgument(const doof_header_type_10& pattern, const doof_header_type_10& actual, const std::string& name);
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> functionDeclarationForCallee(const doof_header_type_11& callee, const doof_header_type_10& calleeType, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result);
    std::string functionModuleForCallee(const doof_header_type_11& callee, const std::string& fallback);
    ...
    std::shared_ptr<::app_src_ast_::ClassDeclaration> staticMemberOwner(const doof_header_type_10& objectType, const std::string& property, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result);
