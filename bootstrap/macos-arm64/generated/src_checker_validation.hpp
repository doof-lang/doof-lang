...
namespace app_src_checker_validation_ {
    ...
    void validateStatement(const doof_header_type_9& statement, const std::string& module, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
    void validateValue(const doof_header_type_9& statement, const doof_header_type_10& resolvedType, const std::variant<std::monostate, std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::string& module, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
    ...
    void validateConstructionPlan(const std::shared_ptr<::app_src_ast_::CheckedConstruction>& plan, ::app_src_ast_::SourceSpan span, const std::string& module, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
    ...
    void validateResolved(const doof_header_type_10& resolvedType, ::app_src_ast_::SourceSpan span, const std::string& module, const std::string& owner, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::Diagnostic>>>& diagnostics);
