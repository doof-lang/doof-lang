...
namespace app_src_checker_types_ {
    __type9 substituteTypeParams(const __type9& type_, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type9>>& arguments);
...
namespace app_src_emitter_monomorphize_ {
    ...
    std::string functionInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    std::string classInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    std::string interfaceInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    std::string methodInstantiationKey(const std::string& ownerKey, const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    std::string concreteName(const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    ...
    void collectFunctionBody(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn, const std::string& modulePath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void collectClassBody(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& class_, const std::string& modulePath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void collectStatement(const __type11& statement, const std::string& modulePath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void collectBlock(const std::shared_ptr<::app_src_ast_::Block>& block, const std::string& modulePath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void collectExpression(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression, const std::string& modulePath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void collectTemplateMethodBody(const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method, const std::shared_ptr<std::vector<__type10>>& typeArgs, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis);
    void collectJsonMemberDemand(const std::shared_ptr<::app_src_ast_::MemberExpression>& member, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    void addJsonSerializationDemand(const std::shared_ptr<InstantiationPlan>& plan, const __type10& type_, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis);
    void addJsonDeserializationDemand(const std::shared_ptr<InstantiationPlan>& plan, const __type10& type_, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis);
    void addJsonDemand(const std::shared_ptr<InstantiationPlan>& plan, const __type10& type_, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, bool serialization);
    ...
    void collectOptionalType(const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan);
    void collectType(const __type10& type_, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis, const std::shared_ptr<InstantiationPlan>& plan);
    void addFunction(const std::shared_ptr<InstantiationPlan>& plan, const std::string& modulePath, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& declaration, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    void addClass(const std::shared_ptr<InstantiationPlan>& plan, const std::string& modulePath, const std::shared_ptr<::app_src_ast_::ClassDeclaration>& declaration, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    ...
    void discoverNativeTemplateClassesInStatement(const __type11& statement, const std::shared_ptr<InstantiationPlan>& plan);
    void collectNativeTemplateClasses(const __type10& type_, const std::shared_ptr<InstantiationPlan>& plan);
    ...
    void addInterface(const std::shared_ptr<InstantiationPlan>& plan, const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<__type10>>& typeArgs);
    void addMethod(const std::shared_ptr<InstantiationPlan>& plan, const std::shared_ptr<::app_src_semantic_::ClassType>& ownerType, const std::shared_ptr<::app_src_ast_::ClassDeclaration>& owner, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& declaration, const std::shared_ptr<std::vector<__type10>>& methodArgs);
    ...
    bool classImplementsConcreteInterface(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& class_, const std::shared_ptr<std::vector<__type10>>& classArgs, const std::shared_ptr<InterfaceInstantiation>& interface_, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& analysis);
    ...
    bool sameConcreteMethodType(const __type10& actual, const __type10& expected);
    ...
    std::shared_ptr<::app_src_ast_::ClassDeclaration> classFromStatement(const __type11& statement, const std::string& name);
    __type10 specialize(const __type10& type_, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<__type10>>& arguments);
    bool containsTypeParameters(const std::shared_ptr<std::vector<__type10>>& types);
    bool containsTypeParameter(const __type10& type_);
    std::string concreteTypeListKey(const std::shared_ptr<std::vector<__type10>>& types);
    std::string canonicalTypeKey(const __type10& type_);
    std::string mangleType(const __type10& type_);
    std::string concreteTypeListMangle(const std::shared_ptr<std::vector<__type10>>& types);
