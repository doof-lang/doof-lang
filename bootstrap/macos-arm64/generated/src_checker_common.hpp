...
namespace app_src_checker_common_ {
    ...
    void keepAstTypes(std::shared_ptr<::app_src_checker_state_::CheckerState> state, std::shared_ptr<::app_src_ast_::EnumDeclaration> enum_ = nullptr, std::shared_ptr<::app_src_ast_::ImportDeclaration> import_ = nullptr, std::shared_ptr<::app_src_ast_::ExportDeclaration> export_ = nullptr, std::shared_ptr<::app_src_ast_::ExportList> exports_ = nullptr, std::shared_ptr<::app_src_ast_::NamedImport> namedImport = nullptr, std::shared_ptr<::app_src_ast_::NamespaceImport> namespaceImport = nullptr, std::shared_ptr<::app_src_ast_::DotShorthand> dot = nullptr, std::shared_ptr<::app_src_ast_::CallerExpression> caller = nullptr, std::shared_ptr<::app_src_ast_::YieldStatement> yield_ = nullptr);
}
