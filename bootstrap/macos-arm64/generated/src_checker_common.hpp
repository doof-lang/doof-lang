...
namespace app_src_checker_common_ {
    ...
    void requireBool(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const __type9& resolvedType, ::app_src_ast_::SourceSpan span);
    void keepAstTypes(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::EnumDeclaration>& enum_ = nullptr, const std::shared_ptr<::app_src_ast_::ImportDeclaration>& import_ = nullptr, const std::shared_ptr<::app_src_ast_::ExportDeclaration>& export_ = nullptr, const std::shared_ptr<::app_src_ast_::ExportList>& exports_ = nullptr, const std::shared_ptr<::app_src_ast_::NamedImport>& namedImport = nullptr, const std::shared_ptr<::app_src_ast_::NamespaceImport>& namespaceImport = nullptr, const std::shared_ptr<::app_src_ast_::DotShorthand>& dot = nullptr, const std::shared_ptr<::app_src_ast_::CallerExpression>& caller = nullptr, const std::shared_ptr<::app_src_ast_::YieldStatement>& yield_ = nullptr);
}
