...
namespace app_src_semantic_ { struct NeverType; }
...
namespace app_src_checker_common_ {
    ...
    void deprecatedNoneAlias(std::shared_ptr<::app_src_checker_state_::CheckerState> state, std::string spelling, ::app_src_ast_::SourceSpan span, std::string module = std::string(""));
