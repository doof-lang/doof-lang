...
namespace std_::os::index { struct ExecStderrStream; }
namespace std_::stream::index { struct DecodedLineStream; }
namespace std_::http::index { struct Cookie; }
namespace std_::http::index { struct SetCookie; }
namespace std_::http::index { struct HttpRequest; }
namespace std_::http::index { struct HttpResponse; }
namespace std_::http::index { struct HttpClient; }
namespace std_::http::types { struct HttpError; }
namespace std_::http::types { struct HttpHeader; }
namespace std_::http::websocket { struct WebSocketBinary; }
namespace std_::http::websocket { struct WebSocketClose; }
...
using Cookie = ::std_::http::index::Cookie;
using SetCookie = ::std_::http::index::SetCookie;
using HttpRequest = ::std_::http::index::HttpRequest;
using HttpResponse = ::std_::http::index::HttpResponse;
using HttpClient = ::std_::http::index::HttpClient;
using HttpError = ::std_::http::types::HttpError;
using HttpHeader = ::std_::http::types::HttpHeader;
using WebSocketBinary = ::std_::http::websocket::WebSocketBinary;
using WebSocketClose = ::std_::http::websocket::WebSocketClose;
