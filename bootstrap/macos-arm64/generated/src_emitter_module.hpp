...
namespace app_src_string_builder_ {
}
...
namespace app_src_emitter_module_ {
    ...
    using doof_header_type_13 = std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>>;
...
namespace app_src_emitter_module_ {
    ...
    bool isValueDeclaration(const doof_header_type_11& statement);
    bool isModuleDeclaration(const doof_header_type_11& statement);
    std::variant<std::monostate, std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>> scriptGlobalDeclaration(const doof_header_type_11& statement);
    std::string scriptDeclarationName(const doof_header_type_11& statement);
    doof_header_type_12 scriptDeclarationType(const doof_header_type_11& statement);
    bool scriptDeclarationMutable(const doof_header_type_11& statement);
    ...
    void collectGenericSurfaceSymbols(const doof_header_type_11& statement, const std::shared_ptr<std::vector<std::string>>& typeNames);
    ...
    bool isCxxConstantInitializer(const doof_header_type_14& value);
    bool moduleHasDeferredInitialization(const std::shared_ptr<::app_src_ast_::Program>& program);
    bool statementHasDeferredInitialization(const doof_header_type_11& statement);
    ...
    std::string emitModuleInitializerStatement(const doof_header_type_11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitModuleValueAssignment(const doof_header_type_13& declaration, const doof_header_type_14& value, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitNativeClassMethodsForStatement(const doof_header_type_11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
