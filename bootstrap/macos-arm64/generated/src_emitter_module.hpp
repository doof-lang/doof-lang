...
namespace app_src_emitter_module_ {
    ...
    std::string emitMainWrapper(std::string moduleName, std::shared_ptr<::app_src_emitter_header_::HeaderPlan> plan, bool hasScript = false);
    std::string emitAppEntryWrapper(std::string moduleName, std::shared_ptr<::app_src_emitter_header_::HeaderPlan> plan, bool hasScript = false);
}
