...
namespace app_src_checker_types_ {
    ...
    bool isNumeric(const __type10& resolvedType);
}
...
namespace app_src_emitter_expr_utils_ {
    __type12 decoratedExpressionType(const __type13& expression);
    bool isNullableVariantType(const __type12& resolvedType);
    std::string variantVisitValue(const std::string& value, const __type14& resolvedType);
    __type14 requireExpressionType(const __type13& expression, const std::string& description);
...
namespace app_src_emitter_expr_ops_ {
    ...
    std::string emitJsonAs(const std::string& source, const __type15& target, const std::string& resultCpp, const std::string& success, const std::string& failure);
    ...
    std::string emitAssignmentTarget(const __type16& target, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
