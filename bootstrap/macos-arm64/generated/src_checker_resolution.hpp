...
namespace app_src_checker_resolution_ {
    ...
    using doof_header_type_13 = std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_checker_resolution_ {
    doof_header_type_12 resolveType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    ...
    void reportConstraintViolation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& typeParam, const doof_header_type_12& argument, const std::string& constraint, ::app_src_ast_::SourceSpan span);
    doof_header_type_12 decorateType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& annotation, const doof_header_type_12& resolvedType);
    ...
    std::shared_ptr<::app_src_semantic_::Binding> fieldAssignmentBinding(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_12& object, const std::string& property, const doof_header_type_12& fieldType);
    ...
    doof_header_type_12 indexType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_12& object, const doof_header_type_12& index, ::app_src_ast_::SourceSpan span);
}
