...
namespace app_src_checker_annotations_ {
...
namespace app_src_checker_resolution_ {
    ...
    using doof_header_type_15 = std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_json_semantics_ {
    ...
    std::shared_ptr<std::vector<std::shared_ptr<JsonDiscriminatorEntry>>> entries;
    JsonDiscriminator(std::string fieldName, std::shared_ptr<std::vector<std::shared_ptr<JsonDiscriminatorEntry>>> entries) : fieldName(fieldName), entries(entries) {}
};
...
namespace app_src_checker_types_ {
    ...
    doof_header_type_9 arrayType(const doof_header_type_9& element, bool readonly_);
    doof_header_type_9 mapType(const doof_header_type_9& key, const doof_header_type_9& value, bool readonly_);
    doof_header_type_9 setType(const doof_header_type_9& element, bool readonly_);
    doof_header_type_9 jsonValueType();
    doof_header_type_9 jsonObjectType();
    doof_header_type_9 classMetadataType(const doof_header_type_9& classType_);
    doof_header_type_9 methodReflectionType(const doof_header_type_9& classType_);
    ...
    doof_header_type_9 joinTypes(const doof_header_type_9& left, const doof_header_type_9& right);
}
...
namespace app_src_checker_annotations_ {
    doof_header_type_10 resolveCheckedAnnotation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_11& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    doof_header_type_10 decorateAnnotationType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_11& annotation, const doof_header_type_10& resolvedType);
    void validateAnnotationConstraints(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& constraints, const std::shared_ptr<std::vector<doof_header_type_10>>& arguments, ::app_src_ast_::SourceSpan span, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& outer, const std::shared_ptr<std::vector<std::string>>& ownerNames, const std::shared_ptr<std::vector<doof_header_type_10>>& ownerArguments);
}

namespace app_src_checker_symbols_ {
    doof_header_type_12 methodSignature(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::string>>& ownerTypeParams);
    ...
    doof_header_type_12 resolveAnnotation(const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::string>>& typeParams);
}
...
namespace app_src_checker_resolution_ {
    doof_header_type_14 resolveType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_15& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    void validateTypeArgumentConstraints(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& constraints, const std::shared_ptr<std::vector<doof_header_type_14>>& arguments, ::app_src_ast_::SourceSpan span, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& outer, const std::shared_ptr<std::vector<std::string>>& ownerNames, const std::shared_ptr<std::vector<doof_header_type_14>>& ownerArguments);
    doof_header_type_14 decorateType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_15& annotation, const doof_header_type_14& resolvedType);
    ...
    doof_header_type_14 resolveMemberType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_14& object, const std::string& property, ::app_src_ast_::SourceSpan span, bool validateVisibility, bool declaredOnly, const std::shared_ptr<::app_src_ast_::CheckedMember>& selection);
    ...
    doof_header_type_14 interfaceMethodSignature(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method, const std::shared_ptr<::app_src_ast_::InterfaceDeclaration>& owner, const std::shared_ptr<::app_src_semantic_::Symbol>& symbol);
}
