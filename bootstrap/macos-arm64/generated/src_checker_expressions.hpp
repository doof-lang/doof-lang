...
namespace app_src_checker_types_ {
    using doof_header_type_9 = std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>;
}
...
namespace app_src_checker_interfaces_ {
    using doof_header_type_12 = std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>;
}
...
namespace app_src_ast_ {
    ...
    struct CheckedMember : public std::enable_shared_from_this<CheckedMember> {
    doof_header_type_2 type_;
    std::shared_ptr<FunctionDeclaration> function_;
    std::string modulePath;
    doof_header_type_2 owner;
    std::shared_ptr<ClassDeclaration> staticOwner;
    bool instance;
    bool field;
    CheckedMember(doof_header_type_2 type_, std::shared_ptr<FunctionDeclaration> function_, std::string modulePath, doof_header_type_2 owner, std::shared_ptr<ClassDeclaration> staticOwner, bool instance, bool field) : type_(type_), function_(function_), modulePath(modulePath), owner(owner), staticOwner(staticOwner), instance(instance), field(field) {}
};
    struct CheckedConstruction : public std::enable_shared_from_this<CheckedConstruction> {
    std::shared_ptr<::app_src_semantic_::ClassType> owner;
    std::shared_ptr<ClassDeclaration> declaration;
    std::shared_ptr<FunctionDeclaration> factory;
    std::shared_ptr<::app_src_semantic_::FunctionType> signature;
    std::shared_ptr<std::vector<std::shared_ptr<ConstructionDefault>>> defaults;
    CheckedConstruction(std::shared_ptr<::app_src_semantic_::ClassType> owner, std::shared_ptr<ClassDeclaration> declaration, std::shared_ptr<FunctionDeclaration> factory, std::shared_ptr<::app_src_semantic_::FunctionType> signature, std::shared_ptr<std::vector<std::shared_ptr<ConstructionDefault>>> defaults) : owner(owner), declaration(declaration), factory(factory), signature(signature), defaults(defaults) {}
};
    struct ConstructionDefault : public std::enable_shared_from_this<ConstructionDefault> {
    doof_header_type_3 value;
    ConstructionDefault(doof_header_type_3 value) : value(value) {}
};
    struct TypeParameterConstraint : public std::enable_shared_from_this<TypeParameterConstraint> {
    doof_header_type_4 type_;
    TypeParameterConstraint(doof_header_type_4 type_) : type_(type_) {}
};
}
...
namespace app_src_ast_ {
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    IntLiteral(std::string kind, int32_t value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    LongLiteral(std::string kind, int64_t value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    FloatLiteral(std::string kind, float value, std::string raw, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), raw(raw), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    DoubleLiteral(std::string kind, double value, std::string raw, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), raw(raw), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    StringLiteral(std::string kind, std::string value, std::shared_ptr<std::vector<std::string>> parts, std::shared_ptr<std::vector<Expression>> interpolations, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), parts(parts), interpolations(interpolations), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    CharLiteral(std::string kind, char32_t value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    BoolLiteral(std::string kind, bool value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    NoneLiteral(std::string kind, std::string sourceSpelling, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), sourceSpelling(sourceSpelling), resolvedType(resolvedType), span(span) {}
};
    ...
    SourceSpan span;
    Identifier(std::string kind, std::string name, doof_header_type_2 resolvedType, std::shared_ptr<::app_src_semantic_::Binding> resolvedBinding, SourceSpan span) : kind(kind), name(name), resolvedType(resolvedType), resolvedBinding(resolvedBinding), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    BinaryExpression(std::string kind, std::string operator_, Expression left, Expression right, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), operator_(operator_), left(left), right(right), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    UnaryExpression(std::string kind, std::string operator_, Expression operand, bool prefix, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), operator_(operator_), operand(operand), prefix(prefix), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    AssignmentExpression(std::string kind, std::string operator_, Expression target, Expression value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), operator_(operator_), target(target), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    std::shared_ptr<CheckedMember> resolvedMember;
    bool resolvedCallableField;
    doof_header_type_2 resolvedType;
    SourceSpan span;
    MemberExpression(std::string kind, Expression object, std::string property, bool optional, bool force, std::shared_ptr<ClassDeclaration> resolvedStaticOwner, bool resolvedNamespaceAccess, std::shared_ptr<::app_src_semantic_::Symbol> resolvedNamespaceSymbol, std::shared_ptr<CheckedMember> resolvedMember, bool resolvedCallableField, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), object(object), property(property), optional(optional), force(force), resolvedStaticOwner(resolvedStaticOwner), resolvedNamespaceAccess(resolvedNamespaceAccess), resolvedNamespaceSymbol(resolvedNamespaceSymbol), resolvedMember(resolvedMember), resolvedCallableField(resolvedCallableField), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    IndexExpression(std::string kind, Expression object, Expression index, bool optional, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), object(object), index(index), optional(optional), resolvedType(resolvedType), span(span) {}
};
    ...
    std::shared_ptr<CheckedConstruction> resolvedConstruction;
    std::string kind;
    Expression callee;
    std::shared_ptr<std::vector<std::shared_ptr<CallArgument>>> args;
    std::shared_ptr<std::vector<TypeAnnotation>> typeArgs;
    std::shared_ptr<std::vector<doof_header_type_5>> resolvedGenericTypeArgs;
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    CallExpression(std::shared_ptr<CheckedConstruction> resolvedConstruction, std::string kind, Expression callee, std::shared_ptr<std::vector<std::shared_ptr<CallArgument>>> args, std::shared_ptr<std::vector<TypeAnnotation>> typeArgs, std::shared_ptr<std::vector<doof_header_type_5>> resolvedGenericTypeArgs, std::shared_ptr<FunctionDeclaration> resolvedFunction, std::string resolvedFunctionModule, std::shared_ptr<FunctionDeclaration> resolvedConstructor, std::shared_ptr<ClassDeclaration> resolvedClass, doof_header_type_2 resolvedType, SourceSpan span) : resolvedConstruction(resolvedConstruction), kind(kind), callee(callee), args(args), typeArgs(typeArgs), resolvedGenericTypeArgs(resolvedGenericTypeArgs), resolvedFunction(resolvedFunction), resolvedFunctionModule(resolvedFunctionModule), resolvedConstructor(resolvedConstructor), resolvedClass(resolvedClass), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    ArrayLiteral(std::string kind, std::shared_ptr<std::vector<Expression>> elements, bool readonly_, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), elements(elements), readonly_(readonly_), resolvedType(resolvedType), span(span) {}
};
    struct ObjectProperty : public std::enable_shared_from_this<ObjectProperty> {
    std::string name;
    doof_header_type_3 key;
    doof_header_type_3 value;
    doof_header_type_2 resolvedType;
    std::shared_ptr<::app_src_semantic_::Binding> resolvedBinding;
    SourceSpan span;
    ObjectProperty(std::string name, doof_header_type_3 key, doof_header_type_3 value, doof_header_type_2 resolvedType, std::shared_ptr<::app_src_semantic_::Binding> resolvedBinding, SourceSpan span) : name(name), key(key), value(value), resolvedType(resolvedType), resolvedBinding(resolvedBinding), span(span) {}
};
    ...
    doof_header_type_3 spread;
    std::shared_ptr<ClassDeclaration> resolvedClass;
    doof_header_type_2 resolvedType;
    SourceSpan span;
    ObjectLiteral(std::shared_ptr<CheckedConstruction> resolvedConstruction, std::string kind, std::shared_ptr<std::vector<std::shared_ptr<ObjectProperty>>> properties, doof_header_type_3 spread, std::shared_ptr<ClassDeclaration> resolvedClass, doof_header_type_2 resolvedType, SourceSpan span) : resolvedConstruction(resolvedConstruction), kind(kind), properties(properties), spread(spread), resolvedClass(resolvedClass), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    TupleLiteral(std::string kind, std::shared_ptr<std::vector<Expression>> elements, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), elements(elements), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_4 returnType;
    doof_header_type_6 body;
    bool parameterless;
    bool trailing;
    doof_header_type_2 resolvedType;
    SourceSpan span;
    LambdaExpression(std::string kind, std::shared_ptr<std::vector<std::shared_ptr<Parameter>>> params, doof_header_type_4 returnType, doof_header_type_6 body, bool parameterless, bool trailing, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), params(params), returnType(returnType), body(body), parameterless(parameterless), trailing(trailing), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    IfExpression(std::string kind, Expression condition, Expression then_, Expression else_, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), condition(condition), then_(then_), else_(else_), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedSpreadType;
    bool named;
    std::shared_ptr<ClassDeclaration> resolvedClass;
    std::shared_ptr<FunctionDeclaration> resolvedConstructor;
    doof_header_type_2 resolvedConstructedType;
    doof_header_type_2 resolvedType;
    SourceSpan span;
    ConstructExpression(std::shared_ptr<CheckedConstruction> resolvedConstruction, std::string kind, std::string type_, std::shared_ptr<std::vector<TypeAnnotation>> typeArgs, std::shared_ptr<std::vector<std::shared_ptr<ObjectProperty>>> args, doof_header_type_3 spread, std::shared_ptr<std::vector<std::string>> spreadFields, doof_header_type_2 resolvedSpreadType, bool named, std::shared_ptr<ClassDeclaration> resolvedClass, std::shared_ptr<FunctionDeclaration> resolvedConstructor, doof_header_type_2 resolvedConstructedType, doof_header_type_2 resolvedType, SourceSpan span) : resolvedConstruction(resolvedConstruction), kind(kind), type_(type_), typeArgs(typeArgs), args(args), spread(spread), spreadFields(spreadFields), resolvedSpreadType(resolvedSpreadType), named(named), resolvedClass(resolvedClass), resolvedConstructor(resolvedConstructor), resolvedConstructedType(resolvedConstructedType), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    AsyncExpression(std::string kind, doof_header_type_6 expression, std::shared_ptr<std::vector<std::string>> resolvedCaptureNames, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), expression(expression), resolvedCaptureNames(resolvedCaptureNames), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    RetireExpression(std::string kind, Expression actor, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), actor(actor), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    AsExpression(std::string kind, Expression expression, TypeAnnotation targetType, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), expression(expression), targetType(targetType), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    ActorCreationExpression(std::shared_ptr<CheckedConstruction> resolvedConstruction, std::string kind, std::string className, std::shared_ptr<std::vector<Expression>> args, std::shared_ptr<FunctionDeclaration> resolvedConstructor, doof_header_type_2 resolvedType, SourceSpan span) : resolvedConstruction(resolvedConstruction), kind(kind), className(className), args(args), resolvedConstructor(resolvedConstructor), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    YieldBlockExpression(std::string kind, std::shared_ptr<Block> body, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), body(body), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    CatchExpression(std::string kind, std::shared_ptr<Block> body, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), body(body), resolvedType(resolvedType), span(span) {}
};
    struct Parameter : public std::enable_shared_from_this<Parameter> {
    std::string name;
    std::string description;
    doof_header_type_4 type_;
    doof_header_type_3 defaultValue;
    doof_header_type_2 resolvedType;
    SourceSpan span;
    Parameter(std::string name, std::string description, doof_header_type_4 type_, doof_header_type_3 defaultValue, doof_header_type_2 resolvedType, SourceSpan span) : name(name), description(description), type_(type_), defaultValue(defaultValue), resolvedType(resolvedType), span(span) {}
};
    ...
    SourceSpan span;
    ConstDeclaration(std::string kind, std::string name, std::string description, doof_header_type_4 type_, Expression value, bool exported, doof_header_type_2 resolvedType, bool moduleInitializerChecked, SourceSpan span) : kind(kind), name(name), description(description), type_(type_), value(value), exported(exported), resolvedType(resolvedType), moduleInitializerChecked(moduleInitializerChecked), span(span) {}
};
    ...
    bool moduleInitializerChecked;
    SourceSpan span;
    ReadonlyDeclaration(std::string kind, std::string name, std::string description, doof_header_type_4 type_, Expression value, bool exported, doof_header_type_2 resolvedType, bool moduleInitializerChecked, SourceSpan span) : kind(kind), name(name), description(description), type_(type_), value(value), exported(exported), resolvedType(resolvedType), moduleInitializerChecked(moduleInitializerChecked), span(span) {}
};
    ...
    bool moduleInitializerChecked;
    SourceSpan span;
    ImmutableBinding(std::string kind, std::string name, doof_header_type_4 type_, Expression value, bool exported, std::shared_ptr<Block> else_, std::optional<std::string> failureName, doof_header_type_2 resolvedType, bool moduleInitializerChecked, SourceSpan span) : kind(kind), name(name), type_(type_), value(value), exported(exported), else_(else_), failureName(failureName), resolvedType(resolvedType), moduleInitializerChecked(moduleInitializerChecked), span(span) {}
};
    ...
    bool moduleInitializerChecked;
    SourceSpan span;
    LetDeclaration(std::string kind, std::string name, doof_header_type_4 type_, Expression value, doof_header_type_2 resolvedType, bool moduleInitializerChecked, SourceSpan span) : kind(kind), name(name), type_(type_), value(value), resolvedType(resolvedType), moduleInitializerChecked(moduleInitializerChecked), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    YieldBlockAssignmentStatement(std::string kind, std::string name, std::shared_ptr<YieldBlockExpression> value, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), name(name), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    CaseExpression(std::string kind, Expression subject, std::shared_ptr<std::vector<std::shared_ptr<CaseExpressionArm>>> arms, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), subject(subject), arms(arms), resolvedType(resolvedType), span(span) {}
};
    ...
    std::string kind;
    doof_header_type_3 start;
    doof_header_type_3 end;
    bool inclusive;
    SourceSpan span;
    RangePattern(std::string kind, doof_header_type_3 start, doof_header_type_3 end, bool inclusive, SourceSpan span) : kind(kind), start(start), end(end), inclusive(inclusive), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    WithBinding(std::string name, doof_header_type_4 type_, Expression value, doof_header_type_2 resolvedType, SourceSpan span) : name(name), type_(type_), value(value), resolvedType(resolvedType), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    InterfaceField(std::string kind, std::string name, std::string description, TypeAnnotation type_, bool let_, bool readonly_, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), name(name), description(description), type_(type_), let_(let_), readonly_(readonly_), resolvedType(resolvedType), span(span) {}
};
    ...
    SourceSpan span;
    EnumVariant(std::string kind, std::string name, std::string description, doof_header_type_3 value, std::optional<int32_t> resolvedIntValue, std::optional<std::string> resolvedStringValue, SourceSpan span) : kind(kind), name(name), description(description), value(value), resolvedIntValue(resolvedIntValue), resolvedStringValue(resolvedStringValue), span(span) {}
};
    ...
    doof_header_type_2 resolvedType;
    SourceSpan span;
    TypeAliasDeclaration(std::string kind, std::string name, std::string description, std::shared_ptr<std::vector<std::string>> typeParams, std::shared_ptr<std::vector<std::shared_ptr<TypeParameterConstraint>>> typeParamConstraints, TypeAnnotation type_, bool exported, doof_header_type_2 resolvedType, SourceSpan span) : kind(kind), name(name), description(description), typeParams(typeParams), typeParamConstraints(typeParamConstraints), type_(type_), exported(exported), resolvedType(resolvedType), span(span) {}
};
...
namespace app_src_checker_types_ {
    ...
    doof_header_type_9 rangeType();
    bool isJsonValueType(const doof_header_type_9& resolvedType);
    doof_header_type_9 resultType(const doof_header_type_9& value, const doof_header_type_9& error);
    doof_header_type_9 actorType(const std::shared_ptr<::app_src_semantic_::ClassType>& innerClass);
    doof_header_type_9 promiseType(const doof_header_type_9& valueType);
    doof_header_type_9 tupleType(const std::shared_ptr<std::vector<doof_header_type_9>>& elements);
    doof_header_type_9 unionType(const std::shared_ptr<std::vector<doof_header_type_9>>& types);
    doof_header_type_9 functionType(const std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>>& params, const doof_header_type_9& returnType, const std::shared_ptr<std::vector<std::string>>& typeParams);
    doof_header_type_9 typeParameter(const std::string& name, const std::string& constraintName, const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& constraint);
    ...
    bool isNumeric(const doof_header_type_9& resolvedType);
    bool isStringInterpolatable(const doof_header_type_9& type_);
}
...
namespace app_src_checker_symbols_ {
    ...
    doof_header_type_10 optionalResolvedType(const doof_header_type_11& value);
    ...
    doof_header_type_11 namespaceMemberType(const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::string& namespaceName, const std::string& memberName, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result);
    ...
    doof_header_type_10 typeParamConstraint(const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& name);
    std::shared_ptr<::app_src_semantic_::Binding> lookup(const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& name);
    doof_header_type_11 currentThisType(const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    bool isBuiltinCallable(const std::string& name);
    doof_header_type_11 builtinCallable(const std::string& name);
    ...
    doof_header_type_11 resolveAnnotation(const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::string>>& typeParams);
}

namespace app_src_checker_interfaces_ {
    bool isAssignableWithInterfaces(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_12& value, const doof_header_type_12& target);
}

namespace app_src_checker_common_ {
    doof_header_type_13 finish(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression, const doof_header_type_13& resolvedType);
    ...
    void requireBool(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& resolvedType, ::app_src_ast_::SourceSpan span);
}

namespace app_src_checker_resolution_ {
    doof_header_type_14 resolveType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    std::shared_ptr<::app_src_ast_::CheckedMember> resolveMember(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_14& object, const std::string& property, ::app_src_ast_::SourceSpan span, bool validateVisibility, bool declaredOnly);
    std::shared_ptr<::app_src_semantic_::Binding> fieldAssignmentBinding(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_14& object, const std::string& property, const doof_header_type_14& fieldType, ::app_src_ast_::SourceSpan span);
    doof_header_type_14 indexType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_14& object, const doof_header_type_14& index, ::app_src_ast_::SourceSpan span);
}

namespace app_src_checker_numeric_ {
    bool isNumericOperand(const doof_header_type_15& type_);
    bool isIntegerOperand(const doof_header_type_15& type_);
    bool numericOperatorAllowed(const std::string& operator_, const doof_header_type_15& left, const doof_header_type_15& right);
    doof_header_type_15 numericOperationType(const doof_header_type_15& left, const doof_header_type_15& right, const std::string& operator_);
}

namespace app_src_checker_inference_ {
    doof_header_type_16 pathType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_16& left, const doof_header_type_16& right, const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& expected, ::app_src_ast_::SourceSpan span);
}

namespace app_src_checker_arguments_ {
    struct SuppliedArgument : public std::enable_shared_from_this<SuppliedArgument> {
    std::optional<std::string> name;
    doof_header_type_17 value;
    std::shared_ptr<::app_src_ast_::ObjectProperty> property;
    ::app_src_ast_::SourceSpan span;
    SuppliedArgument(std::optional<std::string> name, doof_header_type_17 value, std::shared_ptr<::app_src_ast_::ObjectProperty> property, ::app_src_ast_::SourceSpan span) : name(name), value(value), property(property), span(span) {}
};
...
namespace app_src_checker_construction_ {
    std::shared_ptr<::app_src_ast_::CheckedConstruction> resolveConstructor(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, bool useFactory);
    ...
    void validateFieldArguments(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CheckedConstruction>& plan, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_checker_arguments_::SuppliedArgument>>>& args);
}

namespace app_src_checker_literals_ {
    doof_header_type_18 checkArray(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ArrayLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_19& expected);
    doof_header_type_18 checkObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_19& expected);
}
...
namespace app_src_checker_calls_ {
    doof_header_type_20 checkCall(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_21& expected);
    doof_header_type_20 checkLambda(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::LambdaExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_21& expected);
}

namespace app_src_checker_expressions_ {
    doof_header_type_22 checkCaseExpression(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CaseExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_23& expected);
    bool casePatternsExhaustive(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& subjectType, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_24>>>>& arms);
    bool integerPatternsExhaustive(const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_24>>>>& arms);
    std::optional<int32_t> integerPatternValue(const doof_header_type_25& expression);
    bool enumPatternsExhaustive(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::EnumType>& enum_, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_24>>>>& arms);
    bool unionPatternsExhaustive(const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_24>>>>& arms);
    void checkCasePatterns(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<doof_header_type_24>>& patterns, const doof_header_type_22& subjectType, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    doof_header_type_22 checkExpression(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_25& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_23& expected);
    doof_header_type_22 weakAccessTarget(const doof_header_type_22& type_);
    bool isNamedStaticReceiver(const doof_header_type_25& expression);
    bool enumVariantMember(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& receiver, const std::string& property);
    doof_header_type_22 checkDotShorthand(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::DotShorthand>& expression, const doof_header_type_23& expected);
    doof_header_type_22 checkIdentifier(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::Identifier>& identifier, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    ...
    doof_header_type_22 checkBinary(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::BinaryExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_23& expected);
    void validateNoneComparison(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_22& left, const doof_header_type_22& right, ::app_src_ast_::SourceSpan span);
    bool admitsNone(const doof_header_type_22& type_);
    void validateRangeOperand(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const std::string& side, const doof_header_type_22& operand, ::app_src_ast_::SourceSpan span);
    doof_header_type_22 checkUnary(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::UnaryExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    doof_header_type_22 checkAs(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::AsExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    bool isValidAsNarrow(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& source, const doof_header_type_22& target);
    bool isJsonAsTarget(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& target);
    doof_header_type_22 nonNoneType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& value);
    ...
    doof_header_type_22 checkAssignment(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::AssignmentExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    void validateAssignmentOperator(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_22& target, const doof_header_type_22& value, ::app_src_ast_::SourceSpan span);
    doof_header_type_22 binaryOperatorType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_22& left, const doof_header_type_22& right, ::app_src_ast_::SourceSpan span);
    void validateNumericOperator(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_22& left, const doof_header_type_22& right, ::app_src_ast_::SourceSpan span);
    bool isInteger(const doof_header_type_22& type_);
    bool isNullableType(const doof_header_type_22& type_);
    bool isFallibleType(const doof_header_type_22& type_);
    doof_header_type_23 fallibleValueType(const doof_header_type_22& type_);
    bool orderedTypes(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& left, const doof_header_type_22& right);
    bool typesOverlap(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_22& left, const doof_header_type_22& right);
    void validateCaseRangeBound(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::monostate, std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& bound, const doof_header_type_22& subjectType, const std::shared_ptr<::app_src_semantic_::Scope>& scope, ::app_src_ast_::SourceSpan span);
}
