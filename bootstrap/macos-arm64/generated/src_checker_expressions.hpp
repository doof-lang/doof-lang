...
namespace app_src_checker_expressions_ {
    ...
    using doof_header_type_20 = std::variant<std::shared_ptr<::app_src_ast_::TypePattern>, std::shared_ptr<::app_src_ast_::WildcardPattern>, std::shared_ptr<::app_src_ast_::ValuePattern>, std::shared_ptr<::app_src_ast_::RangePattern>>;
...
namespace app_src_checker_common_ {
    ...
    void requireBool(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_12& resolvedType, ::app_src_ast_::SourceSpan span);
}
...
namespace app_src_checker_resolution_ {
    ...
    doof_header_type_13 memberType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& object, const std::string& property, ::app_src_ast_::SourceSpan span, bool validateVisibility);
    std::shared_ptr<::app_src_semantic_::Binding> fieldAssignmentBinding(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& object, const std::string& property, const doof_header_type_13& fieldType);
    doof_header_type_13 indexType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_13& object, const doof_header_type_13& index, ::app_src_ast_::SourceSpan span);
}

namespace app_src_checker_literals_ {
    doof_header_type_14 checkArray(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ArrayLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_15& expected);
    doof_header_type_14 checkObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_15& expected);
}
...
namespace app_src_checker_expressions_ {
    doof_header_type_18 checkCaseExpression(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CaseExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_19& expected);
    bool casePatternsExhaustive(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& subjectType, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_20>>>>& arms);
    bool integerPatternsExhaustive(const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_20>>>>& arms);
    std::optional<int32_t> integerPatternValue(const doof_header_type_21& expression);
    bool enumPatternsExhaustive(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_semantic_::EnumType>& enum_, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_20>>>>& arms);
    bool unionPatternsExhaustive(const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_, const std::shared_ptr<std::vector<std::shared_ptr<std::vector<doof_header_type_20>>>>& arms);
    void checkCasePatterns(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<doof_header_type_20>>& patterns, const doof_header_type_18& subjectType, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    doof_header_type_18 checkExpression(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_21& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_19& expected);
    doof_header_type_18 weakAccessTarget(const doof_header_type_18& type_);
    ...
    bool isNamedStaticReceiver(const doof_header_type_21& expression);
    bool declaredInstanceMember(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& receiver, const std::string& property);
    doof_header_type_18 checkDotShorthand(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::DotShorthand>& expression, const doof_header_type_19& expected);
    doof_header_type_18 checkIdentifier(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::Identifier>& identifier, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    ...
    doof_header_type_18 checkBinary(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::BinaryExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    void validateNoneComparison(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_18& left, const doof_header_type_18& right, ::app_src_ast_::SourceSpan span);
    bool admitsNone(const doof_header_type_18& type_);
    void validateRangeOperand(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const std::string& side, const doof_header_type_18& operand, ::app_src_ast_::SourceSpan span);
    doof_header_type_18 coalescedType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& left, const doof_header_type_18& right);
    doof_header_type_18 checkUnary(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::UnaryExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    doof_header_type_18 checkAs(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::AsExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    bool isValidAsNarrow(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& source, const doof_header_type_18& target);
    bool isJsonAsTarget(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& target);
    doof_header_type_18 nonNoneType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_18& value);
    ...
    doof_header_type_18 checkAssignment(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::AssignmentExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    void validateAssignmentOperator(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_18& target, const doof_header_type_18& value, ::app_src_ast_::SourceSpan span);
    doof_header_type_18 binaryOperatorType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& operator_, const doof_header_type_18& left, const doof_header_type_18& right, ::app_src_ast_::SourceSpan span);
    bool isInteger(const doof_header_type_18& type_);
    bool bitwiseOperator(const std::string& operator_);
    bool isNullableType(const doof_header_type_18& type_);
    bool isFallibleType(const doof_header_type_18& type_);
    doof_header_type_19 fallibleValueType(const doof_header_type_18& type_);
    bool orderedTypes(const doof_header_type_18& left, const doof_header_type_18& right);
    bool typesOverlap(const doof_header_type_18& left, const doof_header_type_18& right);
