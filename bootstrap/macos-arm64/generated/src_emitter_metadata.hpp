...
namespace app_src_emitter_json_ {
    std::string emitJsonTypeCheck(const std::string& json, const doof_header_type_10& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitJsonRead(const std::string& json, const doof_header_type_10& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string jsonTypeName(const doof_header_type_10& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitJsonField(const std::string& value, const doof_header_type_10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
...
namespace app_src_emitter_metadata_ {
    ...
    std::string emitParameterValidation(const std::string& name, const std::string& value, const doof_header_type_11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& indent);
    std::string metadataFailure(int32_t code, const std::string& message);
    std::string metadataSuccess(const std::string& value);
    doof_header_type_11 methodReturnType(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method);
    doof_header_type_11 methodSuccessType(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method);
    ...
    std::string emitTypeSchemaWithDescription(const doof_header_type_11& type_, const std::string& description, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitTypeSchema(const doof_header_type_11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::shared_ptr<std::vector<std::string>> emitTypeSchemaEntries(const doof_header_type_11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    void collectSchemaClasses(const doof_header_type_11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::ClassDeclaration>>>& classes);
