...
namespace app_src_emitter_json_ {
    std::string emitJsonTypeCheck(const std::string& json, const __type10& type_);
    std::string emitJsonRead(const std::string& json, const __type10& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string jsonTypeName(const __type10& type_);
    std::string emitJsonField(const std::string& value, const __type10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
...
namespace app_src_emitter_metadata_ {
    ...
    std::string emitParameterValidation(const std::string& name, const std::string& value, const __type11& type_, const std::string& indent);
    std::string metadataFailure(int32_t code, const std::string& message);
    std::string metadataSuccess(const std::string& value);
    __type11 methodReturnType(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method);
    __type11 methodSuccessType(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method);
    ...
    std::string emitTypeSchemaWithDescription(const __type11& type_, const std::string& description, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitTypeSchema(const __type11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::shared_ptr<std::vector<std::string>> emitTypeSchemaEntries(const __type11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    void collectSchemaClasses(const __type11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::ClassDeclaration>>>& classes);
