...
namespace app_src_emitter_json_ {
    std::string emitJsonTypeCheck(const std::string& json, const doof_header_type_10& type_);
    ...
    std::string jsonTypeName(const doof_header_type_10& type_);
...
namespace app_src_emitter_metadata_ {
    ...
    std::string emitParameterValidation(const std::string& name, const std::string& value, const doof_header_type_11& type_, const std::string& indent);
