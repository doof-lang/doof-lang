...
namespace app_src_checker_interfaces_ {
    ...
    bool concreteTypes(const std::shared_ptr<std::vector<__type11>>& types);
    ...
    bool sameConcreteMethodType(const __type11& actual, const __type11& expected);
