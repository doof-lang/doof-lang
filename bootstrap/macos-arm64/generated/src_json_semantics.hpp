...
namespace app_src_json_semantics_ {
    ...
    doof_header_type_9 nullableJsonMember(const doof_header_type_10& type_);
    bool isGeneratedJsonType(const doof_header_type_10& type_, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Program>>>& programs, const std::shared_ptr<std::vector<std::string>>& visited);
    bool isGeneratedJsonSerializationType(const doof_header_type_10& type_, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Program>>>& programs, const std::shared_ptr<std::vector<std::string>>& visited);
    doof_header_type_9 nullableJsonMemberUnchecked(const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_);
    ...
    bool isGeneratedJsonDeserializationAnnotation(const doof_header_type_11& annotation, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Program>>>& programs, const std::shared_ptr<std::vector<std::string>>& visited);
    bool isGeneratedJsonSerializationAnnotation(const doof_header_type_11& annotation, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Program>>>& programs, const std::shared_ptr<std::vector<std::string>>& visited);
