...
namespace app_src_emitter_types_ {
    ...
    std::string emitContextReturnType(const doof_header_type_10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
}
...
namespace app_src_emitter_expr_utils_ {
    std::string emitPropertyValue(const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& expected);
...
namespace app_src_emitter_call_arguments_ {
    std::shared_ptr<::app_src_ast_::CallArgument> callArgumentNamed(const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::CallArgument>>>& args, const std::string& name);
    bool hasNamedArguments(const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::CallArgument>>>& args);
...
namespace app_src_emitter_construction_ {
    struct ConstructionInputs : public std::enable_shared_from_this<ConstructionInputs> {
    std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::CallArgument>>> args;
    std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::ObjectProperty>>> properties;
    bool named;
    ::app_src_ast_::SourceSpan span;
    std::shared_ptr<::app_src_ast_::ConstructExpression> construct;
    std::string spreadName;
    bool aliasThis;
    ConstructionInputs(std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::CallArgument>>> args, std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::ObjectProperty>>> properties, bool named, ::app_src_ast_::SourceSpan span, std::shared_ptr<::app_src_ast_::ConstructExpression> construct, std::string spreadName, bool aliasThis) : args(args), properties(properties), named(named), span(span), construct(construct), spreadName(spreadName), aliasThis(aliasThis) {}
};
    ...
    std::string emitConstructionValue(const std::shared_ptr<ConstructionInputs>& inputs, const std::string& name, int32_t index, const doof_header_type_11& expected, const std::variant<std::monostate, std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& defaultValue, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, const std::shared_ptr<std::vector<std::string>>& ownerTypeParams, const std::string& missingMessage, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
