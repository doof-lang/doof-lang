...
namespace app_src_emitter_decl_ {
    using doof_header_type_11 = std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>>;
...
namespace app_src_emitter_decl_ {
    ...
    std::string emitValueDeclaration(const doof_header_type_11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitModuleValueStorage(const doof_header_type_11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& initializer);
    std::string valuePrefix(const std::string& name, const doof_header_type_12& resolvedType, bool mutable_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    void ensureKnown(const doof_header_type_12& resolvedType, const std::string& owner);
    ...
    doof_header_type_12 fieldTypeForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field);
    std::string fieldTypeTextForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field, const doof_header_type_12& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
