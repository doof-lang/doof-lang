...
namespace app_src_emitter_decl_ {
    using __type11 = std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>>;
...
namespace app_src_emitter_types_ {
    ...
    std::string emitContextType(const __type10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitContextReturnType(const __type10& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitReturnType(const __type10& resolvedType, const std::string& currentModulePath = std::string(""));
    std::string emitParameterType(const __type10& resolvedType, const std::string& currentModulePath = std::string(""));
    std::string borrowParameterType(const __type10& resolvedType, const std::string& emittedType);
...
namespace app_src_emitter_decl_ {
    ...
    std::string emitValueDeclaration(const __type11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitModuleValueStorage(const __type11& statement, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& initializer = std::string(""));
    std::string valuePrefix(const std::string& name, const __type12& resolvedType, bool mutable_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    void ensureKnown(const __type12& resolvedType, const std::string& owner);
    ...
    __type12 fieldTypeForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field);
    std::string fieldTypeTextForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field, const __type12& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
