...
namespace app_src_emitter_types_ {
    ...
    std::string emitReturnType(const doof_header_type_10& resolvedType, const std::string& currentModulePath);
    std::string emitParameterType(const doof_header_type_10& resolvedType, const std::string& currentModulePath);
    std::string borrowParameterType(const doof_header_type_10& resolvedType, const std::string& emittedType);
...
namespace app_src_emitter_decl_ {
    std::string emitFunctionSignature(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn, const std::string& name, const std::string& modulePath, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitCallableDefinition(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& name, const std::string& description);
    ...
    void ensureKnown(const doof_header_type_11& resolvedType, const std::string& owner);
    ...
    doof_header_type_11 fieldTypeForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field);
    std::string fieldTypeTextForEmission(const std::shared_ptr<::app_src_ast_::ClassField>& field, const doof_header_type_11& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
