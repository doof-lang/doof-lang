...
namespace app_src_checker_module_initialization_ {
    ...
    bool literalTree(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const __type9& expression);
    ...
    bool scalarConstantInitializer(const __type9& expression);
    bool numericLiteral(const __type9& expression);
