...
namespace app_src_checker_module_initialization_ {
    ...
    bool literalTree(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_9& expression);
    ...
    bool scalarConstantInitializer(const doof_header_type_9& expression);
    bool numericLiteral(const doof_header_type_9& expression);
