...
namespace app_src_emitter_carriers_ {
    ...
    doof_header_type_11 naturalCarrierMember(const doof_header_type_10& type_);
    std::shared_ptr<std::vector<doof_header_type_10>> flattenCarrierMembers(const std::shared_ptr<std::vector<doof_header_type_10>>& types);
}
...
namespace app_src_checker_types_ {
    doof_header_type_12 substituteTypeParams(const doof_header_type_12& type_, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<doof_header_type_12>>& arguments);
}

namespace app_src_emitter_monomorphize_ {
    std::string classInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_13>>& typeArgs);
    std::string interfaceInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_13>>& typeArgs);
    std::string concreteName(const std::string& name, const std::shared_ptr<std::vector<doof_header_type_13>>& typeArgs);
}

namespace app_src_emitter_types_ {
    doof_header_type_14 specializeEmitType(const doof_header_type_14& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitContextType(const doof_header_type_14& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitContextReturnType(const doof_header_type_14& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitReturnType(const doof_header_type_14& resolvedType, const std::string& currentModulePath);
    std::string emitResultPayloadType(const doof_header_type_14& resolvedType, const std::string& currentModulePath);
    doof_header_type_14 lowerRegisteredTypes(const doof_header_type_14& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string concreteInterfaceName(const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& key);
    std::string emitType(const doof_header_type_14& resolvedType, const std::string& currentModulePath);
    std::string emitWeakType(const doof_header_type_14& inner, const std::string& currentModulePath);
    std::string emitParameterType(const doof_header_type_14& resolvedType, const std::string& currentModulePath);
    std::string borrowParameterType(const doof_header_type_14& resolvedType, const std::string& emittedType);
    bool canBorrowParameter(const doof_header_type_14& resolvedType);
    bool requiresParameterValueSemantics(const doof_header_type_14& resolvedType);
    std::string emitMetadataInnerType(const doof_header_type_14& owner, const std::string& currentModulePath);
    ...
    bool usesVariantRepresentation(const doof_header_type_14& type_);
    bool usesNullableSingleValueRepresentation(const doof_header_type_14& type_);
    std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> naturalNullableUnionMember(const doof_header_type_14& type_);
