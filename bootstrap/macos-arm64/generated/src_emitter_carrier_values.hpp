...
namespace app_src_emitter_carrier_values_ {
    std::string emitCarrierAbsence(const doof_header_type_12& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitCarrierNullTest(const std::string& value);
    std::string emitCarrierPresentValue(const std::string& value);
    std::string emitCarrierConversion(const std::string& value, const doof_header_type_12& source, const doof_header_type_12& target, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, ::app_src_emitter_carriers_::CarrierPosition position);
}
