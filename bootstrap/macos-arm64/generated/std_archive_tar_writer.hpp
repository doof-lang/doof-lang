...
namespace std_::archive::tar_writer {
    ...
    extern int64_t TAR_MAX_BASE_SIZE;
}
...
namespace std_::archive::tar_writer {
    ...
    struct UstarPath : public std::enable_shared_from_this<UstarPath> {
    std::string name;
    std::string prefix;
    UstarPath(std::string name, std::string prefix) : name(name), prefix(prefix) {}
};
}
