...
namespace app_src_parser_expressions_ {
    ...
    using __type12 = std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_parser_ {
    ...
    __type9 parseLet();
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> parseFunction(bool exported, bool static_, bool isolated_, bool private_, bool legacyMethod = false);
...
namespace app_src_parser_expressions_ {
    __type11 parseExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseAssignment(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseNullCoalescing(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseLogicalOr(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseLogicalAnd(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseBitwiseOr(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseBitwiseXor(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseBitwiseAnd(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseEquality(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseComparison(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseShift(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseAdditive(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseMultiplicative(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseRange(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseExponentiation(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseBinaryLevel(const std::shared_ptr<::app_src_parser_::Parser>& parser, int32_t level);
    __type11 parseBinaryLoop(const std::shared_ptr<::app_src_parser_::Parser>& parser, const __type11& initial, const std::shared_ptr<std::vector<::app_src_lexer_::TokenType>>& kinds, int32_t level);
    bool contains(const std::shared_ptr<std::vector<::app_src_lexer_::TokenType>>& values, ::app_src_lexer_::TokenType value);
    __type11 parseUnary(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseAs(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<::app_src_ast_::AsyncExpression> makeAsyncExpression(const __type11& expression, ::app_src_ast_::AstLocation start);
    __type11 parseIfExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parsePostfix(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseCall(const std::shared_ptr<::app_src_parser_::Parser>& parser, const __type11& callee, const std::shared_ptr<std::vector<__type12>>& typeArgs = std::make_shared<std::vector<__type12>>(std::vector<__type12>{}));
    __type11 parseNamedCall(const std::shared_ptr<::app_src_parser_::Parser>& parser, const __type11& callee, const std::shared_ptr<std::vector<__type12>>& typeArgs = std::make_shared<std::vector<__type12>>(std::vector<__type12>{}));
    __type11 parsePrimary(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseTagCall(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseTagAttributeValue(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name);
    ...
    __type11 parseCatchExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<std::vector<__type12>> parseGenericCallTypeArguments(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseStringLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<::app_src_ast_::ArrayLiteral> parseArrayLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseParenExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type11 finishLambda(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, ::app_src_ast_::AstLocation start);
    __type11 parseParameterlessLambda(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseObjectLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    bool isBareMapKeyToken(::app_src_lexer_::TokenType kind);
    __type11 parseConstruction(const std::shared_ptr<::app_src_parser_::Parser>& parser, ::app_src_ast_::AstLocation start, const std::string& name, const std::shared_ptr<std::vector<__type12>>& typeArgs);
