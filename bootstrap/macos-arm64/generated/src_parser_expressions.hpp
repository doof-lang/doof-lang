...
namespace app_src_parser_expressions_ {
    ...
    using doof_header_type_12 = std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
}
...
namespace app_src_parser_expressions_ {
    ...
    doof_header_type_11 parseAssignment(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseNullCoalescing(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseLogicalOr(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseLogicalAnd(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseBitwiseOr(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseBitwiseXor(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseBitwiseAnd(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseEquality(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseComparison(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseShift(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseAdditive(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseMultiplicative(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseRange(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseExponentiation(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseBinaryLevel(const std::shared_ptr<::app_src_parser_::Parser>& parser, int32_t level);
    doof_header_type_11 parseBinaryLoop(const std::shared_ptr<::app_src_parser_::Parser>& parser, const doof_header_type_11& initial, const std::shared_ptr<std::vector<::app_src_lexer_::TokenType>>& kinds, int32_t level);
    bool contains(const std::shared_ptr<std::vector<::app_src_lexer_::TokenType>>& values, ::app_src_lexer_::TokenType value);
    doof_header_type_11 parseUnary(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseAs(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<::app_src_ast_::AsyncExpression> makeAsyncExpression(const doof_header_type_11& expression, ::app_src_ast_::AstLocation start);
    doof_header_type_11 parseIfExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parsePostfix(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseCall(const std::shared_ptr<::app_src_parser_::Parser>& parser, const doof_header_type_11& callee, const std::shared_ptr<std::vector<doof_header_type_12>>& typeArgs);
    doof_header_type_11 parseNamedCall(const std::shared_ptr<::app_src_parser_::Parser>& parser, const doof_header_type_11& callee, const std::shared_ptr<std::vector<doof_header_type_12>>& typeArgs);
    doof_header_type_11 parsePrimary(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseTagCall(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseTagAttributeValue(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& name);
    bool isNumericLiteralToken(::app_src_lexer_::TokenType kind);
    bool stringArrayContains(const std::shared_ptr<std::vector<std::string>>& values, const std::string& value);
    std::string normalizeTagText(const std::string& raw);
    doof_header_type_11 parseCatchExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<std::vector<doof_header_type_12>> parseGenericCallTypeArguments(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseStringLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<::app_src_ast_::ArrayLiteral> parseArrayLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseParenExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    bool looksLikeParenthesizedLambda(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>> parseLambdaParameters(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 finishLambda(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Parameter>>>& params, ::app_src_ast_::AstLocation start);
    doof_header_type_11 parseParameterlessLambda(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseObjectLiteral(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    bool looksLikeExpressionMapKey(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseConstruction(const std::shared_ptr<::app_src_parser_::Parser>& parser, ::app_src_ast_::AstLocation start, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_12>>& typeArgs);
    bool looksLikeConstruction(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    bool looksLikeGenericTypeArguments(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    int32_t parseIntValue(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& raw);
    int64_t parseLongValue(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& raw);
    int32_t digitValue(char32_t ch);
    double parseDoubleValue(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& raw);
    bool isAssignmentOperator(const std::shared_ptr<::app_src_parser_::Parser>& parser, ::app_src_lexer_::TokenType kind);
