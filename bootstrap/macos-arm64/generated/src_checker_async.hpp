...
namespace app_src_checker_async_ {
    struct AsyncBoundaryViolation : public std::enable_shared_from_this<AsyncBoundaryViolation> {
    std::string reason;
    AsyncBoundaryViolation(std::string reason) : reason(reason) {}
};
}
...
namespace app_src_ast_walk_ {
    void collectBlockExpressions(const std::shared_ptr<::app_src_ast_::Block>& block, const std::shared_ptr<std::vector<doof_header_type_10>>& result);
    void collectExpressionTree(const doof_header_type_10& expression, const std::shared_ptr<std::vector<doof_header_type_10>>& result);
}
...
namespace app_src_checker_async_ {
    ...
    std::optional<std::string> asyncResultViolation(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_11& type_);
    std::optional<std::string> findAsyncViolation(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_11& type_, const std::shared_ptr<std::vector<std::string>>& seen, const std::shared_ptr<std::vector<std::string>>& safe, bool resultMode);
