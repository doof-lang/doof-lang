...
namespace app_src_analyzer_ {
    ...
    void decorateDeclarationSymbol(const doof_header_type_11& statement, const std::shared_ptr<::app_src_semantic_::Symbol>& symbol);
    std::shared_ptr<::app_src_semantic_::Symbol> symbolFor(const doof_header_type_11& statement, const std::string& module);
    ...
    void visitStatementTypes(const doof_header_type_11& statement, const std::shared_ptr<ModuleInfo>& info);
