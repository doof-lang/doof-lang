...
namespace app_src_parser_types_ {
    ...
    doof_header_type_11 parseTypeAnnotation(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseTypeMember(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parsePrimaryType(const std::shared_ptr<::app_src_parser_::Parser>& parser);
}
