...
namespace app_src_parser_types_ {
    ...
    __type11 parseTypeAnnotation(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseTypeMember(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parsePrimaryType(const std::shared_ptr<::app_src_parser_::Parser>& parser);
}
