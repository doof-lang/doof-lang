...
std::shared_ptr<ProjectSpec> readProjectSpec(std::string requestedPath, std::string platform, std::string targetOverride) {
    const auto absolutePath = [&]() -> std::string { auto _try_value = ::std_::path::index::absolute(requestedPath); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 55, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
    ...
    const auto manifestSource = [&]() -> std::string { auto _try_value = ::doof_fs::readText(manifest); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 78, std::string("try! failed")); return std::move(doof::success_value(_try_value)); }();
    const auto packageManifest = [&]() -> std::shared_ptr<::app_src_package_manifest_::PackageManifest> { auto _try_value = ::app_src_package_manifest_::parsePackageManifest(manifestSource, manifest, packageDirectory, platform, targetOverride); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 79, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
    const auto root = [&]() -> std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>> { auto _try_value = [&]() -> doof::Result<std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>>, std::string> { auto _as_value = [&]() -> doof::JsonValue { auto _try_value = ::doof_json::parse(manifestSource); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 80, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }(); if (doof::json_is_object(_as_value)) return doof::Success<std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>>>{doof::json_object(_as_value)}; return doof::Failure<std::string>{"JsonValue narrowing failed"}; }(); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 80, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
    auto name = fileName(packageDirectory);
    if (root->find(std::string("name")) != root->end()) {
        (name = [&]() -> std::string { auto _try_value = [&]() -> doof::Result<std::string, std::string> { auto _as_value = [&]() -> doof::JsonValue { auto _try_value = doof::map_get(root, std::string("name"), "", 0); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 82, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }(); if (doof::json_is_string(_as_value)) return doof::Success<std::string>{doof::json_as_string(_as_value)}; return doof::Failure<std::string>{"JsonValue narrowing failed"}; }(); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 82, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }());
    }
    auto entry = std::string("main.do");
    auto buildDirectory = std::string("build");
    if (root->find(std::string("build")) != root->end()) {
        const auto build = [&]() -> std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>> { auto _try_value = [&]() -> doof::Result<std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>>, std::string> { auto _as_value = [&]() -> doof::JsonValue { auto _try_value = doof::map_get(root, std::string("build"), "", 0); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 86, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }(); if (doof::json_is_object(_as_value)) return doof::Success<std::shared_ptr<doof::ordered_map<std::string, doof::JsonValue>>>{doof::json_object(_as_value)}; return doof::Failure<std::string>{"JsonValue narrowing failed"}; }(); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 86, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
        if (build->find(std::string("entry")) != build->end()) {
            (entry = [&]() -> std::string { auto _try_value = [&]() -> doof::Result<std::string, std::string> { auto _as_value = [&]() -> doof::JsonValue { auto _try_value = doof::map_get(build, std::string("entry"), "", 0); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 87, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }(); if (doof::json_is_string(_as_value)) return doof::Success<std::string>{doof::json_as_string(_as_value)}; return doof::Failure<std::string>{"JsonValue narrowing failed"}; }(); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 87, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }());
        }
        if (build->find(std::string("buildDir")) != build->end()) {
            (buildDirectory = [&]() -> std::string { auto _try_value = [&]() -> doof::Result<std::string, std::string> { auto _as_value = [&]() -> doof::JsonValue { auto _try_value = doof::map_get(build, std::string("buildDir"), "", 0); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 88, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }(); if (doof::json_is_string(_as_value)) return doof::Success<std::string>{doof::json_as_string(_as_value)}; return doof::Failure<std::string>{"JsonValue narrowing failed"}; }(); if (doof::is_failure(_try_value)) doof::panic_at("src/project", 88, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }());
        }
    }
