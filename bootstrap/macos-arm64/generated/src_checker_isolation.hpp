...
namespace app_src_checker_isolation_ {
    struct IsolationReason;
    struct IsolationCall;
    struct IsolationNode;
    struct IsolationGraph;
}
...
namespace app_src_ast_walk_ {
    using doof_header_type_9 = std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>;
}
...
namespace app_src_checker_isolation_ {
    struct IsolationNode : public std::enable_shared_from_this<IsolationNode> {
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> declaration;
    std::string module;
    std::string owner;
    std::shared_ptr<std::vector<std::shared_ptr<IsolationCall>>> calls;
    std::shared_ptr<IsolationReason> directReason;
    std::shared_ptr<IsolationReason> reason;
    IsolationNode(std::shared_ptr<::app_src_ast_::FunctionDeclaration> declaration, std::string module, std::string owner, std::shared_ptr<std::vector<std::shared_ptr<IsolationCall>>> calls, std::shared_ptr<IsolationReason> directReason, std::shared_ptr<IsolationReason> reason) : declaration(declaration), module(module), owner(owner), calls(calls), directReason(directReason), reason(reason) {}
};
    struct IsolationGraph : public std::enable_shared_from_this<IsolationGraph> {
    std::shared_ptr<std::vector<std::shared_ptr<IsolationNode>>> nodes;
    IsolationGraph(std::shared_ptr<std::vector<std::shared_ptr<IsolationNode>>> nodes) : nodes(nodes) {}
};
}
...
namespace app_src_ast_walk_ {
    void collectStatementExpressions(const std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>& statement, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
    void collectBlockExpressions(const std::shared_ptr<::app_src_ast_::Block>& block, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
    void collectExpressionTree(const doof_header_type_9& expression, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
}
...
namespace app_src_checker_isolation_ {
    struct IsolationReason : public std::enable_shared_from_this<IsolationReason> {
    std::string kind;
    std::string name;
    ::app_src_ast_::SourceSpan span;
    IsolationReason(std::string kind, std::string name, ::app_src_ast_::SourceSpan span) : kind(kind), name(name), span(span) {}
};
    struct IsolationCall : public std::enable_shared_from_this<IsolationCall> {
    std::shared_ptr<::app_src_ast_::FunctionDeclaration> declaration;
    ::app_src_ast_::SourceSpan span;
    IsolationCall(std::shared_ptr<::app_src_ast_::FunctionDeclaration> declaration, ::app_src_ast_::SourceSpan span) : declaration(declaration), span(span) {}
};
    doof_header_type_10 unwrapExport(const doof_header_type_10& statement);
    ...
    std::shared_ptr<IsolationReason> mutableModuleReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_11& expression);
    std::shared_ptr<IsolationReason> mutableStaticReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const doof_header_type_11& expression);
    ...
    std::shared_ptr<std::vector<doof_header_type_11>> allExpressions(const std::shared_ptr<std::vector<doof_header_type_11>>& roots);
    std::shared_ptr<std::vector<doof_header_type_11>> functionExpressionRoots(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn);
    std::shared_ptr<std::vector<doof_header_type_11>> functionExpressions(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn);
    ...
    std::shared_ptr<IsolationReason> probeReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<IsolationGraph>& graph, const doof_header_type_11& expression);
    ...
    std::shared_ptr<std::vector<doof_header_type_11>> moduleExpressions(const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module);
