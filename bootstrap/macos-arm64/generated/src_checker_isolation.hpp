...
namespace app_src_checker_isolation_ {
    ...
    std::shared_ptr<std::vector<std::shared_ptr<IsolationCall>>> calls = std::make_shared<std::vector<std::shared_ptr<IsolationCall>>>(std::vector<std::shared_ptr<IsolationCall>>{});
    std::shared_ptr<IsolationReason> directReason = nullptr;
    std::shared_ptr<IsolationReason> reason = nullptr;
    IsolationNode(std::shared_ptr<::app_src_ast_::FunctionDeclaration> declaration, std::string module, std::string owner = std::string(""), std::shared_ptr<std::vector<std::shared_ptr<IsolationCall>>> calls = std::make_shared<std::vector<std::shared_ptr<IsolationCall>>>(std::vector<std::shared_ptr<IsolationCall>>{}), std::shared_ptr<IsolationReason> directReason = nullptr, std::shared_ptr<IsolationReason> reason = nullptr) : declaration(declaration), module(module), owner(owner), calls(calls), directReason(directReason), reason(reason) {}
};
    struct IsolationGraph : public std::enable_shared_from_this<IsolationGraph> {
    std::shared_ptr<std::vector<std::shared_ptr<IsolationNode>>> nodes = std::make_shared<std::vector<std::shared_ptr<IsolationNode>>>(std::vector<std::shared_ptr<IsolationNode>>{});
    IsolationGraph(std::shared_ptr<std::vector<std::shared_ptr<IsolationNode>>> nodes = std::make_shared<std::vector<std::shared_ptr<IsolationNode>>>(std::vector<std::shared_ptr<IsolationNode>>{})) : nodes(nodes) {}
};
}
...
namespace app_src_checker_actor_lifecycle_ {
    ...
    void collectBlockExpressions(const std::shared_ptr<::app_src_ast_::Block>& block, const std::shared_ptr<std::vector<__type9>>& result);
    void collectNestedExpressions(const __type9& expression, const std::shared_ptr<std::vector<__type9>>& result);
}
...
namespace app_src_checker_isolation_ {
    ...
    doof::JsonObject toJsonObject() const;
    static doof::Result<std::shared_ptr<IsolationReason>, std::string> fromJsonValue(const doof::JsonValue& _json, bool _lenient = false);
};
    ...
    __type10 unwrapExport(const __type10& statement);
    ...
    std::shared_ptr<IsolationReason> mutableModuleReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const __type11& expression);
    std::shared_ptr<IsolationReason> mutableStaticReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const __type11& expression);
    ...
    std::shared_ptr<std::vector<__type11>> allExpressions(const std::shared_ptr<std::vector<__type11>>& roots);
    void collectExpressionTree(const __type11& expression, const std::shared_ptr<std::vector<__type11>>& result);
    std::shared_ptr<std::vector<__type11>> functionExpressionRoots(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn);
    std::shared_ptr<std::vector<__type11>> functionExpressions(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn);
    ...
    std::shared_ptr<IsolationReason> probeReason(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<IsolationGraph>& graph, const __type11& expression);
    ...
    std::shared_ptr<std::vector<__type11>> moduleExpressions(const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module);
