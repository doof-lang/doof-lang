...
namespace std_::archive::tar_reader {
    ...
    extern int64_t TAR_NAME_OFFSET;
    extern int64_t TAR_NAME_LENGTH;
    ...
    extern int64_t TAR_CHECKSUM_OFFSET;
    extern int64_t TAR_CHECKSUM_LENGTH;
    extern int64_t TAR_TYPE_OFFSET;
    extern int64_t TAR_LINK_NAME_OFFSET;
    extern int64_t TAR_LINK_NAME_LENGTH;
    extern int64_t TAR_MAGIC_OFFSET;
    extern int64_t TAR_PREFIX_OFFSET;
    extern int64_t TAR_PREFIX_LENGTH;
}
