...
namespace std_::archive::writer {
    extern int64_t LOCAL_FILE_HEADER_SIGNATURE;
    extern int64_t CENTRAL_DIRECTORY_SIGNATURE;
    extern int64_t END_OF_CENTRAL_DIRECTORY_SIGNATURE;
    extern int32_t ZIP_VERSION_NEEDED;
    extern int32_t ZIP_VERSION_MADE_BY;
    extern int32_t ZIP_UTF8_FLAG;
}
