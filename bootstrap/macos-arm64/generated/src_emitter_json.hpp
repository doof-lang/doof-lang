...
namespace app_src_emitter_json_ {
    ...
    std::string emitJsonValidation(const std::string& json, const doof_header_type_11& type_, const std::string& name, const std::string& failureType, int32_t indent);
    std::string emitJsonTypeCheck(const std::string& json, const doof_header_type_11& type_);
    ...
    std::string jsonTypeName(const doof_header_type_11& type_);
