...
namespace app_src_parser_statements_ {
    ...
    doof_header_type_11 parseWhile(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label);
    doof_header_type_11 parseFor(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label);
