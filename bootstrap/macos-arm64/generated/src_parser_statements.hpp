...
namespace app_src_parser_statements_ {
    __type11 parseStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseReturn(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseYield(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseIfStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseCaseStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type12 parseCaseExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type11 parseWhile(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label);
    __type11 parseFor(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label);
    __type11 parseLetNoSemicolon(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseExpressionStatementNoSemicolon(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseWith(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type11 parseBreak(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseContinue(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    __type11 parseDestructuring(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    __type11 parseExpressionStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type12 parseTrailingLambdaExpressionStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser, const __type12& expression);
    __type11 parseTryStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 wrapTryDestructuring(const std::shared_ptr<::app_src_parser_::Parser>& parser, ::app_src_ast_::AstLocation start, const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    ...
    __type11 parseTypedImmutableBinding(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    __type11 parseDiscardElseBinding(const std::shared_ptr<::app_src_parser_::Parser>& parser);
