...
namespace app_src_parser_statements_ {
    struct ElseCapture : public std::enable_shared_from_this<ElseCapture> {
    std::optional<std::string> failureName;
    std::shared_ptr<::app_src_ast_::Block> block;
    ElseCapture(std::optional<std::string> failureName, std::shared_ptr<::app_src_ast_::Block> block) : failureName(failureName), block(block) {}
};
}
...
namespace app_src_parser_statements_ {
    doof_header_type_11 parseStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseReturn(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseYield(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseIfStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseCaseStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_12 parseCaseExpression(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    doof_header_type_11 parseWhile(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label, ::app_src_ast_::AstLocation start);
    doof_header_type_11 parseFor(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::optional<std::string>& label, ::app_src_ast_::AstLocation start);
    doof_header_type_11 parseLetNoSemicolon(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseExpressionStatementNoSemicolon(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseWith(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    doof_header_type_11 parseBreak(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseContinue(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    ...
    doof_header_type_11 parseDestructuring(const std::shared_ptr<::app_src_parser_::Parser>& parser, const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    doof_header_type_11 parseExpressionStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_12 parseTrailingLambdaExpressionStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser, const doof_header_type_12& expression);
    doof_header_type_11 parseTryStatement(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 wrapTryDestructuring(const std::shared_ptr<::app_src_parser_::Parser>& parser, ::app_src_ast_::AstLocation start, const std::string& shape, const std::string& bindingKind, ::app_src_lexer_::TokenType separator);
    ...
    doof_header_type_11 parseTypedImmutableBinding(const std::shared_ptr<::app_src_parser_::Parser>& parser);
    doof_header_type_11 parseDiscardElseBinding(const std::shared_ptr<::app_src_parser_::Parser>& parser);
