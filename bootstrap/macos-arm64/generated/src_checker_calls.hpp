...
namespace app_src_checker_resolution_ {
    doof_header_type_12 resolveType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    void validateTypeArgumentConstraints(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& constraints, const std::shared_ptr<std::vector<doof_header_type_12>>& arguments, ::app_src_ast_::SourceSpan span, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& outer);
...
namespace app_src_checker_calls_ {
    doof_header_type_14 checkCall(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_15& expected);
    doof_header_type_15 genericInferenceExpected(const doof_header_type_14& pattern, const std::shared_ptr<std::vector<std::string>>& typeParams);
    doof_header_type_14 checkedMemberCallReturnType(const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const doof_header_type_14& returnType);
    bool callArgumentsDiverge(const std::shared_ptr<::app_src_ast_::CallExpression>& expression);
    std::shared_ptr<std::vector<doof_header_type_14>> inferClassTypeArguments(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::shared_ptr<::app_src_semantic_::ClassType>& class_, const std::shared_ptr<::app_src_ast_::ClassDeclaration>& declaration);
    void applyTypeArgumentConstraints(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& declaration, const std::shared_ptr<std::vector<doof_header_type_14>>& arguments, ::app_src_ast_::SourceSpan span, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    ...
    doof_header_type_14 checkLambda(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::LambdaExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_15& expected);
    std::shared_ptr<::app_src_semantic_::FunctionType> contextualFunctionType(const doof_header_type_15& expected);
    doof_header_type_14 checkConstruct(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ConstructExpression>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_15& expected);
    ...
    bool callableField(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_14& objectType, const std::string& property);
}
