...
namespace app_src_checker_resolution_ {
    ...
    __type12 memberType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const __type12& object, const std::string& property, ::app_src_ast_::SourceSpan span);
}
