...
namespace app_src_checker_symbols_ {
    using __type10 = std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>;
...
namespace app_src_checker_symbols_ {
    ...
    void decorateAnnotationWithResolved(const __type10& annotation, const __type11& resolved);
    bool blockContainsLoopExit(const std::shared_ptr<::app_src_ast_::Block>& block);
    __type12 optionalResolvedType(const __type11& value);
    ...
    __type11 symbolType(const std::shared_ptr<::app_src_semantic_::Symbol>& symbol, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result);
    ...
    __type11 resolveAnnotation(const __type10& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::string>>& typeParams = std::make_shared<std::vector<std::string>>(std::vector<std::string>{}));
    ...
    __type12 typeParamConstraint(const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::string& name);
    ...
    __type11 iterableElement(const __type11& iterable);
