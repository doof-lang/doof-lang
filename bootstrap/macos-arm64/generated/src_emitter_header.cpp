...
void collect(const std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>& statement, const std::shared_ptr<HeaderPlan>& plan, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_emitter_monomorphize_::MethodInstantiation>>>& methods, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_emitter_monomorphize_::ClassInstantiation>>>& classes) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
            ...
            if (fn->name == std::string("main")) {
                static_cast<void>((plan->hasMain = true));
                static_cast<void>((plan->mainReturnsInt = functionReturnsInt(fn)));
                static_cast<void>((plan->mainAcceptsArgs = (static_cast<int32_t>((fn->params)->size()) == 1)));
...
std::string renderProjectedHeader(const std::shared_ptr<std::vector<std::shared_ptr<HeaderSection>>>& sections) {
    ...
    for (const auto& section : *_iterable_48) {
        ...
        for (const auto& declaration : *_iterable_46) {
            ...
            static_cast<void>((emittedForward = true));
        }
    }
    if (emittedForward) {
    ...
    for (const auto& section : *_iterable_80) {
        ...
        for (const auto& alias : *_iterable_76) {
            result->append(alias);
            static_cast<void>((emittedNative = true));
        }
    ...
    while (doof::string_endsWith(rendered, std::string("\n\n"))) {
        static_cast<void>((rendered = doof::string_substring(rendered, 0, (static_cast<int32_t>(rendered.size()) - 1))));
    }
    return rendered;
}
...
void compressRepeatedHeaderVariants(const std::shared_ptr<HeaderPlan>& plan, const std::shared_ptr<HeaderCompressionState>& state) {
    ...
    for (const auto& use : *_iterable_92) {
        ...
        if (name == std::string("")) {
            static_cast<void>((name = nextHeaderTypeAliasName(plan, state)));
...
bool referenceOnlyVariant(const std::string& spelling) {
    ...
    for (int32_t index = 0; index <= static_cast<int32_t>(inner.size()); ++index) {
        ...
        if (atEnd || ((doof::string_at(inner, index, "src/emitter-header", 536) == U'\u002C') && (depth == 0))) {
            ...
            static_cast<void>((memberStart = (index + 1)));
        }
    }
    return true;
}
...
void replaceHeaderTypeUses(const std::shared_ptr<std::vector<std::string>>& values, const std::string& spelling, const std::string& name) {
    for (int32_t index = 0; index < static_cast<int32_t>((values)->size()); ++index) {
        static_cast<void>((doof::array_at(values, index, "src/emitter-header", 553) = doof::string_replaceAll(doof::array_at(values, index, "src/emitter-header", 553), spelling, name)));
    }
}
...
std::string emitEnumDeclaration(const std::shared_ptr<::app_src_ast_::EnumDeclaration>& declaration, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    for (int32_t i = 0; i < static_cast<int32_t>((declaration->variants)->size()); ++i) {
        ...
        static_cast<void>((result = (((result + ::app_src_emitter_decl_::emitDescriptionComment(variant->description, std::string("    "))) + std::string("    ")) + variant->name)));
        if (declaration->backingKind == std::string("string")) {
            static_cast<void>((result = ((result + std::string(" = ")) + doof::to_string(i))));
        } else if (!doof::is_null(variant->resolvedIntValue)) {
            static_cast<void>((result = ((result + std::string(" = ")) + doof::to_string(doof::unwrap_optional(variant->resolvedIntValue)))));
        }
    ...
    static_cast<void>((result = (result + std::string("};\n"))));
    static_cast<void>((result = (((((result + std::string("inline const char* ")) + declaration->name) + std::string("_name(")) + declaration->name) + std::string(" value) {\n"))));
    static_cast<void>((result = (result + std::string("  switch (value) {\n"))));
    const auto& _iterable_118 = declaration->variants;
    for (const auto& variant : *_iterable_118) {
        static_cast<void>((result = (((((((result + std::string("    case ")) + declaration->name) + std::string("::")) + variant->name) + std::string(": return \"")) + variant->name) + std::string("\";\n"))));
    }
    static_cast<void>((result = (((result + std::string("  }\n  doof::panic(std::string(\"Invalid ")) + declaration->name) + std::string(" enum value: \") + doof::to_string(static_cast<int32_t>(value)));\n}\n"))));
    static_cast<void>((result = (((((result + std::string("inline std::optional<")) + declaration->name) + std::string("> ")) + declaration->name) + std::string("_fromName(std::string_view value) {\n"))));
    const auto& _iterable_120 = declaration->variants;
    for (const auto& variant : *_iterable_120) {
        static_cast<void>((result = (((((((result + std::string("  if (value == \"")) + variant->name) + std::string("\") return ")) + declaration->name) + std::string("::")) + variant->name) + std::string(";\n"))));
    }
    static_cast<void>((result = (result + std::string("  return std::nullopt;\n}\n"))));
    if (declaration->backingKind == std::string("string")) {
        static_cast<void>((result = (((((result + std::string("inline std::string ")) + declaration->name) + std::string("_value(")) + declaration->name) + std::string(" value) {\n  switch (value) {\n"))));
        const auto& _iterable_123 = declaration->variants;
        for (const auto& variant : *_iterable_123) {
            static_cast<void>((result = (((((((result + std::string("    case ")) + declaration->name) + std::string("::")) + variant->name) + std::string(": return ")) + ::app_src_emitter_expr_literals_::quote([&]() -> std::string { auto _coalesce_121 = variant->resolvedStringValue; if (doof::is_null(_coalesce_121)) return std::string(""); return doof::unwrap_optional(_coalesce_121); }())) + std::string(";\n"))));
        }
        static_cast<void>((result = (((result + std::string("  }\n  doof::panic(std::string(\"Invalid ")) + declaration->name) + std::string(" enum value: \") + doof::to_string(static_cast<int32_t>(value)));\n}\n"))));
        static_cast<void>((result = (((((result + std::string("inline std::optional<")) + declaration->name) + std::string("> ")) + declaration->name) + std::string("_fromValue(std::string_view value) {\n"))));
        const auto& _iterable_126 = declaration->variants;
        for (const auto& variant : *_iterable_126) {
            static_cast<void>((result = (((((((result + std::string("  if (value == ")) + ::app_src_emitter_expr_literals_::quote([&]() -> std::string { auto _coalesce_124 = variant->resolvedStringValue; if (doof::is_null(_coalesce_124)) return std::string(""); return doof::unwrap_optional(_coalesce_124); }())) + std::string(") return ")) + declaration->name) + std::string("::")) + variant->name) + std::string(";\n"))));
        }
        static_cast<void>((result = (result + std::string("  return std::nullopt;\n}\n"))));
    } else {
        static_cast<void>((result = (((((result + std::string("inline int32_t ")) + declaration->name) + std::string("_value(")) + declaration->name) + std::string(" value) { return static_cast<int32_t>(value); }\n"))));
        static_cast<void>((result = (((((result + std::string("inline std::optional<")) + declaration->name) + std::string("> ")) + declaration->name) + std::string("_fromValue(int32_t value) {\n"))));
        const auto& _iterable_129 = declaration->variants;
        for (const auto& variant : *_iterable_129) {
            static_cast<void>((result = (((((((result + std::string("  if (value == ")) + doof::to_string([&]() -> int32_t { auto _coalesce_127 = variant->resolvedIntValue; if (doof::is_null(_coalesce_127)) return 0; return doof::unwrap_optional(_coalesce_127); }())) + std::string(") return ")) + declaration->name) + std::string("::")) + variant->name) + std::string(";\n"))));
        }
        static_cast<void>((result = (result + std::string("  return std::nullopt;\n}\n"))));
    }
    static_cast<void>((result = (((((((((result + std::string("inline std::shared_ptr<std::vector<")) + declaration->name) + std::string(">> ")) + declaration->name) + std::string("_values() { return std::make_shared<std::vector<")) + declaration->name) + std::string(">>(std::initializer_list<")) + declaration->name) + std::string(">{"))));
    for (int32_t i = 0; i < static_cast<int32_t>((declaration->variants)->size()); ++i) {
        if (i > 0) {
            static_cast<void>((result = (result + std::string(", "))));
        }
        static_cast<void>((result = (((result + declaration->name) + std::string("::")) + doof::array_at(declaration->variants, i, "src/emitter-header", 670)->name)));
    }
    static_cast<void>((result = (result + std::string("}); }\n"))));
    ...
    static_cast<void>((result = (((((((result + std::string("inline doof::JsonValue ")) + declaration->name) + std::string("_toJsonValue(")) + declaration->name) + std::string(" value) { return doof::json_value(")) + declaration->name) + std::string("_value(value)); }\n"))));
    static_cast<void>((result = (((((result + std::string("inline doof::Result<")) + declaration->name) + std::string(", std::string> ")) + declaration->name) + std::string("_fromJsonValue(const doof::JsonValue& value, bool) {\n"))));
    static_cast<void>((result = (((((((result + std::string("  if (!(")) + typeCheck) + std::string(")) return doof::Failure<std::string>{std::string(\"Expected ")) + expectedType) + std::string(" for enum ")) + declaration->name) + std::string(", got \") + doof::json_type_name(value)};\n"))));
    static_cast<void>((result = (((((result + std::string("  auto resolved = ")) + declaration->name) + std::string("_fromValue(")) + valueRead) + std::string(");\n"))));
    auto validValues = std::string("");
    for (int32_t i = 0; i < static_cast<int32_t>((declaration->variants)->size()); ++i) {
        if (i > 0) {
            static_cast<void>((validValues = (validValues + std::string(", "))));
        }
        if (declaration->backingKind == std::string("string")) {
            static_cast<void>((validValues = (((validValues + std::string("\"")) + [&]() -> std::string { auto _coalesce_131 = doof::array_at(declaration->variants, i, "src/emitter-header", 683)->resolvedStringValue; if (doof::is_null(_coalesce_131)) return std::string(""); return doof::unwrap_optional(_coalesce_131); }()) + std::string("\""))));
        } else {
            static_cast<void>((validValues = (validValues + doof::to_string([&]() -> int32_t { auto _coalesce_132 = doof::array_at(declaration->variants, i, "src/emitter-header", 684)->resolvedIntValue; if (doof::is_null(_coalesce_132)) return 0; return doof::unwrap_optional(_coalesce_132); }()))));
        }
    }
    static_cast<void>((result = (((((((result + std::string("  if (!resolved.has_value()) return doof::Failure<std::string>{std::string(\"Unknown backing value for enum ")) + declaration->name) + std::string(": \") + doof::to_string(")) + valueRead) + std::string(") + ")) + ::app_src_emitter_expr_literals_::quote((std::string("; expected one of ") + validValues))) + std::string("};\n"))));
    static_cast<void>((result = (((result + std::string("  return doof::Success<")) + declaration->name) + std::string(">{resolved.value()};\n}\n"))));
