...
namespace app_src_checker_properties_ {
    doof_header_type_11 checkPropertyValue(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_12& expected);
    doof_header_type_11 checkAssignableProperty(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_12& expected);
    bool sameFixedFieldValue(const doof_header_type_13& actual, const doof_header_type_13& expected);
}
