...
#line 179 "/src/emitter-module.do"
    sourceBuilder->append(std::string("}\n"));
...
#line 185 "/src/emitter-module.do"
...
#line 186 "/src/emitter-module.do"
...
#line 187 "/src/emitter-module.do"
    const auto source = sourceBuilder->drainToString();
#line 188 "/src/emitter-module.do"
...
#line 196 "/src/emitter-module.do"
...
#line 202 "/src/emitter-module.do"
...
#line 203 "/src/emitter-module.do"
...
#line 211 "/src/emitter-module.do"
            return true;
    }
...
#line 213 "/src/emitter-module.do"
            return true;
    }
    else {
#line 214 "/src/emitter-module.do"
            return false;
    }
    }
    doof::unreachable();
...
#line 228 "/src/emitter-module.do"
            return true;
    }
...
#line 230 "/src/emitter-module.do"
            return true;
    }
    else {
#line 231 "/src/emitter-module.do"
            return false;
    }
    }
    doof::unreachable();
...
#line 240 "/src/emitter-module.do"
...
#line 253 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
#line 254 "/src/emitter-module.do"
            return value->name;
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject)) {
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject);
#line 255 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::LetDeclaration>>(_case_subject);
#line 256 "/src/emitter-module.do"
            return value->name;
    }
    else {
#line 257 "/src/emitter-module.do"
            return std::string("");
    }
    }
    doof::unreachable();
...
#line 264 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
#line 265 "/src/emitter-module.do"
            return value->resolvedType;
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject)) {
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject);
#line 266 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::LetDeclaration>>(_case_subject);
#line 267 "/src/emitter-module.do"
            return value->resolvedType;
    }
    else {
#line 268 "/src/emitter-module.do"
            return std::monostate{};
    }
    }
    doof::unreachable();
...
#line 273 "/src/emitter-module.do"
...
#line 275 "/src/emitter-module.do"
            return true;
    }
    else {
#line 276 "/src/emitter-module.do"
            return false;
    }
    }
    doof::unreachable();
...
#line 290 "/src/emitter-module.do"
...
#line 292 "/src/emitter-module.do"
...
#line 293 "/src/emitter-module.do"
...
#line 316 "/src/emitter-module.do"
...
#line 323 "/src/emitter-module.do"
...
#line 328 "/src/emitter-module.do"
...
#line 333 "/src/emitter-module.do"
...
#line 338 "/src/emitter-module.do"
...
#line 349 "/src/emitter-module.do"
...
#line 369 "/src/emitter-module.do"
...
#line 387 "/src/emitter-module.do"
...
#line 392 "/src/emitter-module.do"
            continue;
        }
#line 394 "/src/emitter-module.do"
...
#line 414 "/src/emitter-module.do"
        (emitted->fingerprint = fingerprint);
#line 415 "/src/emitter-module.do"
        graph->modules->push_back(emitted);
#line 416 "/src/emitter-module.do"
        if (coverageModuleId >= 0) {
#line 417 "/src/emitter-module.do"
...
#line 427 "/src/emitter-module.do"
...
#line 428 "/src/emitter-module.do"
...
#line 433 "/src/emitter-module.do"
...
#line 438 "/src/emitter-module.do"
...
#line 440 "/src/emitter-module.do"
    const auto& _iterable_45 = keys;
    for (const auto& key : *_iterable_45) {
#line 441 "/src/emitter-module.do"
...
#line 446 "/src/emitter-module.do"
...
#line 447 "/src/emitter-module.do"
...
#line 448 "/src/emitter-module.do"
...
#line 469 "/src/emitter-module.do"
...
#line 504 "/src/emitter-module.do"
...
#line 505 "/src/emitter-module.do"
...
#line 509 "/src/emitter-module.do"
bool isCoverageEligible(const std::string& modulePath) {
#line 510 "/src/emitter-module.do"
...
#line 519 "/src/emitter-module.do"
...
#line 521 "/src/emitter-module.do"
            if ((line > last) && (doof::is_null(candidate) || (line < candidate.value()))) {
#line 521 "/src/emitter-module.do"
                (candidate = line);
            }
        }
#line 523 "/src/emitter-module.do"
...
#line 530 "/src/emitter-module.do"
...
#line 534 "/src/emitter-module.do"
...
#line 538 "/src/emitter-module.do"
...
#line 542 "/src/emitter-module.do"
...
#line 545 "/src/emitter-module.do"
...
#line 546 "/src/emitter-module.do"
...
#line 550 "/src/emitter-module.do"
    const auto& _iterable_88 = serializationKeys;
    for (const auto& key : *_iterable_88) {
#line 550 "/src/emitter-module.do"
        context->jsonSerializationKeys->push_back(key);
    }
#line 551 "/src/emitter-module.do"
    const auto& _iterable_90 = deserializationKeys;
    for (const auto& key : *_iterable_90) {
#line 551 "/src/emitter-module.do"
        context->jsonDeserializationKeys->push_back(key);
    }
}
#line 554 "/src/emitter-module.do"
...
#line 561 "/src/emitter-module.do"
    const auto& _iterable_92 = instantiations->methods;
    for (const auto& instantiation : *_iterable_92) {
...
#line 564 "/src/emitter-module.do"
        const auto& _iterable_94 = instantiation->substitution->arguments;
...
#line 571 "/src/emitter-module.do"
...
#line 573 "/src/emitter-module.do"
...
#line 576 "/src/emitter-module.do"
...
#line 587 "/src/emitter-module.do"
...
#line 603 "/src/emitter-module.do"
        ::app_src_emitter_header_::reserveHeaderNamespaceName(plan, instantiation->emittedName);
#line 604 "/src/emitter-module.do"
...
#line 612 "/src/emitter-module.do"
    return false;
}
#line 615 "/src/emitter-module.do"
...
#line 618 "/src/emitter-module.do"
            return class_->name;
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::InterfaceDeclaration>>(_case_subject)) {
...
#line 634 "/src/emitter-module.do"
...
#line 639 "/src/emitter-module.do"
                if (!containsString(plan->typeOnlyForwardDeclarations, declaration)) {
#line 639 "/src/emitter-module.do"
                    plan->typeOnlyForwardDeclarations->push_back(declaration);
                }
...
#line 650 "/src/emitter-module.do"
...
#line 652 "/src/emitter-module.do"
...
#line 661 "/src/emitter-module.do"
...
#line 665 "/src/emitter-module.do"
        if (doof::array_at(context->concreteClassKeys, index, "src/emitter-module", 665) == key) {
#line 665 "/src/emitter-module.do"
            return doof::array_at(context->concreteClassNames, index, "src/emitter-module", 665);
        }
    }
#line 667 "/src/emitter-module.do"
    return ::app_src_emitter_monomorphize_::concreteName(class_->name, class_->typeArgs);
}
...
#line 671 "/src/emitter-module.do"
    auto result = std::string("");
#line 672 "/src/emitter-module.do"
    const auto& _iterable_123 = instantiations->functions;
...
#line 682 "/src/emitter-module.do"
...
#line 683 "/src/emitter-module.do"
    auto result = std::string("");
#line 684 "/src/emitter-module.do"
    const auto& _iterable_125 = instantiations->classes;
...
#line 688 "/src/emitter-module.do"
        const auto& _iterable_127 = instantiation->declaration->methods;
        for (const auto& method : *_iterable_127) {
#line 689 "/src/emitter-module.do"
...
#line 693 "/src/emitter-module.do"
...
#line 694 "/src/emitter-module.do"
        clearInstantiation(context);
    }
#line 696 "/src/emitter-module.do"
    return result;
}
#line 699 "/src/emitter-module.do"
...
#line 701 "/src/emitter-module.do"
    const auto& _iterable_129 = instantiations->methods;
    for (const auto& instantiation : *_iterable_129) {
#line 702 "/src/emitter-module.do"
        if (instantiation->modulePath != context->modulePath) {
#line 702 "/src/emitter-module.do"
            continue;
        }
#line 703 "/src/emitter-module.do"
        (context->substitution = instantiation->substitution);
#line 704 "/src/emitter-module.do"
...
#line 708 "/src/emitter-module.do"
        clearInstantiation(context);
    }
#line 710 "/src/emitter-module.do"
    return result;
}
#line 713 "/src/emitter-module.do"
...
#line 714 "/src/emitter-module.do"
...
#line 721 "/src/emitter-module.do"
...
#line 729 "/src/emitter-module.do"
    return surfaces;
}
...
#line 737 "/src/emitter-module.do"
...
#line 745 "/src/emitter-module.do"
...
#line 750 "/src/emitter-module.do"
    const auto& _iterable_137 = surfaces;
    for (const auto& surface : *_iterable_137) {
#line 750 "/src/emitter-module.do"
...
#line 754 "/src/emitter-module.do"
...
#line 759 "/src/emitter-module.do"
...
#line 760 "/src/emitter-module.do"
    const auto& _iterable_141 = result->modules;
    for (const auto& module : *_iterable_141) {
#line 760 "/src/emitter-module.do"
        if (module->path == path) {
#line 760 "/src/emitter-module.do"
...
#line 761 "/src/emitter-module.do"
    return std::make_shared<std::vector<std::shared_ptr<::app_src_semantic_::ImportBinding>>>(std::vector<std::shared_ptr<::app_src_semantic_::ImportBinding>>{});
}
...
#line 765 "/src/emitter-module.do"
    const auto& _iterable_143 = result->modules;
    for (const auto& module : *_iterable_143) {
#line 765 "/src/emitter-module.do"
        if (module->path == path) {
#line 765 "/src/emitter-module.do"
            return module;
...
#line 766 "/src/emitter-module.do"
    return nullptr;
}
#line 769 "/src/emitter-module.do"
...
#line 775 "/src/emitter-module.do"
...
#line 790 "/src/emitter-module.do"
...
#line 792 "/src/emitter-module.do"
    if (doof::is_null(info)) {
#line 792 "/src/emitter-module.do"
        return;
    }
#line 793 "/src/emitter-module.do"
    visiting->push_back(path);
#line 794 "/src/emitter-module.do"
    const auto& _iterable_145 = info->imports;
    for (const auto& imported : *_iterable_145) {
#line 795 "/src/emitter-module.do"
...
#line 797 "/src/emitter-module.do"
    const auto& _iterable_147 = info->namespaceImports;
    for (const auto& imported : *_iterable_147) {
#line 798 "/src/emitter-module.do"
        if (!imported->typeOnly) {
#line 798 "/src/emitter-module.do"
            visitInitializationModule(result, imported->sourceModule, entry, entryMode, visiting, visited, order);
        }
...
#line 800 "/src/emitter-module.do"
    const auto& _iterable_149 = info->reExports;
    for (const auto& reExport : *_iterable_149) {
#line 800 "/src/emitter-module.do"
        visitInitializationModule(result, reExport, entry, entryMode, visiting, visited, order);
    }
#line 801 "/src/emitter-module.do"
    auto ignored = [&]() -> std::string { auto _try_value = doof::array_pop(visiting); if (doof::is_failure(_try_value)) doof::panic_at("src/emitter-module", 801, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
#line 802 "/src/emitter-module.do"
...
#line 808 "/src/emitter-module.do"
...
#line 810 "/src/emitter-module.do"
    const auto& _iterable_151 = paths;
    for (const auto& path : *_iterable_151) {
#line 810 "/src/emitter-module.do"
        result->push_back(::app_src_emitter_names_::moduleNamespace(path));
    }
#line 811 "/src/emitter-module.do"
    return result;
}
...
#line 824 "/src/emitter-module.do"
    {
        auto _case_subject = statement;
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::FunctionDeclaration>>(_case_subject)) {
            const auto& fn = std::get<std::shared_ptr<::app_src_ast_::FunctionDeclaration>>(_case_subject);
...
#line 831 "/src/emitter-module.do"
            auto result = (std::string("\n") + ::app_src_emitter_decl_::emitStaticClassFieldDefinitions(class_, context, std::string("")));
#line 832 "/src/emitter-module.do"
            if (static_cast<int32_t>((class_->typeParams)->size()) == 0) {
#line 833 "/src/emitter-module.do"
                const auto& _iterable_153 = class_->methods;
                for (const auto& method : *_iterable_153) {
#line 833 "/src/emitter-module.do"
...
#line 843 "/src/emitter-module.do"
...
#line 846 "/src/emitter-module.do"
            return std::string("");
    }
    }
    doof::unreachable();
#line 848 "/src/emitter-module.do"
    return std::string("");
}
...
#line 856 "/src/emitter-module.do"
...
#line 857 "/src/emitter-module.do"
...
#line 867 "/src/emitter-module.do"
    ...
    doof::unreachable();
#line 869 "/src/emitter-module.do"
    return std::monostate{};
}
...
#line 880 "/src/emitter-module.do"
...
#line 881 "/src/emitter-module.do"
    ...
    doof::unreachable();
#line 883 "/src/emitter-module.do"
    return false;
}
#line 886 "/src/emitter-module.do"
...
#line 888 "/src/emitter-module.do"
        if (statementHasDeferredInitialization(statement)) {
#line 888 "/src/emitter-module.do"
            return true;
        }
    }
#line 890 "/src/emitter-module.do"
    return false;
}
...
#line 895 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
#line 896 "/src/emitter-module.do"
            return !isCxxConstantInitializer(value->value);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject)) {
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject);
#line 897 "/src/emitter-module.do"
            return !isCxxConstantInitializer(value->value);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::LetDeclaration>>(_case_subject)) {
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::LetDeclaration>>(_case_subject);
...
#line 901 "/src/emitter-module.do"
            const auto& _iterable_157 = class_->fields;
            for (const auto& field : *_iterable_157) {
#line 901 "/src/emitter-module.do"
...
#line 902 "/src/emitter-module.do"
            return false;
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject)) {
            const auto& export_ = std::get<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject);
...
#line 910 "/src/emitter-module.do"
...
#line 912 "/src/emitter-module.do"
    if (includeValues) {
#line 913 "/src/emitter-module.do"
...
#line 923 "/src/emitter-module.do"
...
#line 925 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
#line 926 "/src/emitter-module.do"
            return emitModuleValueAssignment(doof::variant_promote<std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>>>(value), value->value, context);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject)) {
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject);
#line 927 "/src/emitter-module.do"
            ...
            const auto& value = std::get<std::shared_ptr<::app_src_ast_::LetDeclaration>>(_case_subject);
#line 928 "/src/emitter-module.do"
            return emitModuleValueAssignment(doof::variant_promote<std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>>>(value), value->value, context);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
            const auto& class_ = std::get<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject);
#line 930 "/src/emitter-module.do"
            auto result = std::string("");
...
#line 932 "/src/emitter-module.do"
            const auto& _iterable_163 = class_->fields;
            for (const auto& field : *_iterable_163) {
...
#line 934 "/src/emitter-module.do"
                const auto& _iterable_165 = field->names;
                for (const auto& name : *_iterable_165) {
...
#line 952 "/src/emitter-module.do"
...
#line 960 "/src/emitter-module.do"
    const auto& _iterable_167 = namespaces;
    for (const auto& namespace_ : *_iterable_167) {
#line 960 "/src/emitter-module.do"
        (result = (((result + std::string("::")) + namespace_) + std::string("::__doof_initialize_module(); ")));
    }
#line 961 "/src/emitter-module.do"
    return result;
}
...
#line 966 "/src/emitter-module.do"
    const auto& _iterable_169 = programs;
    for (const auto& program : *_iterable_169) {
#line 967 "/src/emitter-module.do"
        const auto& _iterable_171 = program->statements;
        for (const auto& statement : *_iterable_171) {
#line 968 "/src/emitter-module.do"
            (result = (result + emitNativeClassMethodsForStatement(statement, context)));
        }
    }
#line 971 "/src/emitter-module.do"
    return result;
}
#line 974 "/src/emitter-module.do"
...
#line 975 "/src/emitter-module.do"
    {
        auto _case_subject = statement;
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
            const auto& class_ = std::get<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject);
#line 977 "/src/emitter-module.do"
            if (!class_->native_) {
#line 977 "/src/emitter-module.do"
                return std::string("");
            }
#line 978 "/src/emitter-module.do"
            auto result = std::string("");
#line 979 "/src/emitter-module.do"
            const auto& _iterable_173 = class_->methods;
            for (const auto& method : *_iterable_173) {
#line 980 "/src/emitter-module.do"
                if (!method->bodyless) {
#line 980 "/src/emitter-module.do"
                    (result = (result + ::app_src_emitter_decl_::emitClassMethodDefinition(class_, method, context, std::string(""), std::string(""))));
                }
            }
#line 982 "/src/emitter-module.do"
            return result;
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject)) {
            const auto& export_ = std::get<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject);
#line 984 "/src/emitter-module.do"
            return emitNativeClassMethodsForStatement(export_->declaration, context);
    }
    else {
#line 985 "/src/emitter-module.do"
            return std::string("");
    }
    }
    doof::unreachable();
#line 987 "/src/emitter-module.do"
    return std::string("");
}
#line 991 "/src/emitter-module.do"
...
#line 995 "/src/emitter-module.do"
...
#line 999 "/src/emitter-module.do"
...
#line 1007 "/src/emitter-module.do"
    const auto panicHandler = std::string("catch (const doof::Panic& _panic) { std::cerr << \"panic: \" << _panic.what() << std::endl; std::abort(); }");
#line 1008 "/src/emitter-module.do"
    const auto actorSetup = std::string("auto& __doof_application_domain = doof::detail::ApplicationDomain::shared(); doof::detail::ActiveActorScope __doof_application_scope(&__doof_application_domain); ");
#line 1009 "/src/emitter-module.do"
    return (((((((((std::string("\n") + signature) + std::string(" { try { ")) + actorSetup) + initializationCall) + argumentSetup) + success) + std::string(" } ")) + panicHandler) + std::string(" catch (const std::exception& error) { std::cerr << \"error: \" << error.what() << std::endl; return 1; } }\n"));
}
#line 1013 "/src/emitter-module.do"
...
#line 1014 "/src/emitter-module.do"
    if (!hasScript) {
#line 1015 "/src/emitter-module.do"
...
#line 1016 "/src/emitter-module.do"
        const auto call = (plan->mainAcceptsArgs ? (moduleName + std::string("::doof_main(std::make_shared<std::vector<std::string>>(std::move(args)))")) : (moduleName + std::string("::doof_main()")));
#line 1017 "/src/emitter-module.do"
        const auto success = (plan->mainReturnsInt ? ((std::string("return ") + call) + std::string(";")) : (call + std::string("; return 0;")));
#line 1018 "/src/emitter-module.do"
        const auto panicHandler = std::string("catch (const doof::Panic& _panic) { std::cerr << \"panic: \" << _panic.what() << std::endl; std::abort(); }");
#line 1019 "/src/emitter-module.do"
        const auto actorSetup = std::string("auto& __doof_application_domain = doof::detail::ApplicationDomain::shared(); doof::detail::ActiveActorScope __doof_application_scope(&__doof_application_domain); ");
#line 1020 "/src/emitter-module.do"
...
#line 1022 "/src/emitter-module.do"
    const auto needsArguments = (plan->mainAcceptsArgs || hasScript);
#line 1023 "/src/emitter-module.do"
...
#line 1024 "/src/emitter-module.do"
    const auto scriptCall = (hasScript ? (moduleName + std::string("::__doof_run_script(arguments); ")) : std::string(""));
#line 1025 "/src/emitter-module.do"
    const auto call = (plan->mainAcceptsArgs ? (moduleName + std::string("::doof_main(arguments)")) : (moduleName + std::string("::doof_main()")));
#line 1026 "/src/emitter-module.do"
    const auto success = (!plan->hasMain ? (scriptCall + std::string("return 0;")) : (plan->mainReturnsInt ? (((scriptCall + std::string("return ")) + call) + std::string(";")) : ((scriptCall + call) + std::string("; return 0;"))));
#line 1027 "/src/emitter-module.do"
    const auto panicHandler = std::string("catch (const doof::Panic& _panic) { std::cerr << \"panic: \" << _panic.what() << std::endl; std::abort(); }");
#line 1028 "/src/emitter-module.do"
    const auto actorSetup = std::string("auto& __doof_application_domain = doof::detail::ApplicationDomain::shared(); doof::detail::ActiveActorScope __doof_application_scope(&__doof_application_domain); ");
#line 1029 "/src/emitter-module.do"
    return (((((((std::string("\nextern \"C\" int doof_entry_main(int argc, char** argv) { try { ") + actorSetup) + initializationCall) + argumentSetup) + success) + std::string(" } ")) + panicHandler) + std::string(" catch (const std::exception& error) { std::cerr << \"error: \" << error.what() << std::endl; return 1; } }\n"));
}
