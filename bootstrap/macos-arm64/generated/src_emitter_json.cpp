...
std::string emitInterfaceJsonDefinition(const std::shared_ptr<::app_src_ast_::InterfaceDeclaration>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    static_cast<void>((result = (result + std::string("    const auto* _object = doof::json_as_object(_json);\n"))));
    static_cast<void>((result = (((result + std::string("    if (_object == nullptr) { return ")) + failureType) + std::string("{\"Expected JSON object\"}; }\n"))));
    static_cast<void>((result = (((result + std::string("    auto _discriminator_iterator = _object->find(\"")) + discriminator->fieldName) + std::string("\");\n"))));
    static_cast<void>((result = (((((result + std::string("    if (_discriminator_iterator == _object->end() || !doof::json_is_string(_discriminator_iterator->second)) { return ")) + failureType) + std::string("{\"Missing or invalid discriminator field \\\"")) + discriminator->fieldName) + std::string("\\\"\"}; }\n"))));
    static_cast<void>((result = (result + std::string("    auto _discriminator = doof::json_as_string(_discriminator_iterator->second);\n"))));
    for (int32_t i = 0; i < static_cast<int32_t>((discriminator->entries)->size()); ++i) {
        const auto entry = doof::array_at(discriminator->entries, i, "src/emitter-json", 33);
        ...
        static_cast<void>((result = (((((result + std::string("    ")) + ((i == 0) ? std::string("if") : std::string("else if"))) + std::string(" (_discriminator == \"")) + entry->value) + std::string("\") {\n"))));
        static_cast<void>((result = (((result + std::string("        auto _result = ")) + className) + std::string("::fromJsonValue(_json, _lenient);\n"))));
        static_cast<void>((result = (((((result + std::string("        if (doof::is_success(_result)) { return ")) + successType) + std::string("{")) + owner->name) + std::string("{doof::success_value(_result)}}; }\n"))));
        static_cast<void>((result = (((result + std::string("        return ")) + failureType) + std::string("{doof::failure_error(_result)};\n"))));
...
std::string emitGeneratedJsonDeclarations(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    if (containsJsonDemand(context->jsonSerializationKeys, key)) {
        static_cast<void>((result = (result + std::string("    doof::JsonObject toJsonObject() const;\n"))));
    }
    if (containsJsonDemand(context->jsonDeserializationKeys, key)) {
        const auto valueType = jsonResultValueType(owner);
        static_cast<void>((result = (((result + std::string("    static doof::Result<")) + valueType) + std::string(", std::string> fromJsonValue(const doof::JsonValue& _json, bool _lenient);\n"))));
    }
    return result;
}
std::string emitGeneratedJsonMethods(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    auto result = std::string("");
    if (containsJsonDemand(context->jsonSerializationKeys, key)) {
        static_cast<void>((result = (result + emitToJsonObject(owner, context))));
    }
    if (containsJsonDemand(context->jsonDeserializationKeys, key)) {
        static_cast<void>((result = (result + emitFromJsonValue(owner, context))));
    }
    return result;
}
...
std::string emitToJsonObject(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    static_cast<void>((result = (result + std::string("    auto _json = std::make_shared<doof::ordered_map<std::string, doof::JsonValue>>();\n"))));
    ...
    for (const auto& field : *_iterable_7) {
        ...
        for (const auto& name : *_iterable_5) {
            static_cast<void>((result = (((((result + std::string("    (*_json)[\"")) + name) + std::string("\"] = ")) + emitJsonField((std::string("this->") + ::app_src_emitter_expr_::cppIdentifier(name)), doof::unwrap_optional(field->resolvedType), context)) + std::string(";\n"))));
        }
    }
...
std::string emitFromJsonValue(const std::shared_ptr<::app_src_ast_::ClassDeclaration>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    ...
    static_cast<void>((result = (result + std::string("    try {\n"))));
    static_cast<void>((result = (result + std::string("        const auto* _object = doof::json_as_object(_json);\n"))));
    static_cast<void>((result = (((result + std::string("        if (_object == nullptr) { return ")) + failureType) + std::string("{\"Expected JSON object\"}; }\n"))));
    ...
    for (const auto& field : *_iterable_11) {
        ...
        for (const auto& name : *_iterable_9) {
            if (field->const_) {
                static_cast<void>((result = (result + emitJsonConstFieldValidation(field, name, failureType))));
            } else {
                static_cast<void>((result = (result + emitJsonFieldRead(field, name, context, failureType))));
            }
        }
    }
    ...
    for (const auto& field : *_iterable_15) {
        ...
        for (const auto& name : *_iterable_13) {
            ...
            static_cast<void>((arguments = ((arguments + std::string("_field_")) + ::app_src_emitter_expr_::cppIdentifier(name))));
            if (!doof::is_null(field->defaultValue)) {
                static_cast<void>((arguments = (arguments + std::string(".value()"))));
            }
        }
    }
    auto constructed = (((owner->name + std::string("{")) + arguments) + std::string("}"));
    if (!owner->struct_) {
        static_cast<void>((constructed = ((((std::string("std::make_shared<") + owner->name) + std::string(">(")) + arguments) + std::string(")"))));
    }
...
std::string emitJsonConstFieldValidation(const std::shared_ptr<::app_src_ast_::ClassField>& field, const std::string& name, const std::string& failureType) {
    ...
    const auto iterator = (std::string("_iterator_") + ::app_src_emitter_expr_::cppIdentifier(name));
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::StringLiteral>>(_case_subject)) {
            ...
            static_cast<void>((result = (((((((((((((result + std::string("        if (!doof::json_is_string(")) + iterator) + std::string("->second) || doof::json_as_string(")) + iterator) + std::string("->second) != \"")) + value->value) + std::string("\") { return ")) + failureType) + std::string("{\"Field \\\"")) + name) + std::string("\\\" must be \\\"")) + value->value) + std::string("\\\"\"}; }\n"))));
            ...
            auto result = ((((((std::string("    if (auto ") + iterator) + std::string(" = _object->find(\"")) + name) + std::string("\"); ")) + iterator) + std::string(" != _object->end()) {\n"));
            static_cast<void>((result = (((((((((((((result + std::string("        if (!doof::json_is_number(")) + iterator) + std::string("->second) || doof::json_as_int(")) + iterator) + std::string("->second) != ")) + doof::to_string(value->value)) + std::string(") { return ")) + failureType) + std::string("{\"Field \\\"")) + name) + std::string("\\\" must be ")) + doof::to_string(value->value)) + std::string("\"}; }\n"))));
            return (result + std::string("    }\n"));
    }
    else {
            return std::string("");
...
std::string emitJsonFieldRead(const std::shared_ptr<::app_src_ast_::ClassField>& field, const std::string& name, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& failureType) {
    ...
    auto result = std::string("");
    if (!doof::is_null(field->defaultValue)) {
        static_cast<void>((result = (((((result + std::string("    std::optional<")) + typeText) + std::string("> ")) + value) + std::string(";\n"))));
        static_cast<void>((result = (((((((result + std::string("    if (auto ")) + iterator) + std::string(" = _object->find(\"")) + name) + std::string("\"); ")) + iterator) + std::string(" != _object->end()) {\n"))));
        static_cast<void>((result = (result + emitJsonValidation((iterator + std::string("->second")), type_, name, context, failureType, 2))));
        const auto read = emitJsonRead((iterator + std::string("->second")), type_, context);
        static_cast<void>((result = (((((((result + std::string("        ")) + value) + std::string(" = doof::json_decode_at(\"Field \\\"")) + name) + std::string("\\\"\", [&]() { return ")) + read) + std::string("; });\n"))));
        static_cast<void>((result = (result + std::string("    } else {\n"))));
        auto defaultValue = ::app_src_emitter_expr_::emitExpression(doof::unwrap_optional(field->defaultValue), context, doof::variant_promote<std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(type_));
        {
            auto _case_subject = doof::unwrap_optional(field->defaultValue);
            if (std::holds_alternative<std::shared_ptr<::app_src_ast_::NoneLiteral>>(_case_subject)) {
                static_cast<void>((defaultValue = (((typeText + std::string("{")) + defaultValue) + std::string("}"))));
        }
        else {
        }
        }
        static_cast<void>((result = (((((result + std::string("        ")) + value) + std::string(" = ")) + defaultValue) + std::string(";\n"))));
        return (result + std::string("    }\n"));
    }
    static_cast<void>((result = (((((result + std::string("    auto ")) + iterator) + std::string(" = _object->find(\"")) + name) + std::string("\");\n"))));
    static_cast<void>((result = (((((((result + std::string("    if (")) + iterator) + std::string(" == _object->end()) { return ")) + failureType) + std::string("{\"Missing required field \\\"")) + name) + std::string("\\\"\"}; }\n"))));
    static_cast<void>((result = (result + emitJsonValidation((iterator + std::string("->second")), type_, name, context, failureType, 1))));
    const auto read = emitJsonRead((iterator + std::string("->second")), type_, context);
    return (((((((result + std::string("    auto ")) + value) + std::string(" = doof::json_decode_at(\"Field \\\"")) + name) + std::string("\\\"\", [&]() { return ")) + read) + std::string("; });\n"));
}
std::string emitJsonValidation(const std::string& json, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::string& name, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& failureType, int32_t indent) {
    const auto prefix = ((indent == 2) ? std::string("            ") : std::string("        "));
    const auto check = emitJsonTypeCheck(json, type_, context);
    const auto expected = jsonTypeName(type_, context);
...
std::string emitJsonTypeCheck(const std::string& json, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::PrimitiveType>>(_case_subject)) {
            ...
            return ((std::string("doof::json_is_null(") + json) + std::string(")"));
    }
            ...
            if ((!doof::is_null(context)) && (enumBackingKind(enum_, doof::unwrap_optional(context)) == std::string("string"))) {
                return ((std::string("doof::json_is_string(") + json) + std::string(")"));
            }
            return ((std::string("doof::json_is_integer(") + json) + std::string(")"));
    }
            ...
            return (((std::string("doof::json_is_null(") + json) + std::string(") || ")) + emitJsonTypeCheck(json, inner, context));
    }
    else {
...
std::string emitJsonContainerRead(const std::string& json, const std::string& name, bool object_) {
    const auto kind = (object_ ? std::string("object") : std::string("array"));
    return ((((((((((std::string("const auto* ") + name) + std::string(" = doof::json_as_")) + kind) + std::string("(")) + json) + std::string("); if (")) + name) + std::string(" == nullptr) throw doof::JsonDecodeError(\"Expected ")) + kind) + std::string("\"); "));
}
std::string emitJsonRead(const std::string& json, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::PrimitiveType>>(_case_subject)) {
            ...
            return ((std::string("[&]() -> std::monostate { if (!doof::json_is_null(") + json) + std::string(")) throw doof::JsonDecodeError(\"Expected null\"); return {}; }()"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>>(_case_subject)) {
            return json;
    }
            ...
            const auto& enum_ = std::get<std::shared_ptr<::app_src_semantic_::EnumType>>(_case_subject);
            return ((((std::string("doof::json_decode_value(") + ::app_src_emitter_types_::emitContextType(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(enum_), context)) + std::string("_fromJsonValue(")) + json) + std::string(", false))"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject)) {
            ...
            return ((((((std::string("[&]() { ") + emitJsonContainerRead(json, std::string("_array"), false)) + std::string("auto _values = std::make_shared<std::vector<")) + elementType) + std::string(">>(); _values->reserve(_array->size()); for (size_t _index = 0; _index < _array->size(); ++_index) { const auto& _element = (*_array)[_index]; _values->push_back(doof::json_decode_at(std::string(\"[\") + doof::to_string(_index) + \"]\", [&]() { return ")) + elementValue) + std::string("; })); } return _values; }()"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::TupleResolvedType>>(_case_subject)) {
            const auto& tuple = std::get<std::shared_ptr<::app_src_semantic_::TupleResolvedType>>(_case_subject);
            ...
            for (int32_t i = 0; i < static_cast<int32_t>((tuple->elements)->size()); ++i) {
                if (i > 0) {
                    static_cast<void>((elements = (elements + std::string(", "))));
                }
                static_cast<void>((elements = (((((elements + std::string("doof::json_decode_at(\"[")) + doof::to_string(i)) + std::string("]\", [&]() { return ")) + emitJsonRead(((std::string("(*_tuple)[") + doof::to_string(i)) + std::string("]")), doof::array_at(tuple->elements, i, "src/emitter-json", 226), context)) + std::string("; })"))));
            }
            return ((((((((std::string("[&]() { ") + emitJsonContainerRead(json, std::string("_tuple"), false)) + std::string("if (_tuple->size() != ")) + doof::to_string(static_cast<int32_t>((tuple->elements)->size()))) + std::string(") throw doof::JsonDecodeError(\"Expected tuple of length ")) + doof::to_string(static_cast<int32_t>((tuple->elements)->size()))) + std::string("\"); return std::make_tuple(")) + elements) + std::string("); }()"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::MapResolvedType>>(_case_subject)) {
            ...
            return ((((((std::string("[&]() { ") + emitJsonContainerRead(json, std::string("_object_value"), true)) + std::string("auto _values = std::make_shared<doof::ordered_map<std::string, ")) + valueType) + std::string(">>(); for (const auto& _entry : *_object_value) { (*_values)[_entry.first] = doof::json_decode_at(std::string(\".\") + _entry.first, [&]() { return ")) + entryValue) + std::string("; }); } return _values; }()"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject)) {
            const auto& union_ = std::get<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject);
            const auto inner = doof::unwrap_optional(::app_src_json_semantics_::nullableJsonMember(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(union_)));
            ...
            if (::app_src_emitter_carriers_::carrierOf(type_, ::app_src_emitter_carriers_::CarrierPosition::Value)->kind == ::app_src_emitter_carriers_::CarrierKind::SharedPointer) {
                return ((((((std::string("(doof::json_is_null(") + json) + std::string(") \? ")) + ::app_src_emitter_carrier_values_::emitCarrierAbsence(type_, context)) + std::string(" : ")) + emitJsonRead(json, inner, context)) + std::string(")"));
            }
            const auto optionalType = ::app_src_emitter_types_::emitContextType(type_, context);
...
std::string jsonTypeName(const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::PrimitiveType>>(_case_subject)) {
            ...
            const auto& union_ = std::get<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject);
            return (jsonTypeName(doof::unwrap_optional(::app_src_json_semantics_::nullableJsonMember(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(union_))), context) + std::string(" or null"));
    }
    else {
...
std::string emitJsonField(const std::string& value, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& resolvedType, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>>(_case_subject)) {
            ...
            const auto& enum_ = std::get<std::shared_ptr<::app_src_semantic_::EnumType>>(_case_subject);
            return (((::app_src_emitter_types_::emitContextType(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(enum_), context) + std::string("_toJsonValue(")) + value) + std::string(")"));
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject)) {
            const auto& union_ = std::get<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject);
            const auto inner = doof::unwrap_optional(::app_src_json_semantics_::nullableJsonMember(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(union_)));
            ...
            if (::app_src_emitter_carriers_::carrierOf(resolvedType, ::app_src_emitter_carriers_::CarrierPosition::Value)->kind == ::app_src_emitter_carriers_::CarrierKind::SharedPointer) {
            ...
            for (int32_t i = 0; i < static_cast<int32_t>((tuple->elements)->size()); ++i) {
                ...
                static_cast<void>((elements = (elements + emitJsonField(((((std::string("std::get<") + doof::to_string(i)) + std::string(">(")) + value) + std::string(")")), doof::array_at(tuple->elements, i, "src/emitter-json", 322), context))));
            }
...
std::string enumBackingKind(const std::shared_ptr<::app_src_semantic_::EnumType>& enum_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context) {
    const auto declaration = findEnumDeclaration(context, enum_->symbol->module, enum_->name);
...
std::shared_ptr<::app_src_ast_::EnumDeclaration> findEnumDeclaration(const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::string& modulePath, const std::string& name) {
    const auto& _iterable_21 = context->allPrograms;
    for (const auto& program : *_iterable_21) {
        const auto& _iterable_19 = program->statements;
        for (const auto& statement : *_iterable_19) {
            const auto declaration = enumStatementDeclaration(statement);
            if ((!doof::is_null(declaration)) && (declaration->name == name)) {
                return declaration;
            }
        }
    }
