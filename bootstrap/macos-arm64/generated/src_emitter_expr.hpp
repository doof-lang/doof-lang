...
namespace app_src_emitter_carrier_values_ {
    std::string emitCarrierConversion(const std::string& value, const doof_header_type_11& source, const doof_header_type_11& target, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, ::app_src_emitter_carriers_::CarrierPosition position);
}
...
namespace app_src_emitter_expr_literals_ {
    std::string emitNoneLiteral(const doof_header_type_12& expected, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitChar(char32_t value);
    std::string emitArray(const std::shared_ptr<::app_src_ast_::ArrayLiteral>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_12& expected);
    std::string emitObject(const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_12& expected);
...
namespace app_src_emitter_expr_control_ {
    ...
    std::string emitIfExpression(const std::shared_ptr<::app_src_ast_::IfExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_13& expected);
    std::string emitYieldBlockExpression(const std::shared_ptr<::app_src_ast_::YieldBlockExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_13& expected);
    ...
    std::string emitCaseExpression(const std::shared_ptr<::app_src_ast_::CaseExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_13& expected);
}
...
namespace app_src_emitter_expr_ {
    std::string emitExpression(const doof_header_type_14& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_15& expected);
    std::string emitDiscardedExpression(const doof_header_type_14& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    std::string emitJsonValuePromotion(const doof_header_type_14& expression, const std::string& value, const doof_header_type_15& source, const doof_header_type_15& expected);
    std::string cppIdentifier(const std::string& name);
