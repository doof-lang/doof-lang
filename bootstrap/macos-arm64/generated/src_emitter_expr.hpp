...
namespace app_src_emitter_expr_utils_ {
    doof_header_type_10 decoratedExpressionType(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression);
    bool needsNullableVariantPromotion(const doof_header_type_10& source, const doof_header_type_10& expected);
    std::string emitNullableVariantPromotion(const std::string& value, const doof_header_type_10& source, const doof_header_type_10& expected, const std::string& currentModulePath);
    bool needsVariantPromotion(const doof_header_type_10& source, const doof_header_type_10& expected);
}
...
namespace app_src_emitter_expr_ {
    std::string emitExpression(const doof_header_type_13& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_14& expected);
    std::string emitJsonValuePromotion(const doof_header_type_13& expression, const std::string& value, const doof_header_type_14& source, const doof_header_type_14& expected);
    std::string cppIdentifier(const std::string& name);
