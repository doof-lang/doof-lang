    ...
    }
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject)) {
            ...
            if (property == std::string("dispatch")) {
                if (doof::kind(function_->returnType) != std::string("none")) {
                            ...
                            if (!doof::is_null(method->resolvedType)) {
                                {
                                    ...
                                    if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject)) {
                                        ...
                                        if ((doof::kind(successType) != std::string("none")) && !::app_src_json_semantics_::isGeneratedJsonType(successType, jsonPrograms(state->result), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}))) {
