        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::NamedType>>(_case_subject)) {
            ...
            if (((named->name == std::string("none")) || (named->name == std::string("void"))) || (named->name == std::string("null"))) {
                ...
                if ((named->name != std::string("none")) && doof::is_null(named->resolvedType)) {
                    (static_cast<void>(::app_src_checker_common_::deprecatedNoneAlias(state, named->name, named->span, module->path)), std::monostate{});
                }
            ...
            if (named->name == std::string("Tuple")) {
                ...
                for (const auto& argument : *_iterable_2) {
                    (static_cast<void>(elements->push_back(resolveType(state, argument, module, scope, validateConstraints))), std::monostate{});
                }
            ...
            if ((named->name == std::string("Map")) || (named->name == std::string("ReadonlyMap"))) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 2) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, (named->name + std::string(" requires two type arguments")), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                const auto key = resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 88), module, scope, validateConstraints);
                const auto value = resolveType(state, doof::array_at(named->typeArgs, 1, "src/checker-resolution", 89), module, scope, validateConstraints);
            ...
            if ((named->name == std::string("Set")) || (named->name == std::string("ReadonlySet"))) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 1) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, (named->name + std::string(" requires one type argument")), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                const auto element = resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 94), module, scope, validateConstraints);
                if (!::app_src_checker_types_::isSupportedHashCollectionType(element)) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Set element type \"") + ::app_src_checker_types_::typeName(element)) + std::string("\" is not supported; set elements must be byte, string, int, long, char, bool, or enum")), std::visit([](auto&& _obj) { return _obj->span; }, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 96)))), std::monostate{});
                }
            ...
            if (named->name == std::string("Stream")) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 1) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Stream requires one type argument"), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                return decorateType(state, annotation, ::app_src_checker_types_::streamType(resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 102), module, scope, validateConstraints)));
            }
            if (named->name == std::string("Actor")) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 1) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Actor requires one type argument"), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                const auto inner = resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 106), module, scope, validateConstraints);
                {
                    ...
                    if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject)) {
                        ...
                        (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Actor requires a class type"), named->span)), std::monostate{});
                        return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                }
                doof::unreachable();
            ...
            if (named->name == std::string("Promise")) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 1) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Promise requires one type argument"), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                return decorateType(state, annotation, ::app_src_checker_types_::promiseType(resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 114), module, scope, validateConstraints)));
            }
            if (named->name == std::string("Result")) {
                if (static_cast<int32_t>((named->typeArgs)->size()) != 2) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Result requires two type arguments"), named->span)), std::monostate{});
                    return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                return decorateType(state, annotation, ::app_src_checker_types_::resultType(resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 118), module, scope, validateConstraints), resolveType(state, doof::array_at(named->typeArgs, 1, "src/checker-resolution", 118), module, scope, validateConstraints)));
            }
            if ((named->name == std::string("Success")) || (named->name == std::string("Failure"))) {
                ...
                const auto payload = resolveType(state, doof::array_at(named->typeArgs, 0, "src/checker-resolution", 122), module, scope, validateConstraints);
            ...
            if (doof::is_null(symbol)) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Unknown type '") + named->name) + std::string("'")), named->span)), std::monostate{});
                return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
            }
                ...
                }
                {
                    ...
                    if (std::holds_alternative<std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>>(_case_subject)) {
                        ...
                        if (static_cast<int32_t>((named->typeArgs)->size()) != static_cast<int32_t>((alias->typeParams)->size())) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((((alias->name + std::string(" requires ")) + doof::to_string(static_cast<int32_t>((alias->typeParams)->size()))) + std::string(" type argument")) + ((static_cast<int32_t>((alias->typeParams)->size()) == 1) ? std::string("") : std::string("s"))), named->span)), std::monostate{});
                            return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                        }
                        ...
                        for (const auto& typeParam : *_iterable_4) {
                            (static_cast<void>(aliasScope->typeParams->push_back(typeParam)), std::monostate{});
                        }
                        auto resolvedAlias = resolveType(state, alias->type_, ::app_src_checker_interfaces_::classModuleFor(state->result, doof::unwrap_optional(symbol)), aliasScope, false);
                        ...
                        for (const auto& argument : *_iterable_6) {
                            (static_cast<void>(typeArgs->push_back(resolveType(state, argument, module, scope, validateConstraints))), std::monostate{});
                        }
                        if (validateConstraints) {
                            (static_cast<void>(validateTypeArgumentConstraints(state, alias->typeParams, alias->typeParamConstraints, typeArgs, named->span, ::app_src_checker_interfaces_::classModuleFor(state->result, doof::unwrap_optional(symbol)), scope, std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>(std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>{}))), std::monostate{});
                        }
            ...
            if (symbol->kind == std::string("interface")) {
                ...
                if (!doof::is_null(declaration)) {
                    {
                        ...
                        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::InterfaceDeclaration>>(_case_subject)) {
                            ...
                            if (validateConstraints) {
                                (static_cast<void>(validateTypeArgumentConstraints(state, interfaceDeclaration->typeParams, interfaceDeclaration->typeParamConstraints, typeArgs, named->span, ::app_src_checker_interfaces_::classModuleFor(state->result, doof::unwrap_optional(symbol)), scope, std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>(std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>{}))), std::monostate{});
                            }
                    }
                    else {
                    }
                ...
                if (::app_src_checker_interfaces_::concreteTypes(typeArgs)) {
                    (static_cast<void>(::app_src_checker_interfaces_::registerConcreteInterfaceImplementations(state->result, concreteInterface)), std::monostate{});
                }
            ...
            if (!doof::is_null(declaration)) {
                {
                    ...
                    if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
                        ...
                        if (validateConstraints) {
                            (static_cast<void>(validateTypeArgumentConstraints(state, classDeclaration->typeParams, classDeclaration->typeParamConstraints, typeArgs, named->span, ::app_src_checker_interfaces_::classModuleFor(state->result, doof::unwrap_optional(symbol)), scope, std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>(std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>{}))), std::monostate{});
                        }
                }
                else {
                        (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Symbol '") + named->name) + std::string("' is not a type")), named->span)), std::monostate{});
                        return decorateType(state, annotation, ::app_src_checker_types_::unknownType());
                }
                }
            ...
            return decorateType(state, annotation, ::app_src_checker_types_::arrayType(resolveType(state, array->elementType, module, scope, validateConstraints), array->readonly_));
    }
            ...
            for (const auto& item : *_iterable_12) {
                (static_cast<void>(members->push_back(resolveType(state, item, module, scope, validateConstraints))), std::monostate{});
            }
            ...
            for (const auto& parameter : *_iterable_14) {
                (static_cast<void>(params->push_back(std::make_shared<::app_src_semantic_::FunctionParamType>(parameter->name, resolveType(state, parameter->type_, module, scope, validateConstraints), false))), std::monostate{});
            }
            return decorateType(state, annotation, ::app_src_checker_types_::functionType(params, resolveType(state, function_->returnType, module, scope, validateConstraints), std::make_shared<std::vector<std::string>>(std::vector<std::string>{})));
    }
            ...
            const auto inner = resolveType(state, weak_->type_, module, scope, validateConstraints);
            if (!::app_src_checker_types_::isWeakReferenceTarget(inner)) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Type \"") + ::app_src_checker_types_::typeName(inner)) + std::string("\" is not a valid weak reference target")), weak_->span)), std::monostate{});
            }
...
bool rejectUnexpectedTypeArguments(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::NamedType>& named, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope) {
    ...
    for (const auto& argument : *_iterable_16) {
        resolveType(state, argument, module, scope, true);
    }
    (static_cast<void>(::app_src_checker_common_::typeError(state, (named->name + std::string(" does not accept type arguments")), named->span)), std::monostate{});
    return true;
}
bool validateNominalTypeArity(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& name, int32_t expected, int32_t actual, ::app_src_ast_::SourceSpan span) {
    ...
    (static_cast<void>(::app_src_checker_common_::typeError(state, ((((((name + std::string(" requires ")) + doof::to_string(expected)) + std::string(" type argument")) + ((expected == 1) ? std::string("") : std::string("s"))) + std::string("; received ")) + doof::to_string(actual)), span)), std::monostate{});
    return false;
}
void validateTypeArgumentConstraints(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::TypeParameterConstraint>>>& constraints, const std::shared_ptr<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>& arguments, ::app_src_ast_::SourceSpan span, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& outer, const std::shared_ptr<std::vector<std::string>>& ownerNames, const std::shared_ptr<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>& ownerArguments) {
    if (static_cast<int32_t>((names)->size()) != static_cast<int32_t>((arguments)->size())) {
        return;
    }
    const auto constraintScope = std::make_shared<::app_src_semantic_::Scope>(outer, std::make_shared<std::vector<std::shared_ptr<::app_src_semantic_::Binding>>>(std::vector<std::shared_ptr<::app_src_semantic_::Binding>>{}), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::make_shared<std::vector<std::shared_ptr<::app_src_semantic_::ResolvedTypeConstraint>>>(std::vector<std::shared_ptr<::app_src_semantic_::ResolvedTypeConstraint>>{}), std::monostate{}, std::monostate{}, std::string(""), false, false, std::monostate{}, std::monostate{}, false, std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>>(std::vector<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>{}), false, std::nullopt);
    const auto& _iterable_18 = ownerNames;
    for (const auto& name : *_iterable_18) {
        (static_cast<void>(constraintScope->typeParams->push_back(name)), std::monostate{});
        (static_cast<void>(constraintScope->typeParamConstraintNames->push_back(std::string(""))), std::monostate{});
        (static_cast<void>(constraintScope->typeParamConstraints->push_back(std::make_shared<::app_src_semantic_::ResolvedTypeConstraint>(std::monostate{}))), std::monostate{});
    }
    const auto& _iterable_20 = names;
    ...
    for (int32_t index = 0; index < static_cast<int32_t>((names)->size()); ++index) {
        if ((index >= static_cast<int32_t>((constraints)->size())) || doof::is_null(doof::array_at(constraints, index, "src/checker-resolution", 246)->type_)) {
            continue;
        }
        const auto annotation = doof::unwrap_optional(doof::array_at(constraints, index, "src/checker-resolution", 247)->type_);
        {
            auto _case_subject = annotation;
            if (std::holds_alternative<std::shared_ptr<::app_src_ast_::NamedType>>(_case_subject)) {
                const auto& named = std::get<std::shared_ptr<::app_src_ast_::NamedType>>(_case_subject);
                if ((static_cast<int32_t>((named->typeArgs)->size()) == 0) && ((named->name == std::string("Reflectable")) || (named->name == std::string("JsonSerializable")))) {
                    {
                        auto _case_subject = doof::array_at(arguments, index, "src/checker-resolution", 251);
                        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::TypeParameterType>>(_case_subject)) {
                            ...
                            if (parameter->constraintName == named->name) {
                                continue;
                            }
                    }
                    else {
                ...
                if ((static_cast<int32_t>((named->typeArgs)->size()) == 0) && (named->name == std::string("Reflectable"))) {
                    {
                        auto _case_subject = doof::array_at(arguments, index, "src/checker-resolution", 257);
                        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject)) {
                            memberType(state, doof::array_at(arguments, index, "src/checker-resolution", 258), std::string("metadata"), span, true, false);
                    }
                    else {
                            (static_cast<void>(reportConstraintViolation(state, doof::array_at(names, index, "src/checker-resolution", 259), doof::array_at(arguments, index, "src/checker-resolution", 259), std::string("Reflectable"), span)), std::monostate{});
                    }
                    }
                    continue;
                }
                if ((static_cast<int32_t>((named->typeArgs)->size()) == 0) && (named->name == std::string("JsonSerializable"))) {
                    const auto result = memberType(state, doof::array_at(arguments, index, "src/checker-resolution", 264), std::string("fromJsonValue"), span, true, false);
                    if (std::visit([](auto&& _obj) { return _obj->kind; }, result) == std::string("unknown")) {
                        (static_cast<void>(reportConstraintViolation(state, doof::array_at(names, index, "src/checker-resolution", 265), doof::array_at(arguments, index, "src/checker-resolution", 265), std::string("JsonSerializable"), span)), std::monostate{});
                    }
                    continue;
                }
        }
        ...
        const auto resolvedConstraint = resolveType(state, annotation, module, constraintScope, false);
        const auto substitutedConstraint = ::app_src_checker_types_::substituteTypeParams(::app_src_checker_types_::substituteTypeParams(resolvedConstraint, ownerNames, ownerArguments), names, arguments);
        if (::app_src_checker_numeric_::isNumericConstraint(substitutedConstraint)) {
            if (!::app_src_checker_numeric_::satisfiesNumericConstraint(doof::array_at(arguments, index, "src/checker-resolution", 274), substitutedConstraint)) {
                (static_cast<void>(reportConstraintViolation(state, doof::array_at(names, index, "src/checker-resolution", 274), doof::array_at(arguments, index, "src/checker-resolution", 274), ::app_src_checker_types_::typeName(substitutedConstraint), span)), std::monostate{});
            }
        } else if (!::app_src_checker_interfaces_::isAssignableWithInterfaces(state->result, doof::array_at(arguments, index, "src/checker-resolution", 275), substitutedConstraint)) {
            (static_cast<void>(reportConstraintViolation(state, doof::array_at(names, index, "src/checker-resolution", 276), doof::array_at(arguments, index, "src/checker-resolution", 276), ::app_src_checker_types_::typeName(substitutedConstraint), span)), std::monostate{});
        }
    }
}
void reportConstraintViolation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& typeParam, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& argument, const std::string& constraint, ::app_src_ast_::SourceSpan span) {
    (static_cast<void>(::app_src_checker_common_::typeError(state, ((((((std::string("Type \"") + ::app_src_checker_types_::typeName(argument)) + std::string("\" does not satisfy constraint \"")) + constraint) + std::string("\" for type parameter \"")) + typeParam) + std::string("\"")), span)), std::monostate{});
}
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject)) {
            ...
            if (property == std::string("dispatch")) {
                if (std::visit([](auto&& _obj) { return _obj->kind; }, function_->returnType) != std::string("none")) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Method \"dispatch\" is only available on none-returning callbacks"), span)), std::monostate{});
            ...
            for (const auto& member : *_iterable_23) {
                ...
                const auto memberValue = memberType(state, member, property, span, validateVisibility, false);
                if (std::visit([](auto&& _obj) { return _obj->kind; }, memberValue) == std::string("unknown")) {
                    return ::app_src_checker_types_::unknownType();
                }
                (resolved = [&]() -> std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { if (doof::is_null(resolved)) { return doof::variant_promote<std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(memberValue); } return doof::variant_promote<std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(::app_src_checker_types_::joinTypes(doof::unwrap_optional(resolved), memberValue)); }());
            }
            ...
            if (array->readonly_ && ((((property == std::string("push")) || (property == std::string("reserve"))) || (property == std::string("pop"))) || (property == std::string("takeFirstCompleted")))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Method \"") + property) + std::string("\" is not available on readonly array")), span)), std::monostate{});
                return ::app_src_checker_types_::unknownType();
            }
            ...
            if (property == std::string("buildReadonly")) {
                (static_cast<void>(::app_src_checker_common_::deprecatedBuildReadonly(state, span)), std::monostate{});
            ...
            if (map->readonly_ && ((property == std::string("set")) || (property == std::string("delete")))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Method \"") + property) + std::string("\" is not available on readonly map")), span)), std::monostate{});
                return ::app_src_checker_types_::unknownType();
            }
            ...
            if (set->readonly_ && (property == std::string("add"))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Method \"add\" is not available on readonly set"), span)), std::monostate{});
                return ::app_src_checker_types_::unknownType();
            }
            ...
            if (set->readonly_ && (property == std::string("delete"))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Method \"delete\" is not available on readonly set"), span)), std::monostate{});
                return ::app_src_checker_types_::unknownType();
            }
            if (property == std::string("delete")) {
                return ::app_src_checker_types_::functionType(std::make_shared<std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>>(std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>{std::make_shared<::app_src_semantic_::FunctionParamType>(std::string("value"), set->elementType, false)}), ::app_src_checker_types_::noneType(), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}));
            ...
            if (set->readonly_ && (((property == std::string("buildReadonly")) || (property == std::string("drainToReadonly"))) || (property == std::string("cloneReadonly")))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Method \"") + property) + std::string("\" is not available on readonly set")), span)), std::monostate{});
                return ::app_src_checker_types_::unknownType();
            }
            if (property == std::string("buildReadonly")) {
                (static_cast<void>(::app_src_checker_common_::deprecatedBuildReadonly(state, span)), std::monostate{});
            ...
            if (property == std::string("unwrapOr")) {
                if (std::visit([](auto&& _obj) { return _obj->kind; }, result->valueType) == std::string("none")) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Method \"unwrapOr\" is not available on Result<void, E>"), span)), std::monostate{});
                    return ::app_src_checker_types_::unknownType();
                }
            ...
            for (int32_t i = 0; i < static_cast<int32_t>((tuple->elements)->size()); ++i) {
                if (property == (std::string("_") + doof::to_string((i + 1)))) {
                    return doof::array_at(tuple->elements, i, "src/checker-resolution", 432);
                }
            }
            return ::app_src_checker_types_::unknownType();
    }
            ...
            return memberType(state, doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(actor->innerClass), property, span, true, false);
    }
            ...
            const auto& parameter = std::get<std::shared_ptr<::app_src_semantic_::TypeParameterType>>(_case_subject);
            const auto bound = ::app_src_checker_types_::interfaceBoundReceiver(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(parameter));
            if (std::visit([](auto&& _obj) { return _obj->kind; }, bound) == std::string("interface")) {
                return memberType(state, bound, property, span, validateVisibility, true);
            }
            if (property == std::string("metadata")) {
                if (parameter->constraintName != std::string("Reflectable")) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Static member \"metadata\" requires type parameter \"") + parameter->name) + std::string("\" to be constrained by Reflectable")), span)), std::monostate{});
                    return ::app_src_checker_types_::unknownType();
                }
            ...
            if (property == std::string("fromJsonValue")) {
                if (parameter->constraintName != std::string("JsonSerializable")) {
                    (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Static member \"fromJsonValue\" requires type parameter \"") + parameter->name) + std::string("\" to be constrained by JsonSerializable")), span)), std::monostate{});
                    return ::app_src_checker_types_::unknownType();
                }
            ...
            if (!doof::is_null(declaration)) {
                {
                    ...
                    if (std::holds_alternative<std::shared_ptr<::app_src_ast_::EnumDeclaration>>(_case_subject)) {
                        const auto& enumDeclaration = std::get<std::shared_ptr<::app_src_ast_::EnumDeclaration>>(_case_subject);
                        const auto& _iterable_26 = enumDeclaration->variants;
                        for (const auto& variant : *_iterable_26) {
                ...
                if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
                    ...
                    if (property == std::string("metadata")) {
                        if (static_cast<int32_t>((classDeclaration->typeParams)->size()) > 0) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Metadata is not available on generic type \"") + classDeclaration->name) + std::string("\"")), span)), std::monostate{});
                            return ::app_src_checker_types_::unknownType();
                        }
                        if (!::app_src_json_semantics_::canGenerateJsonSerialization(classDeclaration, jsonPrograms(state->result), nullptr) || !::app_src_json_semantics_::canGenerateJsonDeserialization(classDeclaration, jsonPrograms(state->result), nullptr)) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Type \"") + classDeclaration->name) + std::string("\" is not eligible for metadata because it does not support automatic JSON generation")), span)), std::monostate{});
                            return ::app_src_checker_types_::unknownType();
                        }
                        auto valid = true;
                        const auto& _iterable_30 = classDeclaration->methods;
                        for (const auto& method : *_iterable_30) {
                            ...
                            for (const auto& parameter : *_iterable_28) {
                                if ((!doof::is_null(parameter->resolvedType)) && !::app_src_json_semantics_::isGeneratedJsonType(doof::unwrap_optional(parameter->resolvedType), jsonPrograms(state->result), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}))) {
                                    (static_cast<void>(::app_src_checker_common_::typeError(state, ((((std::string("Parameter \"") + parameter->name) + std::string("\" of method \"")) + method->name) + std::string("\" is not JSON-serializable")), parameter->span)), std::monostate{});
                                    (valid = false);
                                }
                            }
                            if (!doof::is_null(method->resolvedType)) {
                                {
                                    ...
                                    if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject)) {
                                        ...
                                        if ((std::visit([](auto&& _obj) { return _obj->kind; }, successType) != std::string("none")) && !::app_src_json_semantics_::isGeneratedJsonType(successType, jsonPrograms(state->result), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}))) {
                                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Return type of method \"") + method->name) + std::string("\" is not JSON-serializable")), method->span)), std::monostate{});
                                            (valid = false);
                                        }
                                }
                                else {
                    ...
                    if ((property == std::string("toJsonObject")) || (property == std::string("fromJsonValue"))) {
                        (static_cast<void>(::app_src_checker_common_::typeError(state, (((std::string("Type \"") + classDeclaration->name) + std::string("\" does not support automatic JSON ")) + ((property == std::string("toJsonObject")) ? std::string("serialization") : std::string("deserialization"))), span)), std::monostate{});
                        return ::app_src_checker_types_::unknownType();
                    }
                    ...
                    const auto& _iterable_40 = interface_->fields;
                    for (const auto& field : *_iterable_40) {
                        if (field->name == property) {
                            return [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { auto _coalesce_38 = field->resolvedType; if (doof::is_null(_coalesce_38)) return resolveType(state, field->type_, doof::unwrap_optional(state->info), doof::unwrap_optional(state->moduleScope), true); return doof::unwrap_optional(_coalesce_38); }();
                        }
                    }
                    const auto& _iterable_43 = interface_->methods;
                    for (const auto& method : *_iterable_43) {
                        if (method->name == property) {
                            return [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { auto _coalesce_41 = method->resolvedType; if (doof::is_null(_coalesce_41)) return ::app_src_checker_symbols_::methodSignature(method, ::app_src_checker_interfaces_::classModuleFor(state->result, class_->symbol), state->result); return doof::unwrap_optional(_coalesce_41); }();
                        }
                    }
            }
            else {
            ...
            }
            {
                ...
                if (std::holds_alternative<std::shared_ptr<::app_src_ast_::InterfaceDeclaration>>(_case_subject)) {
                    ...
                    for (const auto& field : *_iterable_46) {
                        if (field->name == property) {
                            const auto fieldType = [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { auto _coalesce_44 = field->resolvedType; if (doof::is_null(_coalesce_44)) return ::app_src_checker_symbols_::resolveAnnotation(field->type_, ::app_src_checker_interfaces_::classModuleFor(state->result, interfaceType_->symbol), state->result, interface_->typeParams); return doof::unwrap_optional(_coalesce_44); }();
                            return ::app_src_checker_types_::substituteTypeParams([&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { if (field->readonly_) { return ::app_src_checker_types_::applyDeepReadonly(fieldType); } return fieldType; }(), interface_->typeParams, interfaceType_->typeArgs);
                        }
                    }
                    const auto& _iterable_49 = interface_->methods;
                    for (const auto& method : *_iterable_49) {
                        if (method->name == property) {
                            const auto methodType = [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { auto _coalesce_47 = method->resolvedType; if (doof::is_null(_coalesce_47)) return interfaceMethodSignature(state, method, interface_, interfaceType_->symbol); return doof::unwrap_optional(_coalesce_47); }();
                    ...
                    if (property == std::string("fromJsonValue")) {
                        if (static_cast<int32_t>((interface_->typeParams)->size()) > 0) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Automatic JSON deserialization is not available on generic interface \"") + interface_->name) + std::string("\"")), span)), std::monostate{});
                            return ::app_src_checker_types_::unknownType();
                        }
                        if (static_cast<int32_t>((interfaceType_->symbol->implementations)->size()) == 0) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Cannot deserialize interface \"") + interface_->name) + std::string("\": no implementing classes found")), span)), std::monostate{});
                            return ::app_src_checker_types_::unknownType();
                        }
                        ...
                        if (doof::is_null(discriminator)) {
                            (static_cast<void>(::app_src_checker_common_::typeError(state, ((std::string("Cannot deserialize interface \"") + interface_->name) + std::string("\": all implementing classes must share a const string field with distinct values (e.g. const kind = \"variant\")")), span)), std::monostate{});
                            return ::app_src_checker_types_::unknownType();
                        }
...
std::shared_ptr<::app_src_semantic_::Binding> fieldAssignmentBinding(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& object, const std::string& property, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& fieldType, ::app_src_ast_::SourceSpan span) {
    {
        auto _case_subject = ::app_src_checker_types_::interfaceBoundReceiver(object);
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject)) {
            const auto& union_ = std::get<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject);
            std::shared_ptr<::app_src_semantic_::Binding> selected = nullptr;
            const auto& _iterable_51 = union_->types;
            for (const auto& member : *_iterable_51) {
                if (std::visit([](auto&& _obj) { return _obj->kind; }, member) == std::string("none")) {
                    continue;
                }
                const auto concreteType = memberType(state, member, property, span, false, false);
                if (!::app_src_checker_types_::sameType(concreteType, fieldType)) {
                    return nullptr;
                }
                const auto binding = fieldAssignmentBinding(state, member, property, concreteType, span);
                if (doof::is_null(binding)) {
                    return nullptr;
                }
                if (doof::is_null(selected) || !binding->mutable_) {
                    (selected = binding);
                }
            }
            return selected;
            ...
            const auto& actor = std::get<std::shared_ptr<::app_src_semantic_::ActorType>>(_case_subject);
            return fieldAssignmentBinding(state, doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(actor->innerClass), property, fieldType, span);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject)) {
            const auto& class_ = std::get<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject);
            const auto declaration = ::app_src_checker_symbols_::declarationFor(state->result, class_->symbol);
            ...
            }
            {
                ...
                if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
                    const auto& classDeclaration = std::get<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject);
                    const auto& _iterable_55 = classDeclaration->fields;
                    for (const auto& field : *_iterable_55) {
                        const auto& _iterable_53 = field->names;
                        for (const auto& name : *_iterable_53) {
                            if (name == property) {
            ...
            }
            {
                ...
                if (std::holds_alternative<std::shared_ptr<::app_src_ast_::InterfaceDeclaration>>(_case_subject)) {
                    const auto& interface_ = std::get<std::shared_ptr<::app_src_ast_::InterfaceDeclaration>>(_case_subject);
                    const auto& _iterable_57 = interface_->fields;
...
std::shared_ptr<std::vector<std::shared_ptr<::app_src_ast_::Program>>> jsonPrograms(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result) {
    ...
    const auto& _iterable_59 = result->modules;
...
std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> indexType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& object, const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& index, ::app_src_ast_::SourceSpan span) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject)) {
            ...
            if (!::app_src_checker_interfaces_::isAssignableWithInterfaces(state->result, index, ::app_src_checker_types_::primitive(std::string("int"))) && (::app_src_checker_types_::typeName(index) != std::string("unknown"))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Index must be an int"), span)), std::monostate{});
            }
            ...
            if (!::app_src_checker_interfaces_::isAssignableWithInterfaces(state->result, index, map->keyType) && (::app_src_checker_types_::typeName(index) != std::string("unknown"))) {
                (static_cast<void>(::app_src_checker_common_::typeError(state, std::string("Invalid map key type"), span)), std::monostate{});
            }
...
std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> interfaceMethodSignature(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& method, const std::shared_ptr<::app_src_ast_::InterfaceDeclaration>& owner, const std::shared_ptr<::app_src_semantic_::Symbol>& symbol) {
    const auto module = ::app_src_checker_interfaces_::classModuleFor(state->result, symbol);
    std::shared_ptr<std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>> params = std::make_shared<std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>>(std::vector<std::shared_ptr<::app_src_semantic_::FunctionParamType>>{});
    const auto& _iterable_61 = method->params;
    for (const auto& parameter : *_iterable_61) {
        const auto type_ = [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { if (doof::is_null(parameter->type_)) { return ::app_src_checker_types_::unknownType(); } return ::app_src_checker_symbols_::resolveAnnotation(doof::unwrap_optional(parameter->type_), module, state->result, owner->typeParams); }();
        (static_cast<void>(params->push_back(std::make_shared<::app_src_semantic_::FunctionParamType>(parameter->name, type_, (!doof::is_null(parameter->defaultValue))))), std::monostate{});
    }
    return ::app_src_checker_types_::functionType(params, [&]() -> std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> { if (doof::is_null(method->returnType)) { return ::app_src_checker_types_::noneType(); } return ::app_src_checker_symbols_::resolveAnnotation(doof::unwrap_optional(method->returnType), module, state->result, owner->typeParams); }(), std::make_shared<std::vector<std::string>>(std::vector<std::string>{}));
}
}
