...
namespace app_src_emitter_types_ {
    std::string emitResultPayloadType(const doof_header_type_10& resolvedType, const std::string& currentModulePath);
    ...
    bool usesNullableSingleValueRepresentation(const doof_header_type_10& type_);
}
...
namespace app_src_emitter_case_pattern_ {
    std::shared_ptr<CaseTypePatternEmission> emitCaseTypePattern(const std::shared_ptr<::app_src_ast_::TypePattern>& pattern, const doof_header_type_11& subjectType, const std::string& subject, const std::string& bindingName, const std::string& currentModulePath);
    ...
    std::shared_ptr<CaseTypePatternEmission> emitJsonValuePattern(const doof_header_type_11& patternType, const std::string& subject, const std::string& bindingName);
}
