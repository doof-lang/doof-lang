...
namespace app_src_checker_annotations_ {
    struct AnnotationResolution : public std::enable_shared_from_this<AnnotationResolution> {
    std::shared_ptr<::app_src_checker_state_::CheckerState> state;
    bool commit;
    std::shared_ptr<std::vector<std::string>> aliases;
    AnnotationResolution(std::shared_ptr<::app_src_checker_state_::CheckerState> state, bool commit, std::shared_ptr<std::vector<std::string>> aliases) : state(state), commit(commit), aliases(aliases) {}
};
}
...
namespace app_src_checker_types_ {
    ...
    doof_header_type_9 streamType(const doof_header_type_9& element);
...
namespace app_src_checker_numeric_ {
    bool isNumericConstraint(const doof_header_type_13& type_);
    bool satisfiesNumericConstraint(const doof_header_type_13& value, const doof_header_type_13& constraint);
}

namespace app_src_checker_annotations_ {
    doof_header_type_14 resolveCheckedAnnotation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_15& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    doof_header_type_14 resolveProvisionalAnnotation(const doof_header_type_15& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::string>>& typeParams);
    doof_header_type_14 finishAnnotation(const std::shared_ptr<AnnotationResolution>& resolution, const doof_header_type_15& annotation, const doof_header_type_14& type_);
    doof_header_type_14 decorateAnnotationType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_15& annotation, const doof_header_type_14& resolvedType);
    doof_header_type_14 resolveAnnotationType(const std::shared_ptr<AnnotationResolution>& resolution, const doof_header_type_15& annotation, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    bool rejectUnexpectedTypeArguments(const std::shared_ptr<AnnotationResolution>& resolution, const std::shared_ptr<::app_src_ast_::NamedType>& named, const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& module, const std::shared_ptr<::app_src_semantic_::Scope>& scope, bool validateConstraints);
    ...
    void reportConstraintViolation(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::string& typeParam, const doof_header_type_14& argument, const std::string& constraint, ::app_src_ast_::SourceSpan span);
}
