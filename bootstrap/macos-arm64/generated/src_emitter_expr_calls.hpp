...
namespace app_src_emitter_expr_utils_ {
    std::string emitPropertyValue(const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_14& expected);
    doof_header_type_14 decoratedExpressionType(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression);
    doof_header_type_14 optionalExpectedType(const doof_header_type_15& value);
    std::string variantVisitValue(const std::string& value, const doof_header_type_15& resolvedType);
...
namespace app_src_emitter_expr_calls_ {
    std::string emitCall(const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_16& expected);
    ...
    bool isClassCallee(const doof_header_type_17& callee);
    ...
    std::string emitBuiltinCall(const std::string& name, const doof_header_type_17& object, const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    std::string emitDefaultExpression(const doof_header_type_17& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_16& expected, ::app_src_ast_::SourceSpan callSiteSpan);
    doof_header_type_18 specializeOwnerMemberType(const doof_header_type_18& type_, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const std::shared_ptr<std::vector<std::string>>& ownerTypeParams);
    std::string emitOwnerDefaultExpression(const doof_header_type_17& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_18& expected, ::app_src_ast_::SourceSpan callSiteSpan, const std::shared_ptr<::app_src_semantic_::ClassType>& owner, const std::shared_ptr<std::vector<std::string>>& ownerTypeParams);
