...
namespace app_src_emitter_expr_calls_ {
    ...
    using doof_header_type_18 = std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>;
}
...
namespace app_src_checker_types_ {
    doof_header_type_10 substituteTypeParams(const doof_header_type_10& type_, const std::shared_ptr<std::vector<std::string>>& names, const std::shared_ptr<std::vector<doof_header_type_10>>& arguments);
}

namespace app_src_emitter_monomorphize_ {
    std::string functionInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_11>>& typeArgs);
    std::string classInstantiationKey(const std::string& modulePath, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_11>>& typeArgs);
    std::string methodInstantiationKey(const std::string& ownerKey, const std::string& name, const std::shared_ptr<std::vector<doof_header_type_11>>& typeArgs);
}
...
namespace app_src_emitter_types_ {
    ...
    std::string emitType(const doof_header_type_12& resolvedType, const std::string& currentModulePath);
    bool usesVariantRepresentation(const doof_header_type_12& type_);
    std::variant<std::monostate, std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>> naturalNullableUnionMember(const doof_header_type_12& type_);
}

namespace app_src_emitter_expr_utils_ {
    doof_header_type_13 decoratedExpressionType(const doof_header_type_14& expression);
    doof_header_type_13 optionalExpectedType(const doof_header_type_15& value);
    std::string emitExpectedExpression(const doof_header_type_14& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context, const doof_header_type_13& expected);
    bool needsNullableVariantPromotion(const doof_header_type_13& source, const doof_header_type_13& expected);
    std::string emitNullableVariantPromotion(const std::string& value, const doof_header_type_13& source, const doof_header_type_13& expected, const std::string& currentModulePath);
    bool needsVariantPromotion(const doof_header_type_13& source, const doof_header_type_13& expected);
...
namespace app_src_emitter_expr_calls_ {
    ...
    bool weakCallTargetAllowsNone(const doof_header_type_17& type_);
    bool weakCallTargetUsesVariant(const doof_header_type_17& type_);
    ...
    bool isClassCallee(const doof_header_type_18& callee);
    ...
    std::string emitBuiltinCall(const std::string& name, const doof_header_type_18& object, const std::shared_ptr<::app_src_ast_::CallExpression>& expression, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
