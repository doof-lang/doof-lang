...
namespace app_src_emitter_header_ {
    ...
    struct HeaderTypeUse;
    struct HeaderCompressionState;
}
...
namespace app_src_emitter_header_ {
    ...
    struct HeaderTypeUse : public std::enable_shared_from_this<HeaderTypeUse> {
    std::string spelling;
    int32_t count;
    HeaderTypeUse(std::string spelling, int32_t count) : spelling(spelling), count(count) {}
};
    struct HeaderCompressionState : public std::enable_shared_from_this<HeaderCompressionState> {
    int32_t nextAnonymousTypeIndex;
    HeaderCompressionState(int32_t nextAnonymousTypeIndex) : nextAnonymousTypeIndex(nextAnonymousTypeIndex) {}
};
}
...
namespace app_src_emitter_header_ {
    ...
    void collectNativeTypeAliases(const doof_header_type_11& type_, const std::string& namespace_, const std::shared_ptr<HeaderPlan>& plan, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
    ...
    void collectModuleValueDeclaration(const std::shared_ptr<HeaderPlan>& plan, const std::string& declaration, const doof_header_type_11& type_);
    bool moduleValueDeclarationNeedsIncludes(const doof_header_type_11& type_);
    std::string emitModuleValueDeclaration(const std::string& name, const doof_header_type_11& type_, const std::shared_ptr<::app_src_emitter_context_::EmitContext>& context);
