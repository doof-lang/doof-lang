...
namespace app_src_emitter_header_ {
    ...
    std::string spelling;
    int32_t count = 0;
    HeaderTypeUse(std::string spelling, int32_t count = 0) : spelling(spelling), count(count) {}
    doof::JsonObject toJsonObject() const;
    static doof::Result<std::shared_ptr<HeaderTypeUse>, std::string> fromJsonValue(const doof::JsonValue& _json, bool _lenient = false);
};
    struct HeaderCompressionState : public std::enable_shared_from_this<HeaderCompressionState> {
    int32_t nextAnonymousTypeIndex = 1;
    HeaderCompressionState(int32_t nextAnonymousTypeIndex = 1) : nextAnonymousTypeIndex(nextAnonymousTypeIndex) {}
    doof::JsonObject toJsonObject() const;
    static doof::Result<std::shared_ptr<HeaderCompressionState>, std::string> fromJsonValue(const doof::JsonValue& _json, bool _lenient = false);
};
}
...
namespace app_src_emitter_header_ {
    ...
    void collectModuleValueDeclaration(const std::shared_ptr<HeaderPlan>& plan, const std::string& declaration, const __type11& type_);
