...
namespace app_src_checker_resolution_ {
    doof_header_type_11 memberType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const doof_header_type_11& object, const std::string& property, ::app_src_ast_::SourceSpan span, bool validateVisibility);
}
...
namespace app_src_checker_literals_ {
    doof_header_type_12 checkOmittedCollectionLiteral(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const doof_header_type_13& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    doof_header_type_14 checkArray(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ArrayLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_12& expected);
    doof_header_type_14 checkObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_12& expected);
    doof_header_type_12 checkClassObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::shared_ptr<::app_src_semantic_::ClassType>& class_, bool structural);
    bool supportsUnionObjectInference(const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_);
    doof_header_type_14 checkUnionObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_);
    ...
    void decorateObjectProperty(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const doof_header_type_12& expected);
