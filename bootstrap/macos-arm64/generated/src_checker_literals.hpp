...
namespace app_src_checker_resolution_ {
    __type11 memberType(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const __type11& object, const std::string& property, ::app_src_ast_::SourceSpan span, bool validateVisibility = true);
}
...
namespace app_src_checker_literals_ {
    __type12 checkOmittedCollectionLiteral(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const __type13& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope);
    __type14 checkArray(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ArrayLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const __type12& expected);
    __type14 checkObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const __type12& expected);
    __type12 checkClassObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::shared_ptr<::app_src_semantic_::ClassType>& class_, bool structural);
    bool supportsUnionObjectInference(const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_);
    __type14 checkUnionObject(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectLiteral>& expression, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const std::shared_ptr<::app_src_semantic_::UnionResolvedType>& union_);
    ...
    void decorateObjectProperty(const std::shared_ptr<::app_src_checker_state_::CheckerState>& state, const std::shared_ptr<::app_src_ast_::ObjectProperty>& property, const std::shared_ptr<::app_src_semantic_::Scope>& scope, const __type12& expected);
    ...
    bool sameFixedFieldValue(const __type13& actual, const __type13& expected);
