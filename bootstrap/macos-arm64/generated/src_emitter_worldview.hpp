...
namespace app_src_emitter_worldview_ {
    ...
    WorldviewSelection(std::string path, std::shared_ptr<std::vector<doof_header_type_10>> statements) : path(path), statements(statements) {}
};
    ...
    std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>> selectionOrder;
...
namespace app_src_emitter_worldview_walk_ {
    ...
    void collectWorldviewBlockExpressions(const std::shared_ptr<::app_src_ast_::Block>& block, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
    void collectWorldviewNestedExpressions(const doof_header_type_9& expression, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
}
