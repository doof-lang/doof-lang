...
namespace app_src_emitter_worldview_ {
    struct WorldviewModule;
    struct WorldviewPlan;
    struct WorldviewSelection;
    struct WorldviewGraphIndex;
    struct WorldviewIndex;
}
...
namespace app_src_emitter_worldview_ {
    struct WorldviewModule : public std::enable_shared_from_this<WorldviewModule> {
    std::string path;
    std::shared_ptr<::app_src_ast_::Program> program;
    ...
    struct WorldviewSelection : public std::enable_shared_from_this<WorldviewSelection> {
    std::shared_ptr<std::vector<doof_header_type_10>> statements;
    WorldviewSelection(std::shared_ptr<std::vector<doof_header_type_10>> statements) : statements(statements) {}
};
    ...
    std::shared_ptr<doof::ordered_map<std::string, doof_header_type_10>> declarations;
    std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<::app_src_semantic_::Symbol>>> symbols;
    WorldviewGraphIndex(std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<::app_src_analyzer_::ModuleInfo>>> modules, std::shared_ptr<doof::ordered_map<std::string, doof_header_type_10>> declarations, std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<::app_src_semantic_::Symbol>>> symbols) : modules(modules), declarations(declarations), symbols(symbols) {}
};
    struct WorldviewIndex : public std::enable_shared_from_this<WorldviewIndex> {
    std::shared_ptr<WorldviewGraphIndex> graph;
    std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>> selections;
    std::shared_ptr<doof::ordered_set<std::string>> selectedKeys;
    std::shared_ptr<std::vector<std::string>> interfaceKeys;
    std::shared_ptr<doof::ordered_set<std::string>> interfaceKeySet;
    std::shared_ptr<doof::ordered_set<std::string>> visitingPaths;
    std::shared_ptr<doof::ordered_set<std::string>> visitedPaths;
    WorldviewIndex(std::shared_ptr<WorldviewGraphIndex> graph, std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>> selections, std::shared_ptr<doof::ordered_set<std::string>> selectedKeys, std::shared_ptr<std::vector<std::string>> interfaceKeys, std::shared_ptr<doof::ordered_set<std::string>> interfaceKeySet, std::shared_ptr<doof::ordered_set<std::string>> visitingPaths, std::shared_ptr<doof::ordered_set<std::string>> visitedPaths) : graph(graph), selections(selections), selectedKeys(selectedKeys), interfaceKeys(interfaceKeys), interfaceKeySet(interfaceKeySet), visitingPaths(visitingPaths), visitedPaths(visitedPaths) {}
};
}
...
namespace app_src_ast_walk_ {
    ...
    void collectNestedExpressions(const doof_header_type_9& expression, const std::shared_ptr<std::vector<doof_header_type_9>>& result);
}
...
namespace app_src_emitter_worldview_ {
    ...
    std::shared_ptr<std::vector<doof_header_type_10>> orderedSelectionStatements(const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<WorldviewSelection>& selection);
    ...
    void collectStatementSurface(const doof_header_type_10& statement, const std::string& rootPath, const std::shared_ptr<WorldviewIndex>& index, bool foreign);
    ...
    std::string statementName(const doof_header_type_10& statement);
