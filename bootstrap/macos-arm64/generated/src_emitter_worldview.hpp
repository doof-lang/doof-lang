...
namespace app_src_emitter_worldview_ {
    ...
    std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>> selections = std::make_shared<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>>(std::initializer_list<std::pair<std::string, std::shared_ptr<WorldviewSelection>>>{});
    std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>> selectionOrder = std::make_shared<std::vector<std::shared_ptr<WorldviewSelection>>>(std::vector<std::shared_ptr<WorldviewSelection>>{});
    std::shared_ptr<doof::ordered_set<std::string>> selectedKeys = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{});
    std::shared_ptr<std::vector<std::string>> interfaceKeys = std::make_shared<std::vector<std::string>>(std::vector<std::string>{});
    std::shared_ptr<doof::ordered_set<std::string>> interfaceKeySet = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{});
    std::shared_ptr<doof::ordered_set<std::string>> visitingPaths = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{});
    std::shared_ptr<doof::ordered_set<std::string>> visitedPaths = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{});
    WorldviewIndex(std::shared_ptr<WorldviewGraphIndex> graph, std::shared_ptr<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>> selections = std::make_shared<doof::ordered_map<std::string, std::shared_ptr<WorldviewSelection>>>(std::initializer_list<std::pair<std::string, std::shared_ptr<WorldviewSelection>>>{}), std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>> selectionOrder = std::make_shared<std::vector<std::shared_ptr<WorldviewSelection>>>(std::vector<std::shared_ptr<WorldviewSelection>>{}), std::shared_ptr<doof::ordered_set<std::string>> selectedKeys = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{}), std::shared_ptr<std::vector<std::string>> interfaceKeys = std::make_shared<std::vector<std::string>>(std::vector<std::string>{}), std::shared_ptr<doof::ordered_set<std::string>> interfaceKeySet = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{}), std::shared_ptr<doof::ordered_set<std::string>> visitingPaths = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{}), std::shared_ptr<doof::ordered_set<std::string>> visitedPaths = std::make_shared<doof::ordered_set<std::string>>(doof::ordered_set<std::string>{})) : graph(graph), selections(selections), selectionOrder(selectionOrder), selectedKeys(selectedKeys), interfaceKeys(interfaceKeys), interfaceKeySet(interfaceKeySet), visitingPaths(visitingPaths), visitedPaths(visitedPaths) {}
};
}
...
namespace app_src_emitter_worldview_ {
    ...
    void collectStatementSurface(const __type10& statement, const std::string& rootPath, const std::shared_ptr<WorldviewIndex>& index, bool foreign);
