...
namespace app_src_checker_ {
    ...
    std::string scriptGlobalName(const doof_header_type_11& statement);
    bool isScriptValueDeclaration(const doof_header_type_11& statement);
    bool isScriptGlobalDeclaration(const doof_header_type_11& statement);
    bool isModuleDeclaration(const doof_header_type_11& statement);
    bool isExport(const doof_header_type_11& statement);
    void promoteScriptBinding(const doof_header_type_11& statement, const std::shared_ptr<::app_src_semantic_::Scope>& scriptScope, const std::shared_ptr<::app_src_semantic_::Scope>& moduleScope);
