...
std::shared_ptr<WorldviewPlan> planWorldview(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::string& rootPath, const std::shared_ptr<::app_src_emitter_monomorphize_::InstantiationPlan>& instantiations) {
    const auto root = findModule(result, rootPath);
    ...
    std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>> selections = std::make_shared<std::vector<std::shared_ptr<WorldviewSelection>>>(std::vector<std::shared_ptr<WorldviewSelection>>{});
    std::shared_ptr<std::vector<std::string>> selectedKeys = std::make_shared<std::vector<std::string>>(std::vector<std::string>{});
    const auto& _iterable_1 = root->program->statements;
    for (const auto& statement : *_iterable_1) {
        ...
        for (const auto& expression : *_iterable_2) {
            collectExpressionTree(expression, rootPath, result, selections, selectedKeys);
        }
    }
    const auto& _iterable_3 = root->symbols;
    for (const auto& symbol : *_iterable_3) {
        if (symbol->native_ && (symbol->nativeHeader != std::string(""))) {
            collectSymbol(symbol, rootPath, result, selections, selectedKeys);
        }
    }
    const auto& _iterable_4 = root->exports;
    for (const auto& symbol : *_iterable_4) {
    ...
    const auto& _iterable_5 = selections;
    for (const auto& selection : *_iterable_5) {
        const auto& _iterable_6 = selection->statements;
        for (const auto& statement : *_iterable_6) {
            collectStatementInterfaceKeys(statement, interfaceKeys);
        }
    }
    if (!doof::is_null(instantiations)) {
        const auto& _iterable_7 = instantiations->interfaces;
        for (const auto& interface_ : *_iterable_7) {
            if (!containsString(interfaceKeys, interface_->key)) {
                continue;
            }
            const auto& _iterable_8 = interface_->implementations;
            for (const auto& implementation : *_iterable_8) {
                auto name = implementation->typeName;
                const auto& _iterable_9 = instantiations->classes;
                for (const auto& class_ : *_iterable_9) {
                    if ((class_->modulePath == implementation->modulePath) && (class_->emittedName == implementation->typeName)) {
                        (name = class_->declaration->name);
                        break;
                    }
                }
                const auto module = findModule(result, implementation->modulePath);
                if (doof::is_null(module)) {
                    continue;
                }
                const auto& _iterable_10 = module->symbols;
                for (const auto& symbol : *_iterable_10) {
                    const auto original = ((symbol->originalName == std::string("")) ? symbol->name : symbol->originalName);
                    if (original == name) {
                        collectSymbol(symbol, rootPath, result, selections, selectedKeys);
                        break;
                    }
    ...
    std::shared_ptr<std::vector<std::string>> visitedPaths = std::make_shared<std::vector<std::string>>(std::vector<std::string>{});
    ...
    for (const auto& info : *_iterable_11) {
        if ((info->path != rootPath) && (!doof::is_null(findSelection(selections, info->path)))) {
...
void appendWorldviewModule(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::string& path, const std::string& rootPath, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<WorldviewPlan>& plan, const std::shared_ptr<std::vector<std::string>>& visiting, const std::shared_ptr<std::vector<std::string>>& visited) {
    ...
    const auto& _iterable_13 = info->reExports;
    for (const auto& reExport : *_iterable_13) {
        if (reExport != rootPath) {
            appendWorldviewModule(result, reExport, rootPath, selections, plan, visiting, visited);
        }
    }
    const auto ignored = [&]() -> std::string { auto _try_value = doof::array_pop(visiting); if (doof::is_failure(_try_value)) doof::panic_at("src/emitter-worldview", 129, std::string("try! failed") + std::string(": ") + doof::failure_error(_try_value)); return std::move(doof::success_value(_try_value)); }();
    if (containsString(visited, path)) {
        return;
    }
...
void collectProgramInterfaceKeys(const std::shared_ptr<::app_src_ast_::Program>& program, const std::shared_ptr<std::vector<std::string>>& keys) {
    ...
    for (const auto& statement : *_iterable_14) {
        collectStatementInterfaceKeys(statement, keys);
    }
}
void collectStatementInterfaceKeys(const std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>& statement, const std::shared_ptr<std::vector<std::string>>& keys) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject)) {
            ...
            collectStatementInterfaceKeys(export_->declaration, keys);
    }
            ...
            if (!doof::is_null(fn->resolvedType)) {
                collectTypeInterfaceKeys(doof::unwrap_optional(fn->resolvedType), keys);
            }
            const auto& _iterable_15 = fn->params;
            for (const auto& parameter : *_iterable_15) {
                if (!doof::is_null(parameter->resolvedType)) {
                    collectTypeInterfaceKeys(doof::unwrap_optional(parameter->resolvedType), keys);
                }
                if (!doof::is_null(parameter->defaultValue)) {
                    collectExpressionInterfaceKeys(doof::unwrap_optional(parameter->defaultValue), keys);
                }
            }
            std::shared_ptr<std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>> expressions = std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>>(std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>{});
            {
            ...
            const auto& _iterable_16 = expressions;
            for (const auto& expression : *_iterable_16) {
                collectExpressionInterfaceKeys(expression, keys);
            }
    }
            ...
            for (const auto& field : *_iterable_17) {
                if (!doof::is_null(field->resolvedType)) {
                    collectTypeInterfaceKeys(doof::unwrap_optional(field->resolvedType), keys);
                }
                if (!doof::is_null(field->defaultValue)) {
                    collectExpressionInterfaceKeys(doof::unwrap_optional(field->defaultValue), keys);
                }
            }
            const auto& _iterable_18 = class_->methods;
            for (const auto& method : *_iterable_18) {
                collectStatementInterfaceKeys(doof::variant_promote<std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>>(method), keys);
            }
    }
            ...
            const auto& _iterable_19 = interface_->fields;
            ...
            if (!doof::is_null(alias->resolvedType)) {
                collectTypeInterfaceKeys(doof::unwrap_optional(alias->resolvedType), keys);
            }
    }
            ...
            if (!doof::is_null(const_->resolvedType)) {
                collectTypeInterfaceKeys(doof::unwrap_optional(const_->resolvedType), keys);
            }
    }
            ...
            if (!doof::is_null(readonly_->resolvedType)) {
                collectTypeInterfaceKeys(doof::unwrap_optional(readonly_->resolvedType), keys);
            }
    }
            ...
            if (!doof::is_null(binding->resolvedType)) {
                collectTypeInterfaceKeys(doof::unwrap_optional(binding->resolvedType), keys);
            }
    }
    else {
    }
...
void collectExpressionInterfaceKeys(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression, const std::shared_ptr<std::vector<std::string>>& keys) {
    ...
    ::app_src_emitter_worldview_walk_::collectWorldviewNestedExpressions(expression, nested);
    const auto& _iterable_21 = nested;
    for (const auto& child : *_iterable_21) {
        collectExpressionInterfaceKeys(child, keys);
    }
}
void collectTypeInterfaceKeys(const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::shared_ptr<std::vector<std::string>>& keys) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::InterfaceType>>(_case_subject)) {
            ...
            if (static_cast<int32_t>((interface_->typeArgs)->size()) > 0) {
                addUniqueString(keys, ::app_src_emitter_monomorphize_::interfaceInstantiationKey(interface_->symbol->module, interface_->name, interface_->typeArgs));
            }
            const auto& _iterable_22 = interface_->typeArgs;
            for (const auto& argument : *_iterable_22) {
                collectTypeInterfaceKeys(argument, keys);
            }
    }
            ...
            const auto& _iterable_23 = class_->typeArgs;
            for (const auto& argument : *_iterable_23) {
                collectTypeInterfaceKeys(argument, keys);
            }
    }
            ...
            collectTypeInterfaceKeys(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(actor->innerClass), keys);
    }
            ...
            collectTypeInterfaceKeys(promise->valueType, keys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject)) {
            const auto& array = std::get<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject);
            collectTypeInterfaceKeys(array->elementType, keys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::MapResolvedType>>(_case_subject)) {
            const auto& map = std::get<std::shared_ptr<::app_src_semantic_::MapResolvedType>>(_case_subject);
            collectTypeInterfaceKeys(map->keyType, keys);
            collectTypeInterfaceKeys(map->valueType, keys);
    }
            ...
            collectTypeInterfaceKeys(set_->elementType, keys);
    }
            ...
            collectTypeInterfaceKeys(result_->valueType, keys);
            collectTypeInterfaceKeys(result_->errorType, keys);
    }
            ...
            for (const auto& element : *_iterable_24) {
                collectTypeInterfaceKeys(element, keys);
            }
    }
            ...
            for (const auto& member : *_iterable_25) {
                collectTypeInterfaceKeys(member, keys);
            }
    }
            ...
            collectTypeInterfaceKeys(weak_->inner, keys);
    }
            ...
            for (const auto& parameter : *_iterable_26) {
                collectTypeInterfaceKeys(parameter->type_, keys);
            }
...
std::shared_ptr<std::vector<std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>>> orderedSelectionStatements(const std::shared_ptr<::app_src_analyzer_::ModuleInfo>& info, const std::shared_ptr<WorldviewSelection>& selection) {
    ...
    const auto& _iterable_27 = info->program->statements;
    for (const auto& candidate : *_iterable_27) {
        const auto name = statementName(candidate);
        if (name == std::string("")) {
            continue;
        }
        const auto& _iterable_28 = selection->statements;
        for (const auto& selected : *_iterable_28) {
            if (statementName(selected) == name) {
...
void collectExpressionTree(const std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>& expression, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys) {
    ...
    }
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::Identifier>>(_case_subject)) {
            ...
            if ((!doof::is_null(identifier->resolvedBinding)) && (!doof::is_null(identifier->resolvedBinding->symbol))) {
                collectSymbol(doof::unwrap_optional(identifier->resolvedBinding->symbol), rootPath, result, selections, selectedKeys);
            }
    }
            ...
            if (!doof::is_null(member->resolvedNamespaceSymbol)) {
                collectSymbol(doof::unwrap_optional(member->resolvedNamespaceSymbol), rootPath, result, selections, selectedKeys);
            }
            if ((!doof::is_null(member->resolvedStaticOwner)) && (!doof::is_null(member->resolvedStaticOwner->resolvedSymbol))) {
                collectSymbol(doof::unwrap_optional(member->resolvedStaticOwner->resolvedSymbol), rootPath, result, selections, selectedKeys);
            }
    }
    else {
    }
    ...
    std::shared_ptr<std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>> nested = std::make_shared<std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>>(std::vector<std::variant<std::shared_ptr<::app_src_ast_::IntLiteral>, std::shared_ptr<::app_src_ast_::LongLiteral>, std::shared_ptr<::app_src_ast_::FloatLiteral>, std::shared_ptr<::app_src_ast_::DoubleLiteral>, std::shared_ptr<::app_src_ast_::StringLiteral>, std::shared_ptr<::app_src_ast_::CharLiteral>, std::shared_ptr<::app_src_ast_::BoolLiteral>, std::shared_ptr<::app_src_ast_::NoneLiteral>, std::shared_ptr<::app_src_ast_::Identifier>, std::shared_ptr<::app_src_ast_::BinaryExpression>, std::shared_ptr<::app_src_ast_::UnaryExpression>, std::shared_ptr<::app_src_ast_::AssignmentExpression>, std::shared_ptr<::app_src_ast_::MemberExpression>, std::shared_ptr<::app_src_ast_::IndexExpression>, std::shared_ptr<::app_src_ast_::CallExpression>, std::shared_ptr<::app_src_ast_::ArrayLiteral>, std::shared_ptr<::app_src_ast_::ObjectLiteral>, std::shared_ptr<::app_src_ast_::TupleLiteral>, std::shared_ptr<::app_src_ast_::LambdaExpression>, std::shared_ptr<::app_src_ast_::IfExpression>, std::shared_ptr<::app_src_ast_::CaseExpression>, std::shared_ptr<::app_src_ast_::ConstructExpression>, std::shared_ptr<::app_src_ast_::DotShorthand>, std::shared_ptr<::app_src_ast_::ThisExpression>, std::shared_ptr<::app_src_ast_::CallerExpression>, std::shared_ptr<::app_src_ast_::AsyncExpression>, std::shared_ptr<::app_src_ast_::RetireExpression>, std::shared_ptr<::app_src_ast_::AsExpression>, std::shared_ptr<::app_src_ast_::ActorCreationExpression>, std::shared_ptr<::app_src_ast_::YieldBlockExpression>, std::shared_ptr<::app_src_ast_::CatchExpression>>>{});
    ::app_src_emitter_worldview_walk_::collectWorldviewNestedExpressions(expression, nested);
    const auto& _iterable_29 = nested;
    for (const auto& child : *_iterable_29) {
        collectExpressionTree(child, rootPath, result, selections, selectedKeys);
    }
}
void collectType(const std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>& type_, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys) {
    {
        auto _case_subject = type_;
        if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject)) {
            const auto& class_ = std::get<std::shared_ptr<::app_src_semantic_::ClassType>>(_case_subject);
            collectSymbol(class_->symbol, rootPath, result, selections, selectedKeys);
            const auto& _iterable_30 = class_->typeArgs;
            for (const auto& argument : *_iterable_30) {
                collectType(argument, rootPath, result, selections, selectedKeys);
            }
    }
            ...
            collectSymbol(enum_->symbol, rootPath, result, selections, selectedKeys);
    }
            ...
            const auto& _iterable_31 = interface_->symbol->implementations;
            ...
            const auto& actor = std::get<std::shared_ptr<::app_src_semantic_::ActorType>>(_case_subject);
            collectType(doof::variant_promote<std::variant<std::shared_ptr<::app_src_semantic_::PrimitiveType>, std::shared_ptr<::app_src_semantic_::ClassType>, std::shared_ptr<::app_src_semantic_::EnumType>, std::shared_ptr<::app_src_semantic_::InterfaceType>, std::shared_ptr<::app_src_semantic_::FunctionType>, std::shared_ptr<::app_src_semantic_::ActorType>, std::shared_ptr<::app_src_semantic_::PromiseType>, std::shared_ptr<::app_src_semantic_::ArrayResolvedType>, std::shared_ptr<::app_src_semantic_::MapResolvedType>, std::shared_ptr<::app_src_semantic_::SetResolvedType>, std::shared_ptr<::app_src_semantic_::StreamResolvedType>, std::shared_ptr<::app_src_semantic_::RangeResolvedType>, std::shared_ptr<::app_src_semantic_::JsonValueResolvedType>, std::shared_ptr<::app_src_semantic_::ResultResolvedType>, std::shared_ptr<::app_src_semantic_::TupleResolvedType>, std::shared_ptr<::app_src_semantic_::UnionResolvedType>, std::shared_ptr<::app_src_semantic_::WeakResolvedType>, std::shared_ptr<::app_src_semantic_::NoneType>, std::shared_ptr<::app_src_semantic_::NeverType>, std::shared_ptr<::app_src_semantic_::UnknownType>, std::shared_ptr<::app_src_semantic_::TypeParameterType>, std::shared_ptr<::app_src_semantic_::ClassMetadataResolvedType>, std::shared_ptr<::app_src_semantic_::MethodReflectionResolvedType>>>(actor->innerClass), rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::PromiseType>>(_case_subject)) {
            const auto& promise = std::get<std::shared_ptr<::app_src_semantic_::PromiseType>>(_case_subject);
            collectType(promise->valueType, rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject)) {
            const auto& array = std::get<std::shared_ptr<::app_src_semantic_::ArrayResolvedType>>(_case_subject);
            collectType(array->elementType, rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::MapResolvedType>>(_case_subject)) {
            const auto& map = std::get<std::shared_ptr<::app_src_semantic_::MapResolvedType>>(_case_subject);
            ...
            const auto& set_ = std::get<std::shared_ptr<::app_src_semantic_::SetResolvedType>>(_case_subject);
            collectType(set_->elementType, rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::StreamResolvedType>>(_case_subject)) {
            const auto& stream = std::get<std::shared_ptr<::app_src_semantic_::StreamResolvedType>>(_case_subject);
            collectType(stream->elementType, rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::ResultResolvedType>>(_case_subject)) {
            const auto& result_ = std::get<std::shared_ptr<::app_src_semantic_::ResultResolvedType>>(_case_subject);
            ...
            for (const auto& element : *_iterable_33) {
                collectType(element, rootPath, result, selections, selectedKeys);
            }
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject)) {
            const auto& union_ = std::get<std::shared_ptr<::app_src_semantic_::UnionResolvedType>>(_case_subject);
            ...
            for (const auto& member : *_iterable_34) {
                collectType(member, rootPath, result, selections, selectedKeys);
            }
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::WeakResolvedType>>(_case_subject)) {
            const auto& weak_ = std::get<std::shared_ptr<::app_src_semantic_::WeakResolvedType>>(_case_subject);
            collectType(weak_->inner, rootPath, result, selections, selectedKeys);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject)) {
            const auto& function_ = std::get<std::shared_ptr<::app_src_semantic_::FunctionType>>(_case_subject);
            const auto& _iterable_35 = function_->params;
            for (const auto& parameter : *_iterable_35) {
                collectType(parameter->type_, rootPath, result, selections, selectedKeys);
            }
...
void collectSymbol(const std::shared_ptr<::app_src_semantic_::Symbol>& symbol, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys) {
    ...
    if (containsString(selectedKeys, key)) {
        return;
    }
    ...
    const auto declaration = declarationFor(result, symbol->module, name);
    if (doof::is_null(declaration)) {
        return;
    }
    const auto selection = selectionFor(selections, symbol->module);
    selection->statements->push_back(doof::unwrap_optional(declaration));
    collectStatementSurface(doof::unwrap_optional(declaration), rootPath, result, selections, selectedKeys, true);
    collectNativeHeaderClosure(symbol, rootPath, result, selections, selectedKeys);
}
        ...
        if (!doof::is_null(module)) {
            ...
            for (const auto& imported : *_iterable_37) {
                if ((!doof::is_null(imported->symbol)) && isNominalSurfaceSymbol(doof::unwrap_optional(imported->symbol))) {
                    collectSymbol(doof::unwrap_optional(imported->symbol), rootPath, result, selections, selectedKeys);
                }
            }
            const auto& _iterable_38 = module->exports;
            for (const auto& exported : *_iterable_38) {
                if (isNominalSurfaceSymbol(exported)) {
                    collectSymbol(exported, rootPath, result, selections, selectedKeys);
                }
            }
            const auto& _iterable_39 = module->reExports;
            for (const auto& reExportPath : *_iterable_39) {
                const auto reExported = findModule(result, reExportPath);
                if (doof::is_null(reExported)) {
                    continue;
                }
                const auto& _iterable_40 = reExported->exports;
                for (const auto& exported : *_iterable_40) {
                    if (isNominalSurfaceSymbol(exported)) {
                        collectSymbol(exported, rootPath, result, selections, selectedKeys);
                    }
                }
...
void collectStatementSurface(const std::variant<std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>>& statement, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys, bool foreign) {
    {
        auto _case_subject = statement;
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject)) {
            const auto& export_ = std::get<std::shared_ptr<::app_src_ast_::ExportDeclaration>>(_case_subject);
            collectStatementSurface(export_->declaration, rootPath, result, selections, selectedKeys, foreign);
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::FunctionDeclaration>>(_case_subject)) {
            const auto& fn = std::get<std::shared_ptr<::app_src_ast_::FunctionDeclaration>>(_case_subject);
            if (!doof::is_null(fn->resolvedType)) {
                collectType(doof::unwrap_optional(fn->resolvedType), rootPath, result, selections, selectedKeys);
            }
            if (!doof::is_null(fn->returnType)) {
                collectAnnotationAliases(doof::unwrap_optional(fn->returnType), rootPath, result, selections, selectedKeys);
            }
            const auto& _iterable_41 = fn->params;
            for (const auto& parameter : *_iterable_41) {
                if (!doof::is_null(parameter->resolvedType)) {
                    collectType(doof::unwrap_optional(parameter->resolvedType), rootPath, result, selections, selectedKeys);
                }
                if (!doof::is_null(parameter->type_)) {
                    collectAnnotationAliases(doof::unwrap_optional(parameter->type_), rootPath, result, selections, selectedKeys);
                }
                if (!doof::is_null(parameter->defaultValue)) {
                    collectExpressionTree(doof::unwrap_optional(parameter->defaultValue), rootPath, result, selections, selectedKeys);
                }
            }
            if (!foreign) {
                collectFunctionBody(fn, rootPath, result, selections, selectedKeys);
            }
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject)) {
            const auto& class_ = std::get<std::shared_ptr<::app_src_ast_::ClassDeclaration>>(_case_subject);
            const auto& _iterable_42 = class_->fields;
            for (const auto& field : *_iterable_42) {
                if (!doof::is_null(field->resolvedType)) {
                    collectType(doof::unwrap_optional(field->resolvedType), rootPath, result, selections, selectedKeys);
                }
                if (!doof::is_null(field->type_)) {
                    collectAnnotationAliases(doof::unwrap_optional(field->type_), rootPath, result, selections, selectedKeys);
                }
                if (!doof::is_null(field->defaultValue)) {
                    collectExpressionTree(doof::unwrap_optional(field->defaultValue), rootPath, result, selections, selectedKeys);
                }
            }
            const auto& _iterable_43 = class_->methods;
            for (const auto& method : *_iterable_43) {
                if (!doof::is_null(method->resolvedType)) {
                    collectType(doof::unwrap_optional(method->resolvedType), rootPath, result, selections, selectedKeys);
                }
                if (!doof::is_null(method->returnType)) {
                    collectAnnotationAliases(doof::unwrap_optional(method->returnType), rootPath, result, selections, selectedKeys);
                }
                const auto& _iterable_44 = method->params;
                ...
                if (!foreign) {
                    collectFunctionBody(method, rootPath, result, selections, selectedKeys);
                }
            }
            if (!doof::is_null(class_->resolvedSymbol)) {
                const auto& _iterable_45 = class_->resolvedSymbol->implementations;
                for (const auto& implementation : *_iterable_45) {
                    collectSymbol(implementation, rootPath, result, selections, selectedKeys);
                }
            }
    }
            ...
            for (const auto& method : *_iterable_47) {
                ...
                const auto& _iterable_48 = method->params;
            ...
            if (!doof::is_null(interface_->resolvedSymbol)) {
                const auto& _iterable_49 = interface_->resolvedSymbol->implementations;
                for (const auto& implementation : *_iterable_49) {
                    collectSymbol(implementation, rootPath, result, selections, selectedKeys);
                }
            }
    }
            ...
            const auto& alias = std::get<std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>>(_case_subject);
            if (!doof::is_null(alias->resolvedType)) {
                collectType(doof::unwrap_optional(alias->resolvedType), rootPath, result, selections, selectedKeys);
            }
            ...
            const auto& const_ = std::get<std::shared_ptr<::app_src_ast_::ConstDeclaration>>(_case_subject);
            if (!doof::is_null(const_->resolvedType)) {
                collectType(doof::unwrap_optional(const_->resolvedType), rootPath, result, selections, selectedKeys);
            }
            if (!doof::is_null(const_->type_)) {
                collectAnnotationAliases(doof::unwrap_optional(const_->type_), rootPath, result, selections, selectedKeys);
            }
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject)) {
            const auto& readonly_ = std::get<std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>>(_case_subject);
            if (!doof::is_null(readonly_->resolvedType)) {
                collectType(doof::unwrap_optional(readonly_->resolvedType), rootPath, result, selections, selectedKeys);
            }
            if (!doof::is_null(readonly_->type_)) {
                collectAnnotationAliases(doof::unwrap_optional(readonly_->type_), rootPath, result, selections, selectedKeys);
            }
    }
    else if (std::holds_alternative<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject)) {
            const auto& binding = std::get<std::shared_ptr<::app_src_ast_::ImmutableBinding>>(_case_subject);
            if (!doof::is_null(binding->resolvedType)) {
                collectType(doof::unwrap_optional(binding->resolvedType), rootPath, result, selections, selectedKeys);
            }
            if (!doof::is_null(binding->type_)) {
                collectAnnotationAliases(doof::unwrap_optional(binding->type_), rootPath, result, selections, selectedKeys);
            }
    }
            ...
            const auto& _iterable_50 = enum_->variants;
            for (const auto& variant : *_iterable_50) {
                if (!doof::is_null(variant->value)) {
                    collectExpressionTree(doof::unwrap_optional(variant->value), rootPath, result, selections, selectedKeys);
                }
            }
    }
    else {
...
void collectAnnotationAliases(const std::variant<std::shared_ptr<::app_src_ast_::NamedType>, std::shared_ptr<::app_src_ast_::ArrayType>, std::shared_ptr<::app_src_ast_::UnionType>, std::shared_ptr<::app_src_ast_::AstFunctionType>, std::shared_ptr<::app_src_ast_::WeakType>>& annotation, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys) {
    {
        ...
        if (std::holds_alternative<std::shared_ptr<::app_src_ast_::NamedType>>(_case_subject)) {
            ...
            if ((!doof::is_null(named->resolvedSymbol)) && (named->resolvedSymbol->kind == std::string("type-alias"))) {
                collectSymbol(doof::unwrap_optional(named->resolvedSymbol), rootPath, result, selections, selectedKeys);
            }
            const auto& _iterable_51 = named->typeArgs;
            for (const auto& argument : *_iterable_51) {
                collectAnnotationAliases(argument, rootPath, result, selections, selectedKeys);
            }
    }
            ...
            collectAnnotationAliases(array->elementType, rootPath, result, selections, selectedKeys);
    }
            ...
            for (const auto& member : *_iterable_52) {
                collectAnnotationAliases(member, rootPath, result, selections, selectedKeys);
            }
    }
            ...
            const auto& _iterable_53 = function_->params;
            for (const auto& parameter : *_iterable_53) {
                collectAnnotationAliases(parameter->type_, rootPath, result, selections, selectedKeys);
            }
            ...
            collectAnnotationAliases(weak_->type_, rootPath, result, selections, selectedKeys);
    }
    }
}
void collectFunctionBody(const std::shared_ptr<::app_src_ast_::FunctionDeclaration>& fn, const std::string& rootPath, const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::shared_ptr<std::vector<std::string>>& selectedKeys) {
    ...
    const auto& _iterable_54 = expressions;
    for (const auto& expression : *_iterable_54) {
        collectExpressionTree(expression, rootPath, result, selections, selectedKeys);
    }
}
std::variant<std::monostate, std::shared_ptr<::app_src_ast_::ConstDeclaration>, std::shared_ptr<::app_src_ast_::ReadonlyDeclaration>, std::shared_ptr<::app_src_ast_::ImmutableBinding>, std::shared_ptr<::app_src_ast_::LetDeclaration>, std::shared_ptr<::app_src_ast_::FunctionDeclaration>, std::shared_ptr<::app_src_ast_::ClassDeclaration>, std::shared_ptr<::app_src_ast_::InterfaceDeclaration>, std::shared_ptr<::app_src_ast_::EnumDeclaration>, std::shared_ptr<::app_src_ast_::TypeAliasDeclaration>, std::shared_ptr<::app_src_ast_::ImportDeclaration>, std::shared_ptr<::app_src_ast_::MockImportDirective>, std::shared_ptr<::app_src_ast_::ExportDeclaration>, std::shared_ptr<::app_src_ast_::ExportList>, std::shared_ptr<::app_src_ast_::IfStatement>, std::shared_ptr<::app_src_ast_::CaseStatement>, std::shared_ptr<::app_src_ast_::WhileStatement>, std::shared_ptr<::app_src_ast_::ForStatement>, std::shared_ptr<::app_src_ast_::ForOfStatement>, std::shared_ptr<::app_src_ast_::WithStatement>, std::shared_ptr<::app_src_ast_::ReturnStatement>, std::shared_ptr<::app_src_ast_::YieldStatement>, std::shared_ptr<::app_src_ast_::BreakStatement>, std::shared_ptr<::app_src_ast_::ContinueStatement>, std::shared_ptr<::app_src_ast_::ExpressionStatement>, std::shared_ptr<::app_src_ast_::DestructuringStatement>, std::shared_ptr<::app_src_ast_::TryStatement>, std::shared_ptr<::app_src_ast_::YieldBlockAssignmentStatement>, std::shared_ptr<::app_src_ast_::Block>> declarationFor(const std::shared_ptr<::app_src_analyzer_::AnalysisResult>& result, const std::string& modulePath, const std::string& name) {
    ...
    const auto& _iterable_55 = module->program->statements;
...
std::shared_ptr<WorldviewSelection> selectionFor(const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::string& path) {
    const auto existing = findSelection(selections, path);
...
std::shared_ptr<WorldviewSelection> findSelection(const std::shared_ptr<std::vector<std::shared_ptr<WorldviewSelection>>>& selections, const std::string& path) {
    const auto& _iterable_57 = selections;
    for (const auto& selection : *_iterable_57) {
...
bool containsString(const std::shared_ptr<std::vector<std::string>>& values, const std::string& value) {
    const auto& _iterable_58 = values;
    for (const auto& existing : *_iterable_58) {
        if (existing == value) {
            return true;
        }
    }
